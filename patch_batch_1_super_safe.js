...
const updates = [
  {
    id: "colonia",
    data: {
      subName: "EDC", perfumer: "Acqua Di Parma", year: 1916, gender: "unisex",
      longevity: 6, sillage: 6, seasons: { spring: 60, summer: 90, fall: 20, winter:10 }, dayNight: { day: 80, night: 20 },
  ...
  },
  {
    id: "9pm",
    data: {
      subName: "EDP", perfumer: "Afnan", year: 2020, gender: "nam",
      longevity: 8, sillage: 8, seasons: { spring: 30, summer: 10, fall: 70, winter: 80 }, dayNight: { day: 30, night: 70 },
  ...
  },
  {
    id: "interlude-man",
    data: {
      subName: "EDP", perfumer: "Pierre Negrin", year: 2012, gender: "nam",
      longevity: 9, sillage: 10, seasons: { spring: 20, summer: 5, fall: 85, winter: 90 }, dayNight: { day: 35, night: 65 },
  ...
  },
  {
    ...
    data: {
      subName: "Extrait", perfumer: "Lucas Sieuzac", year: 2021, gender: "nam",
      longevity: 8, sillage: 8, seasons: { spring: 80, summer: 40, fall: 75, winter: 60 }, dayNight: { day: 50, night: 50 },
  ...
  },
  {
    id: "reflection-man",
    data: {
      subName: "EDP", perfumer: "Lucas Sieuzac", year: 2007, gender: "nam",
      longevity: 7, sillage: 8, seasons: { spring: 85, summer: 50, fall: 70, winter: 40 }, dayNight: { day: 60, night: 40 },
  ...
  },
  {
    id: "odyssey-limoni",
    data: {
      subName: "EDP", perfumer: "Armaf", year: 2024, gender: "unisex",
      longevity: 5, sillage: 6, seasons: { spring: 80, summer: 90, fall: 20, winter: 10 }, dayNight: { day: 85, night: 15 },
  ...
  },
  {
    ...
    data: {
      subName: "EDP", perfumer: "Armaf", year: 2023, gender: "nam",
      longevity: 7, sillage: 8, seasons: { spring: 70, summer: 60, fall: 60, winter: 40 }, dayNight: { day: 60, night: 40 },
  ...
  },
  {
    ...
    data: {
      subName: "Parfum", perfumer: "Armaf", year: 2019, gender: "nam",
      longevity: 8, sillage: 8, seasons: { spring: 80, summer: 85, fall: 60, winter: 40 }, dayNight: { day: 70, night: 30 },
  ...
  },
  {
    ...
    data: {
      subName: "EDP", perfumer: "Armaf", year: 2024, gender: "unisex",
      longevity: 7, sillage: 8, seasons: { spring: 30, summer: 10, fall: 85, winter: 90 }, dayNight: { day: 35, night: 65 },
...
updates.forEach(upd => {
  ...
  // For safety, generate new lines to append after "name: "
  let injectLines = [];
  ...
  // Remove existing occurrences of these props inside the bounds
  let cleanedLines = [];
  let inAccords = false;
  ...
  for (let i = startIdx; i <= endIdx; i++) {
    ...
    for (let p of propsToReplace) {
      if (line.trim().startsWith(p + ':')) {
        skip = true;
        // handle multi-line accords or vibes if needed, but our current mockData has accords matching `accords: [`
        if (p === 'accords' && line.includes('[')) {
          // find where it closes
          let j = i;
          while (j <= endIdx && !lines[j].includes('],') && !lines[j].includes('] )')) {
            j++;
          }
          i = j; // skip all those lines
        }
        break;
      }
    }
  ...
  // Find where `name:` is within cleanedLines to inject the new ones
...
console.log("Successfully patched using reliable Line-by-Line array mutations.");
