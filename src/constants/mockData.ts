...
Quanh năm — đi làm, gặp gỡ, dạo phố. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất thu xuân. Ở Sài Gòn dùng quanh năm.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8,"compliments":9.5,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Vani Bourbon chua dịu (Vanilla)"},
      {"name": "Benzoin"}
    ],
    middleNotes: [
      {"name": "Hoa Nhài sáng trắng (Jasmine)"},
      {"name": "Nhũ hương"}
    ],
    baseNotes: [
      {"name": "Hổ phách tươi ấm (Amber)"},
      {"name": "Vũ điệu nhựa cây xanh"}
    ],
    accords: [
...
Dịp đặc biệt, sự kiện sang, hoặc khi muốn mùi Chanel mà 99% người không biết Chanel có. Xịt 2 nhát cổ — EDP mạnh. Dùng quanh năm nhưng đẹp nhất thu đông. Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai bí mật nhất Chanel.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":9,"compliments":8.5,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Tiêu sọ (Pepper)"},
      {"name": "Gừng non (Ginger)"},
      {"name": "Bạch đậu khấu"}
    ],
    middleNotes: [
      {"name": "Dừa bào (Coconut)"},
      {"name": "Hoa Dành dành (Gardenia)"},
      {"name": "Hoa Cam"},
      {"name": "Hoa mẫu đơn đoan trang"}
    ],
    baseNotes: [
      {"name": "Gỗ đàn hương (Sandalwood)"},
      {"name": "Xạ hương"},
...
Đi chơi, hẹn hò, party, hoặc khi muốn ĐƯỢC KHEN. Xịt 2 nhát cổ — xong. Dùng quanh năm nhưng đẹp nhất xuân và thu. Chai niche mà ai ngửi cũng thích.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":15,"fall":25,"winter":35},
    ...
    score: {"scent":9,"uniqueness":8,"compliments":9.5,"value":9,"total":8.9},
    topNotes: [
      {"name": "Bạc hà ngâm sương (Mint)"},
      {"name": "Kẹo Táo đỏ (Candy Apple)"},
      {"name": "Chanh vàng"},
      {"name": "Quýt cam"}
    ],
    middleNotes: [
    ...
    baseNotes: [
      {"name": "Vani sệt (Vanilla)"},
      {"name": "Gỗ Tuyết tùng"},
      {"name": "Gỗ Đàn hương xanh"},
      {"name": "Da lộn"}
    ],
    accords: [
...
Đi làm, du lịch, đi cà phê, gặp gỡ, đi chơi ban ngày. Xịt 2-3 nhát: cổ, cổ tay, tóc. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng rất thoải mái — chypre khô rất dễ chịu khi nóng.`,
  ...
  },
  {
    ...
    score: {"scent":9.3,"uniqueness":8.8,"compliments":9,"value":8.5,"total":8.9},
    topNotes: [
      {"name": "Bạch đậu khấu (Cardamom)"}
    ],
    middleNotes: [
      {"name": "Da thuộc thô (Leather)"},
      {"name": "Hoa Nhài Sambac trắng"}
    ],
    baseNotes: [
      {"name": "Hổ phách tươi (Amber)"},
      {"name": "Rêu sồi (Oakmoss)"},
...
Đi event trang trọng, đám cưới, gặp bạn bè quan trọng, hoặc khi muốn cảm giác sang trong không gian riêng. Xịt 2 nhát: sau cổ và cổ tay. Trời mát-lạnh là lý tưởng. Ở Sài Gòn chỉ dùng tối trong nhà hàng hoặc phòng điều hòa mạnh. Hà Nội mùa đông là thiên đường cho chai này.`,
  ...
  },
  {
    ...
    middleNotes: [
      {"name": "Gỗ Trầm hương (Oud)"},
      {"name": "Gỗ hồng mộc Brazil (Rosewood)"},
      {"name": "Gỗ đàn hương mềm"}
    ],
    baseNotes: [
      {"name": "Vanilla mượt"},
      {"name": "Đậu Tonka"},
...
Đi học, đi café, cuối tuần, hoặc khi muốn cozy casual. Xịt 3 nhát cổ. Quanh năm. Chai easy-wearing giá tốt nhất.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":10,"summer":0,"fall":40,"winter":50},
    dayNight: {"day":25,"night":75},
    ...
    score: {"scent":9.2,"uniqueness":9,"compliments":9.2,"value":8.5,"total":9},
    topNotes: [
      {"name": "Lá Thuốc lá non"},
      {"name": "Gia vị cay"}
    ],
    middleNotes: [
      {"name": "Vani béo ngậy (Vanilla)"},
      {"name": "Bột Cacao"},
      {"name": "Đậu Tonka"},
      {"name": "Hoa lá thuốc"}
    ],
...
Mùa thu đông, buổi tối, tiệc, sự kiện, dịp lãng mạn. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9.4,"uniqueness":9.5,"compliments":9,"value":8,"total":9},
    topNotes: [
      {"name": "Quả Mâm xôi (Raspberry)"},
      {"name": "Nhụy Hoa nghệ tây (Saffron)"},
      {"name": "Xạ hương cỏ thơm"}
    ],
    middleNotes: [
      {"name": "Nhũ hương (Olibanum)"},
      {"name": "Hoa nhài thanh đêm"}
    ],
    baseNotes: [
      {"name": "Da thuộc xịn (Leather)"},
      {"name": "Da lộn (Suede)"},
      {"name": "Gỗ khô"},
      {"name": "Hổ phách"}
    ],
...
Mùa hè, đi dạo, du lịch, khi muốn mùi TƯƠI KHÁC BIỆT. Xịt 4-5 nhát vì EDT nhẹ. Sài Gòn quanh năm. Hà Nội tháng 4-10. Chai để đi biển đẹp nhất.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":8,"compliments":9.5,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Oải hương tím (Lavender)"},
      {"name": "Vani rắc"}
    ],
    middleNotes: [
      {"name": "Vani Bourbon quyến rũ"},
      {"name": "Tiêu non"}
    ],
    baseNotes: [
      {"name": "Cỏ hương bài (Vetiver)"},
...
Hẹn hò, đi chơi tối, tụ tập cuối tuần, bar. Xịt 2 nhát: 1 sau gáy, 1 cổ tay. Đẹp nhất trời mát dưới 25°C — mùa đông hoặc mùa mưa. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh. Đừng dùng đi làm ban ngày.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Rễ cây Diên Vĩ (Orris Root)"},
      {"name": "Bột Hạnh nhân"}
    ],
    middleNotes: [
      {"name": "Vani béo"},
      {"name": "Hương Hoa nhài"},
      {"name": "Hương động vật (Animal Notes)"}
    ],
    baseNotes: [
      {"name": "Vanilla nguyên sinh"},
      {"name": "Gỗ đàn hương (Sandalwood)"},
      {"name": "Xạ hương phấn trắng"}
    ],
    accords: [
...
Mùa đông, buổi tối, tiệc, sự kiện, dịp đặc biệt. Xịt 1-2 nhát DUY NHẤT — tỏa cực mạnh. Đẹp nhất khi dưới 22°C. Ở Sài Gòn chỉ dùng buổi tối phòng máy lạnh.`,
...
},
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":40,"summer":50,"fall":5,"winter":5},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":8.8,"uniqueness":7.5,"compliments":8.5,"value":9,"total":8.4},
    topNotes: [
      {"name": "Quả Yuzu (Chanh Nhật)"},
