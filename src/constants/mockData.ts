...
Mùa đông, buổi tối. Xịt 1 nhát — tỏa cả phòng. Đẹp nhất khi trời lạnh. Ở Sài Gòn chỉ dùng tối trong phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/mugler-angel-muse-main.jpg", source: "amazon", caption: "MUGLER Angel Muse chính hãng", verified: true }],
...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 1-2 nhát — tỏa rất mạnh. Đẹp nhất khi trời mát dưới 25°C. Ở Sài Gòn dùng buổi tối phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-antaeus-main.jpg", source: "amazon", caption: "CHANEL Antaeus chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
