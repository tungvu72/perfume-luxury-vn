...
Quanh năm — đi làm, đi học, gặp gỡ, gym, dạo phố. Xịt 2-3 nhát: cổ, ngực. Dùng thoải mái mọi lúc. Ở Sài Gòn dùng quanh năm. Chai safe choice hoàn hảo.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 6,
    seasons: {"spring":55,"summer":25,"fall":15,"winter":5},
    dayNight: {"day":85,"night":15},
    ...
    topNotes: [
      ...
      {"name": "Quả vải (Litchi)"},
      {"name": "Hoa lan Nam Phi (Freesia)"}
    ],
    middleNotes: [
      {"name": "Hoa hồng (Rose)"},
      {"name": "Hạc đính (Lily-of-the-Valley)"},
      {"name": "Mộc lan (Magnolia)"}
    ],
    baseNotes: [
...
Mùa đông, buổi tối, khi muốn mùi DA mà không cần xăng. Xịt 1-2 nhát cổ — Le Parfum quá mạnh nếu xịt nhiều. Hà Nội tháng 11-2. Sài Gòn chỉ tối lạnh hoặc phòng điều hòa cực mạnh. Chai aggressive nhất dòng Fahrenheit.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":35,"summer":30,"fall":25,"winter":10},
    dayNight: {"day":70,"night":30},
    ...
    score: {"scent":8,"uniqueness":7,"compliments":7,"value":8,"total":7.6},
    topNotes: [
      {"name": "Lê Nashi (Pear)"},
      {"name": "Quất (Kumquat)"},
      {"name": "Cam Bergamot"},
    ...
    middleNotes: [
      {"name": "Bạch đậu khấu (Cardamom)"},
      {"name": "Hoa phong lữ (Geranium)"},
      {"name": "Rau mùi"}
    ],
    baseNotes: [
      {"name": "Long diên hương (Ambergris)"},
      {"name": "Da lộn (Suede)"},
      {"name": "Hương bài"}
    ],
    accords: [
...
Đi làm, meeting, sự kiện cần elégance. Xịt 2-3 nhát cổ. Dùng quanh năm. Chai cho phụ nữ không cần ai khen.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":60,"summer":20,"fall":15,"winter":5},
    dayNight: {"day":85,"night":15},
...
Đi làm, họp, gặp khách. Xịt 2-3 nhát cổ. Dùng quanh năm. Cho ai thích N°19 mà muốn MỀM hơn.`,
  ...
  },
  {
    ...
    longevity: 9,
    sillage: 8,
    seasons: {"spring":15,"summer":5,"fall":35,"winter":45},
    dayNight: {"day":30,"night":70},
    ...
    score: {"scent":7.8,"uniqueness":6,"compliments":8.5,"value":7.8,"total":7.7},
    topNotes: [
      {"name": "Aldehydes"},
      {"name": "Ngọc lan tây (Ylang-Ylang)"},
      {"name": "Neroli"},
...
Đẹp nhất khi dự tiệc, đi ăn tối, dự sự kiện hoặc những dịp cần hình ảnh chỉn chu, sang trọng. Xịt 2 nhát: 1 cổ, 1 cổ tay — đủ rồi vì tỏa mạnh. Hợp trời mát, mùa thu đông. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh. Đừng dùng đi gym hay đi biển.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":35,"summer":10,"fall":30,"winter":25},
    dayNight: {"day":60,"night":40},
...
Dùng hằng ngày — đi làm, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất mùa thu đông. Ở Sài Gòn dùng thoải mái vì EDT khá nhẹ. Đây là bản daily-wear lý tưởng của N°5.`,
  ...
  },
  {
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":7,"value":8.4,"total":8},
    topNotes: [
      {"name": "Aldehydes"},
      {"name": "Ngọc lan tây (Ylang-Ylang)"},
      {"name": "Neroli"}
    ...
    middleNotes: [
      {"name": "Hoa nhài vùng Grasse"},
      {"name": "Hoa hồng"},
      {"name": "Gốc diên vĩ (Orris Root)"}
    ],
    baseNotes: [
      {"name": "Gỗ đàn hương"},
      {"name": "Hương bài (Civet)"},
...
Buổi tối, hẹn hò, tiệc, sự kiện hoặc trời mát. Xịt 2 nhát: cổ và ngực. Đẹp nhất thu-đông. Ở Việt Nam hợp tối mát, phòng máy lạnh hoặc mùa lạnh Hà Nội. Đừng dùng giữa trưa nắng gắt.`,
  ...
  },
  {
    ...
    score: {"scent":8,"uniqueness":7,"compliments":8.5,"value":8,"total":8},
    topNotes: [
      {"name": "Mận Mirabelle"},
      {"name": "Cam Bergamot"},
      {"name": "Chanh (Lemon)"},
...
Hẹn hò, tối, dịp riêng tư. Xịt 1-2 nhát: cổ hoặc ngực. Đẹp nhất thu đông (15-25°C). Ở Việt Nam dùng tối phòng máy lạnh. Chai cho người đã biết mình thích gì — không phải chai an toàn cho người mới.`,
...
},
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":30,"summer":30,"fall":25,"winter":15},
    ...
    topNotes: [
      {"name": "Quả dứa (Pineapple)"},
      {"name": "Cam Bergamot"},
      {"name": "Quả lý chua đen"},
      {"name": "Quả táo"}
    ],
    middleNotes: [
      {"name": "Gỗ sồi bạch dương (Birch)"},
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Hồng Maroc"}
    ],
    baseNotes: [
      {"name": "Xạ hương (Musk)"},
      {"name": "Rêu sồi (Oak moss)"},
