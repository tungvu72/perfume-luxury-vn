...
Gặp khách VIP, sự kiện, tiệc tối, dịp quan trọng. Xịt 2 nhát: 1 cổ, 1 ngực. Đẹp nhất mùa thu đông hoặc buổi tối. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":25,"summer":60,"fall":10,"winter":5},
    ...
    score: {"scent":8.2,"uniqueness":6,"compliments":8,"value":8.2,"total":7.8},
    topNotes: [
      {"name": "Chanh xanh (Lime)"},
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Cam Bergamot"},
      {"name": "Cam (Orange)"}
    ],
    middleNotes: [
      {"name": "Hương nước biển (Sea Water)"},
...
Mùa hè, ban ngày, đi biển, đi làm, dạo phố, thể thao — mọi lúc trời nóng. Xịt 4-5 nhát vì EDT tỏa nhẹ. Ở Sài Gòn dùng quanh năm. Hà Nội tháng 4-9. Chai mà mọi nam giới nên thử ít nhất một lần trong đời — biết mình thích hay không, rồi đi tiếp.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":50,"fall":20,"winter":5},
    ...
    score: {"scent":8.8,"uniqueness":7,"compliments":8.5,"value":8.8,"total":8.4},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Hương nước biển (Sea Water)"}
    ],
    ...
    baseNotes: [
      {"name": "Trầm hương trắng (Olibanum)"},
...
Đi làm, gặp khách, ăn tối, hoặc dịp cần mùi sạch-sang nhưng không nhẹ quá. Xịt 2-3 nhát: cổ và ngực. Dùng quanh năm — xuân hè là tốt nhất vì DNA biển, nhưng hoắc hương giữ được cả thu đông. Cả Sài Gòn và Hà Nội dùng thoải mái.`,
  ...
  },
  {
    ...
    topNotes: [
      ...
      {"name": "Aquozone"},
      {"name": "Cam Bergamot"},
      {"name": "Quýt Mandarin xanh"}
    ],
    middleNotes: [
      {"name": "Hương thảo (Rosemary)"},
      {"name": "Oải hương (Lavender)"},
      {"name": "Cây xô thơm (Cypress)"}
    ],
    baseNotes: [
      {"name": "Khoáng chất (Mineral Notes)"},
      {"name": "Xạ hương"},
      {"name": "Hổ phách"}
    ],
    accords: [
...
Đi làm, đi chơi ban ngày, du lịch biển, dạo phố. Xịt 3 nhát: cổ, ngực, cổ tay. Dùng xuân hè là đẹp nhất — ở Sài Gòn dùng quanh năm. Hà Nội từ tháng 3-10. Mùa đông có thể hơi lạnh vì khoáng. Chai "làm mới AdG" cho thế hệ 2020.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":30,"summer":40,"fall":20,"winter":10},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":8.8,"uniqueness":7.5,"compliments":9,"value":8.8,"total":8.5},
    topNotes: [
      {"name": "Hương nước biển (Sea Water)"},
      {"name": "Cam Bergamot"}
    ],
...
Đi ăn tối ở nhà hàng, dự sự kiện buổi tối, hoặc khi muốn mặc đồ đen ra ngoài. Xịt 2 nhát sau cổ và cổ tay. Đẹp nhất thu đông — Hà Nội tháng 10-2 là lý tưởng. Ở Sài Gòn thì dùng tối, phòng máy lạnh. Tránh ban ngày nóng vì hoắc hương sẽ nặng.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":20,"summer":10,"fall":40,"winter":30},
    dayNight: {"day":50,"night":50},
    ...
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Lá cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa diên vĩ (Iris)"},
      {"name": "Củ diên vĩ (Orris)"},
      {"name": "Aldehydes"},
      {"name": "Cây xô thơm (Clary Sage)"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka (Tonka Bean)"},
...
Đi ăn tối, hẹn hò, sự kiện. Xịt 2-3 nhát cổ. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối điều hòa.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":15,"summer":10,"fall":35,"winter":40},
    dayNight: {"day":35,"night":65},
    ...
    score: {"scent":8.4,"uniqueness":8.5,"compliments":8,"value":8.4,"total":8.4},
    topNotes: [
      {"name": "Quế (Cinnamon)"},
      {"name": "Đinh hương (Cloves)"}
    ],
...
Đêm mùa đông, sự kiện muốn gây ấn tượng MẠNH. Xịt 1-2 nhát SAU CỔ — chấm hết. Hà Nội tháng 12-2. Sài Gòn hoàn toàn không nên. Chai gây sợ đẹp nhất lịch sử.`,
  ...
  },
  {
    ...
    score: {"scent":8.2,"uniqueness":9,"compliments":8,"value":8.2,"total":8.2},
    topNotes: [
      {"name": "Hoa hồng (Rose)"},
      {"name": "Quả mâm xôi (Raspberry)"},
      {"name": "Đinh hương (Cloves)"}
    ],
    middleNotes: [
      {"name": "Hoắc hương (Patchouli)"},
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    score: {"scent":8.5,"uniqueness":7,"compliments":8.5,"value":8.5,"total":8.2},
    topNotes: [
      {"name": "Hương nước biển (Sea Water)"},
      {"name": "Quýt Mandarin (Mandarin Orange)"}
    ],
...
Đi chơi, hẹn hò, party, hoặc khi muốn fun + unique. Xịt 3 nhát cổ. Quanh năm — hồng tươi mùa hè, nhũ hương ấm mùa đông. Chai để phá lệ.`,
...
},
  {
    ...
    score: {"scent":7.6,"uniqueness":6,"compliments":9,"value":7.6,"total":7.8},
    topNotes: [
      {"name": "Hoa cam (Orange Blossom)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa huệ trắng (Tuberose)"},
      {"name": "Hoa nhài Ấn Độ (Jasmine)"}
    ],
    baseNotes: [
      {"name": "Vani Madagascar (Vanilla)"},
      {"name": "Xạ hương trắng (White Musk)"},
      {"name": "Gỗ tuyết tùng"}
    ],
    accords: [
