...
Angels' Share đẹp nếu bạn muốn một mùi có màu sắc rất rõ. Điểm yếu là nó khá dày và khó thành chai dùng hằng ngày.`,
    ...
    seoTitle: "Kilian Angels' Share giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Kilian Angels' Share chính hãng: mùi cognac quế vanilla sang trọng, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Dùng được quanh năm nhưng đẹp nhất mùa thu đông và trời mát. Hợp đi làm, gặp khách, dự tiệc hoặc bất kỳ dịp nào cần hình ảnh lịch thiệp. Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Ở Sài Gòn dùng ban ngày trong phòng máy lạnh rất đẹp. Đây là kiểu mùi an toàn cao — gần như không bao giờ sai.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dior-hypnotic-poison-main.jpg", source: "amazon", caption: "DIOR Hypnotic Poison chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
