...
### Nguồn gốc và xuất xứ
Đây là sản phẩm thuộc Giorgio Armani - thương hiệu Ý vốn mạnh ở nhóm Thiết kế thanh lịch, dễ dùng và có tính đại chúng tốt hơn nhiều dòng niche khó ngửi.
...
Đây là một chai dễ được thích ngay, đặc biệt nếu gu của bạn thiên về mùi ấm và dễ tạo thiện cảm. Điểm yếu là hơi ngọt nếu dùng sai thời tiết.`,
    ...
    tags: ["Hẹn hò", "Thu đông", "Nam ngọt", "Thiết kế"],
  ...
  },
  {
    ...
    article: `Ở Maison de SON, Khamrah thường được nhắc đến như một chai nước hoa Phi giới tính ngọt ấm rất nổi trong tầm giá dễ tiếp cận. Với người thích phong cách đậm, có phần giống món tráng miệng và dễ gây chú ý, bản này của Lattafa khá đáng thử.
...
- Không hợp lắm nếu bạn chỉ thích kiểu Tươi sạch nhẹ
...
Đây là một chai dễ làm người ta nhớ nếu gu của bạn thiên ngọt ấm. Điểm trừ là không hợp số đông trong thời tiết nóng và không phải ai cũng chịu được độ dày của nó.`,
    ...
    baseNotes: [{ name: "Vani" }, { name: "Đậu tonka" }, { name: "Hổ pháchwood" }, { name: "Benzoin" }, { name: "Myrrh" }, { name: "Akigalawood" }],
    accords: [
    ...
    tags: ["Gourmand", "Phi giới tính", "Thu đông", "Giá mềm"],
...
### Nhận xét của Maison de SON
Nếu chỉ giữ một chai Thiết kế nam để dùng nhiều hoàn cảnh, Bleu de Chanel EDP luôn là ứng viên rất mạnh. Điểm yếu duy nhất là nó an toàn quá, nên ai thích mùi thật cá tính có thể sẽ thấy chưa đủ đã.`,
    ...
    accords: [
      ...
      { name: "Tươi spicy", value: 56, color: "#c58a2b" }
    ],
    tags: ["Văn phòng", "Đa dụng", "Thiết kế", "Nam", "Dễ dùng"],
...
Đây là một chai nữ rất dễ gây nghiện nếu bạn thích hướng ngọt tối. Điểm yếu là dùng ban ngày trời nóng có thể hơi gắt và hơi bí nếu xịt nhiều.`,
    ...
    tags: ["Nữ", "Buổi tối", "Hẹn hò", "Thiết kế"],
...
Aventus đáng thử vì nó là một hệ quy chiếu quan trọng. Nhưng cũng cần nói thật: giá cao, batch là chuyện có thật, và không phải ai ngửi xong cũng thấy xứng đáng ngay với số tiền bỏ ra.`,
    ...
    tags: ["Niche", "Nam", "Biểu tượng", "Chủ lực"],
  ...
  },
  {
    ...
    description: "Đây là kiểu mùi ngọt trong, sang và rất dễ để lại ấn tượng. Hợp người thích mùi nổi tiếng, có độ nhận diện cao và thiên Phi giới tính. Nếu bạn không thích kiểu mùi ngọt hơi bay bay hoặc sợ đụng hàng, bạn nên cân nhắc.",
    article: `Tại Maison de SON, Baccarat Rouge 540 là một trong những chai nước hoa Phi giới tính được nhắc đến nhiều nhất trong vài năm gần đây. Nó không phải kiểu mùi ai cũng mô tả được bằng lời, nhưng lại là kiểu ngửi một lần rất dễ nhớ. Trong các sáng tạo nổi bật của Maison Francis Kurkdjian, đây là cái tên có sức ảnh hưởng mạnh nhất.
...
BR540 nổi tiếng là có lý do, vì nó thực sự tạo ra hiệu ứng nhận diện rất mạnh. Nhưng cũng cần nói thật: vì nổi quá nên cảm giác độc lạ của nó không còn như thời đầu nữa.`,
    verdict: "Mùi này sang, ngọt và rất dễ bị nhớ. Hợp người thích mùi Phi giới tính có độ nhận diện cao và muốn tạo dấu ấn. Nếu bạn ghét đụng hàng hoặc không thích ngọt, bản này có thể không hợp.",
    ...
    middleNotes: [{ name: "Hổ pháchwood" }, { name: "Hổ pháchgris" }],
    ...
    tags: ["Phi giới tính", "Niche", "Hổ phách", "Biểu tượng"],
  ...
  },
  {
    ...
    description: "Đây là kiểu mùi ấm, tối và hơi sang theo kiểu đi tối. Hợp người muốn mùi nam khác với nhóm Tươi văn phòng. Nếu bạn cần một chai nhẹ, sạch và dễ dùng ban ngày thì bản này hơi nặng.",
    article: `Tại Maison de SON, Tom Ford Noir Extreme là một trong những chai nước hoa nam hợp với người thích phong cách buổi tối rõ ràng. Nó không phải kiểu dễ dùng nhất, nhưng lại có nét riêng hơn nhiều chai Thiết kế an toàn. Trong nhóm mùi tối của Tom Ford, đây là cái tên khá dễ tiếp cận.
...
### Ra mắt khi nào?
Noir Extreme EDP ra mắt năm 2015 và nhanh chóng trở thành một trong những chai tối nổi bật nhất ở nhóm Thiết kế nam cao cấp.

### Câu chuyện ra đời
Dòng Noir vốn đã mang màu sắc tối và chỉn chu, nhưng Noir Extreme đi xa hơn bằng cách thêm cảm giác indulgent, ấm, hơi ngọt và có phần ăn chơi hơn. Đây là kiểu mùi dành cho người muốn bước ra khỏi vùng an toàn của nhóm Tươi sạch.
...
Noir Extreme là kiểu mùi dùng đúng lúc thì rất đẹp. Điểm yếu là không linh hoạt bằng các chai đa dụng, nên mua nó là phải xác định rõ nhu cầu.`,
    ...
    tags: ["Tom Ford", "Buổi tối", "Thu đông", "Thiết kế"],
