...
Nên mua khi mày muốn một chai ban ngày thật thực dụng. Nếu mày cần mùi đậm, tối hoặc thật nổi, nên tìm hướng khác.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/narciso-rodriguez-pure-musc-for-her-main.jpg", source: "amazon", caption: "NARCISO RODRIGUEZ Pure Musc For Her chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
...
Đi làm, đi ăn, gặp bạn bè — dùng hàng ngày. Xịt 2-3 nhát cổ. Dùng quanh năm. Cả SG lẫn HN. Chai Poison cho ai sợ Poison gốc.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/amouage-reflection-45-man-main.jpg", source: "amazon", caption: "AMOUAGE Reflection 45 Man chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Đi làm sang trọng, gặp khách hàng quan trọng, đi ăn trưa ở nhà hàng, hoặc bất cứ khi nào muốn tạo hình ảnh chỉnh tề mà không cần la hét. Xịt 3 nhát: cổ, ngực, cổ tay. Dùng quanh năm — Sài Gòn hay Hà Nội đều thoải mái vì mùi rất sạch. Tránh đi club hay nhậu — lãng phí.`,
  ...
  },
  {
    ...
    name: "Rive Gauche",
    subName: "Eau de Toilette",
    perfumer: "Jacques Polge & Michel Hy",
    gender: "nu",
    image: "/images/products/ysl-rive-gauche-main.jpg",
    images: [{ url: "/images/products/ysl-rive-gauche-main.jpg", source: "amazon", caption: "YVES SAINT LAURENT Rive Gauche chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
