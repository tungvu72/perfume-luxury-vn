...
Đi gallery, ăn tối sang, sự kiện nghệ thuật, hoặc khi nào muốn mùi hương là tác phẩm chứ không phải phụ kiện. Xịt 2-3 nhát: cổ và cổ tay. Dùng quanh năm — bạch chỉ giữ tươi mùa hè, vani giữ ấm mùa đông. Chai dành cho người hiểu nước hoa.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":9,"compliments":9.5,"value":8.5,"total":9.1},
    topNotes: [
      {"name": "Rượu Cognac"}
    ],
    middleNotes: [
    ...
    baseNotes: [
      {"name": "Kẹo Praline (Praline)"},
      {"name": "Vani (Vanilla)"},
      {"name": "Đàn hương trắng"}
    ],
    accords: [
      {"name": "Gỗ", "value": 100, "color": "#8b4513"},
...
Date night, đi bar, đi club, hoặc bất cứ tối nào muốn được KHEN. Xịt 2 nhát cổ — CHẤM HẾT. Parfum tỏa cực mạnh. Thu đông — Hà Nội tháng 10-2. Sài Gòn chỉ tối phòng điều hòa. Compliment beast đúng nghĩa.`,
  ...
  },
  {
    ...
    subName: "Le Parfum",
    perfumer: "Quentin Bisch, Nathalie Gracia-Cetto",
    year: 2020,
    gender: "nam",
    longevity: 7,
    sillage: 8,
    ...
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Hương phương đông (Oriental Notes)"},
      {"name": "Gỗ (Woody Notes)"}
    ],
    accords: [
      {"name": "Cay ấm", "value": 100, "color": "#d2691e"},
...
Hẹn hò, đi chơi tối, tiệc, sự kiện. Xịt 2-3 nhát: cổ, sau tai, cổ tay. Đẹp nhất mùa thu đông, trời mát dưới 25°C. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":9.5,"value":9,"total":8.8},
    topNotes: [
      {"name": "Quả Lê (Pear)"},
      {"name": "Bạc hà (Mint)"},
      {"name": "Cam Bergamot"}
...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 1-2 nhát — tỏa khá mạnh. Đẹp nhất khi trời mát. Ở Sài Gòn chỉ dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":9,"value":8,"total":8.4},
    topNotes: [
      {"name": "Hoa Cam Neroli"},
      {"name": "Cam Bergamot"},
      {"name": "Hạt tiêu hồng"}
    ...
    middleNotes: [
      {"name": "Hoa Cam (Orange Blossom)"},
      {"name": "Hoa Kim Ngân (Honeysuckle)"},
      {"name": "Hoa Nhài"}
    ],
    baseNotes: [
      {"name": "Mia đường (Sugar)"},
      {"name": "Caramel"},
      {"name": "Vani (Vanilla)"}
    ],
    accords: [
...
Hẹn hò, đêm đặc biệt, phòng ngủ. Xịt 1-2 nhát cổ. Mùa đông only. Chai xịt tên là SEX — bạn hiểu rồi.`,
  ...
  },
  {
    ...
    score: {"scent":8.5,"uniqueness":8,"compliments":9,"value":8,"total":8.4},
    topNotes: [
      {"name": "Hoa Lan (Orchid)"},
      {"name": "Hoa Nhài (Jasmine)"}
    ],
...
Hẹn hò, tối, dịp riêng tư. Xịt 1-2 nhát: cổ hoặc ngực. Đẹp nhất thu đông (15-25°C). Ở Việt Nam dùng tối phòng máy lạnh. Chai cho người đã biết mình thích gì — không phải chai an toàn cho người mới.`,
...
},
  {
    ...
    score: {"scent":9,"uniqueness":9.5,"compliments":8.5,"value":8,"total":8.8},
    topNotes: [
      {"name": "Rượu Rum"},
      {"name": "Mia đường (Sugar)"}
    ],
    middleNotes: [
      {"name": "Socola đen (Dark Chocolate)"},
      {"name": "Cà phê đen (Coffee)"},
      {"name": "Caramel"}
    ],
    baseNotes: [
      {"name": "Hạnh nhân (Almond)"},
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":20,"summer":15,"fall":35,"winter":30},
    dayNight: {"day":45,"night":55},
...
},
  {
    ...
    score: {"scent":8.5,"uniqueness":8.5,"compliments":9.5,"value":8,"total":8.6},
    topNotes: [
      {"name": "Hoa Mộc Tê (Osmanthus)"},
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Hoa Hồng Đan Mạch"}
    ],
    middleNotes: [
      {"name": "Hoa Huệ Tây (Tuberose)"},
      {"name": "Hoa Thủy Tiên (Narcissus)"}
    ],
    baseNotes: [
      {"name": "Hổ Phách (Amber)"},
...
},
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":8.5,"value":7.5,"total":8.2},
    topNotes: [
      {"name": "Sữa Hạnh Nhân (Almond)"},
      {"name": "Xạ hương Ambrette"}
    ],
    middleNotes: [
      {"name": "Hoa Diên Vĩ (Iris)"},
      {"name": "Hoa Lan Nam Phi (Freesia)"}
