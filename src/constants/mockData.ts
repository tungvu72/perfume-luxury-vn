...
Đi tối là chính — bar, quán cà phê, đi chơi cuối tuần, hẹn hò casual. Xịt 1-2 nhát thôi: 1 sau gáy và 1 cổ tay. Đủ rồi vì mùi rất tỏa. Hợp trời mát, mùa đông hoặc buổi tối mùa mưa Sài Gòn. Đừng xịt 3-4 nhát đi ăn trong nhà hàng nhỏ — mọi người xung quanh sẽ chỉ ngửi thấy bạn thôi.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":25,"summer":15,"fall":35,"winter":25},
    ...
    score: {"scent":8.6,"uniqueness":8,"compliments":8.5,"value":7.6,"total":8.3},
    topNotes: [
      {"name": "Bưởi"},
      {"name": "Cam Bergamot"},
      {"name": "Lý chua đen"}
...
Dùng được quanh năm — đi làm, đi chơi, du lịch, hẹn hò nhẹ. Đẹp nhất vào mùa xuân và hè khi trời ấm (25-32°C), nhưng mùa thu cũng rất ổn. Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Ở Sài Gòn dùng ban ngày rất thoải mái vì biển + thảo mộc không bao giờ ngọp. Đây là kiểu chai an toàn cho mọi hoàn cảnh — hiếm khi nào xịt Profumo mà sai.`,
  ...
  },
  {
    ...
    score: {"scent":8.6,"uniqueness":8,"compliments":8.5,"value":8.6,"total":8.5},
    topNotes: [
      {"name": "Lá cam Mandarin"},
      {"name": "Hoa cam khô"}
    ],
    middleNotes: [
      {"name": "Hoa nhài Sambac"}
    ],
    baseNotes: [
      {"name": "Vani Bourbon (Bourbon Vanilla)"}
    ],
    accords: [
...
Mùa hè, ban ngày, đi brunch, dạo phố kiểu gentleman Ý. Xịt 4-5 nhát vì tỏa nhẹ. Đẹp nhất khi trời nóng. Ở Sài Gòn dùng quanh năm.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":30,"summer":60,"fall":8,"winter":2},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":7.8,"uniqueness":6,"compliments":7,"value":8.8,"total":7.4},
    topNotes: [
      {"name": "Nước biển"},
      {"name": "Bạc hà"},
      {"name": "Lá xanh"},
...
Mùa thu đông, buổi tối, dịp đặc biệt, tiệc sang. Xịt 2 nhát: cổ, cổ tay. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối phòng máy lạnh.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":45,"summer":20,"fall":25,"winter":10},
    dayNight: {"day":80,"night":20},
    ...
    score: {"scent":8.4,"uniqueness":7,"compliments":7,"value":7.4,"total":7.8},
    topNotes: [
      {"name": "Cỏ đuôi ngựa (Lemon Verbena)"},
      {"name": "Hoa diên vĩ"}
    ],
    middleNotes: [
      {"name": "Lá Violet (Violet Leaf)"}
    ],
    baseNotes: [
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":7,"value":7.2,"total":7.6},
    topNotes: [
      {"name": "Vỏ cam (Orange Peel)"}
    ],
    middleNotes: [
      {"name": "Hoa mộc lan (Magnolia)"},
      {"name": "Gạo (Rice)"},
...
},
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":35,"summer":45,"fall":15,"winter":5},
    dayNight: {"day":80,"night":20},
    ...
    middleNotes: [
      {"name": "Trà xanh (Green Tea)"},
      {"name": "Lý chua đen (Black Currant)"}
    ],
    baseNotes: [
      {"name": "Xạ hương"},
      {"name": "Lá cam (Petitgrain)"},
...
Đẹp nhất khi trời mát — mùa đông Hà Nội hoặc mùa mưa Sài Gòn. Hợp đi ăn tối, dự tiệc hoặc những dịp muốn tạo dấu ấn. Xịt 1 nhát sau gáy và 1 nhát cổ tay là đủ — đừng xịt quá 2 nhát vì mùi rất tỏa. Dùng ban ngày trong phòng máy lạnh cũng đẹp. Đừng dùng ngày nóng 35°C ngoài trời vì sẽ hơi ngọp.`,
...
},
  {
    ...
    longevity: 8,
    sillage: 6,
    seasons: {"spring":30,"summer":15,"fall":35,"winter":20},
    dayNight: {"day":45,"night":55},
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":7,"value":8.2,"total":7.8},
    topNotes: [
      {"name": "Trái mọng đỏ (Red berries)"}
    ],
    middleNotes: [
      {"name": "Hồng tháng 5 (May Rose)"},
      {"name": "Hồng Grasse"}
    ],
    baseNotes: [
      {"name": "Hoắc hương (Patchouli)"},
...
},
  {
    ...
    longevity: 8,
    sillage: 6,
    seasons: {"spring":25,"summer":10,"fall":35,"winter":30},
    dayNight: {"day":40,"night":60},
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":7,"value":8.4,"total":8},
    topNotes: [
      {"name": "Quả quýt (Mandarin)"},
      {"name": "Mơ (Apricot)"},
      {"name": "Đào (Peach)"}
    ],
    middleNotes: [
      {"name": "Dâu tây rừng"},
      {"name": "Các nốt hoa dại"}
    ],
    baseNotes: [
      {"name": "Hoắc hương"},
      {"name": "Amberwood"},
...
Dùng được quanh năm — đi làm, đi học, đi chơi, hẹn hò nhẹ. Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Đẹp nhất vào mùa xuân và thu khi trời mát (22-28°C). Ở Sài Gòn dùng tốt trong phòng máy lạnh. Đây là kiểu chai xịt xong đi luôn, không cần nghĩ nhiều. Đừng dùng cho dịp quan trọng cần gây ấn tượng mạnh — Y EDP là mùi dễ chịu hơn là mùi ấn tượng.`,
...
},
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":35,"summer":35,"fall":20,"winter":10},
    dayNight: {"day":80,"night":20},
    ...
    score: {"scent":8.2,"uniqueness":7,"compliments":7,"value":7.2,"total":7.5},
    topNotes: [
      {"name": "Táo xanh"},
      {"name": "Cam Bergamot"},
      {"name": "Hoắc hương"},
