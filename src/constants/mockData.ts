...
Dùng quanh năm — đi làm, đi ăn tối nhẹ, gặp gỡ, tiệc nhỏ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa thu đông nhưng xuân hè vẫn OK. Ở Sài Gòn dùng thoải mái vì cân bằng tốt.`,
  ...
  },
  {
    ...
    gender: "nam",
    year: 2014,
    image: "/images/products/chanel-allure-homme-edition-blanche-main.jpg",
    images: [
      { url: "/images/products/chanel-allure-homme-edition-blanche-main.jpg", source: "fragram", caption: "Chanel Allure Homme Édition Blanche chính hãng", verified: true }
    ],
...
Đi chơi tối, hẹn hò, bar, hoặc dịp muốn khác biệt với Boss thường. Xịt 2-3 nhát: cổ và ngực. Thu đông — Hà Nội tháng 10-2. Sài Gòn tối phòng điều hòa. Chai cho ai muốn thử "dark side" của Boss.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/versace-bright-crystal-main.jpg", source: "fragram", caption: "Versace Bright Crystal EDT chính hãng", verified: true }],
...
Đi ăn tối, sự kiện nhẹ, hoặc khi muốn mùi Pháp thật sự. Xịt 3 nhát: cổ, ngực, cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối mát. Chai để hiểu heritage nước hoa nam.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/guerlain-habit-rouge-parfum-main.webp", source: "fragram", caption: "Guerlain Habit Rouge Parfum chính hãng", verified: true }
    ],
...
Đẹp nhất khi đi ăn tối, đi bar hoặc hẹn hò — trời dưới 25°C. Xịt 1 nhát sau gáy, 1 nhát trước ngực là vừa đủ. Mùa mưa Sài Gòn hay mùa đông Hà Nội là lúc Khamrah tỏa đẹp nhất. Đừng dùng đi làm ban ngày vì mùi quá đậm sẽ gây khó chịu cho người xung quanh. Phòng máy lạnh mát thì xịt ít hơn bình thường vì mùi sẽ đọng lại rất lâu.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/guerlain-l-homme-ideal-eau-de-parfum-main.webp", source: "fragram", caption: "Guerlain L'Homme Idéal EDP chính hãng", verified: true }
    ],
...
Đi làm, gặp khách, họp hành, dùng hằng ngày. Xịt 2-3 nhát: cổ, ngực, cổ tay. Dùng quanh năm nhưng đẹp nhất mùa xuân hè. Ở Sài Gòn dùng thoải mái — iris phấn rất dễ chịu khi nóng. Đứng cạnh ai cũng thấy bạn thơm sạch và chỉn chu. Đừng dùng đi bar đêm — quá lịch sự.`,
  ...
  },
  {
    ...
    gender: "nam",
    year: 2022,
    image: "/images/products/guerlain-lhomme-ideal-parfum-main.webp",
    images: [
      { url: "/images/products/guerlain-lhomme-ideal-parfum-main.webp", source: "fragram", caption: "Guerlain L'Homme Idéal Parfum chính hãng", verified: true }
    ],
...
Ban ngày, đi chơi, picnic, hoặc khi nào muốn VUI. Chai này = nụ cười trong lọ nước hoa. Discontinued nên dùng dè sẻn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-mitsouko-edp-main.jpg", source: "fragram", caption: "Guerlain Mitsouko EDP chính hãng", verified: true }],
...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 1-2 nhát — beast mode. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông Hà Nội nhất.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-19-eau-de-parfum-main.webp", source: "fragram", caption: "Chanel N°19 EDP chính hãng", verified: true }],
...
Dịp đặc biệt, sự kiện, khi muốn mùi hương QUYỀN LỰC. Dabbing — chấm 1-2 giọt sau tai và cổ (Parfum dạng dabber, không spray). Dùng quanh năm. Chai mà mọi phụ nữ nên ngửi một lần.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/tom-ford-noir-extreme-main.jpg", source: "ebay", caption: "Tom Ford Noir Extreme Eau de Parfum chai và hộp", verified: true },
...
Mùa thu đông, buổi tối, dịp đặc biệt, sự kiện VIP. Xịt 1-2 nhát — beast mode. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông.`,
  ...
  },
  {
    ...
    year: 2003,
    image: "/images/products/dior-homme-sport-2021-main.jpg",
    images: [{ url: "/images/products/dior-homme-sport-2021-main.jpg", source: "fragram", caption: "Dior Pour Homme chính hãng", verified: true }],
...
Mùa đông, dịp đặc biệt, tiệc sang, buổi tối. Xịt 2 nhát: cổ, cổ tay. Đẹp nhất trời lạnh. Ở Việt Nam chỉ nên dùng mùa lạnh hoặc phòng máy lạnh thật mạnh.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/guerlain-shalimar-lessence-main.webp", source: "fragram", caption: "Guerlain Shalimar L'Essence chính hãng", verified: true }
    ],
...
Mùa thu đông, buổi tối, hẹn hò, tiệc. Xịt 1-2 nhát — tỏa cực mạnh. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông Hà Nội.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chloe-signature-edp-main.jpg", source: "fragram", caption: "Montblanc Signature EDP chính hãng", verified: true }],
    description: "Chai nữ mẫu đơn-hồng-xạ hương kiểu chữ ký thanh lịch — mẫu đơn, cam, hoa hồng, vani, hoắc hương, xạ hương trắng và gỗ tuyết tùng. Nhẹ nhàng, thanh và rất office.",
    article: `### Ai không nên mua?

Nếu bạn muốn mùi cá tính mạnh — Signature quá HIỀN. Antoine Maisondieu (Hermes H24, Prada Luna Rossa Carbon) tạo chai này kiểu "chữ ký nhẹ": mẫu đơn-hồng-xạ hương mỏng, sạch, không gây phiền ai. Montblanc = thương hiệu bút — và mùi cũng vậy: tinh tế, thanh, professional.

### Có đáng tiền không?

Giá Montblanc — RẺ NHẤT nhóm designer nữ EDP. So với Versace Bright Crystal — cùng tier rẻ — thì Signature nhiều hoa hơn, ít tươi hơn. So với Chanel Chance — thì rẻ hơn 2-3 lần mà chất lượng OK. Bám 5-6 giờ.

### Nên dùng khi nào?

Đi làm, đi học, meeting, mọi lúc cần mùi AN TOÀN. Xịt 3-4 nhát cổ. Quanh năm. Chai first perfume lý tưởng.`,
    verdict: "Chữ ký nhẹ — Montblanc rẻ nhất. Maisondieu professional. Hoa-xạ hương an toàn. First perfume.",
    verdictShort: "CHỮ KÝ NHẸ, RẺ NHẤT, AN TOÀN",
    score: { scent: 7, uniqueness: 6, compliments: 7.5, value: 9.5, total: 7.5 },
    vibes: [{ label: "An toàn", icon: "✅" }, { label: "Giá rẻ", icon: "💸" }, { label: "Office", icon: "💼" }],
    longevity: 5,
    sillage: 4,
    seasons: { spring: 78, summer: 62, fall: 62, winter: 48 },
    dayNight: { day: 82, night: 38 },
    topNotes: [{ name: "Hoa mẫu đơn" }, { name: "Cam" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Vani" }],
    baseNotes: [{ name: "Hoắc hương" }, { name: "Xạ hương trắng" }, { name: "Gỗ tuyết tùng" }],
    accords: [
      { name: "Hoa", value: 100, color: "#e91e63" },
      { name: "Xạ hương", value: 62, color: "#bdc3c7" },
      { name: "Tươi mát", value: 48, color: "#2ecc71" },
    ...
    seoTitle: "Montblanc Signature EDP chính hãng mua ở đâu? Review 2026",
    metaDescription: "Đánh giá Montblanc Signature EDP chính hãng: hoa xạ hương nhẹ nhàng giá rẻ nhất designer, độ bám tỏa thực tế và tư vấn mua uy tín 2026.",
    tags: ["Nữ","An toàn","Giá rẻ","Office"],
    sizes: ["10ml Chiết","30ml Fullbox","50ml Fullbox","90ml Fullbox"],
    basePrice: 800000,
    shopeeOffers: [],
    isPublished: true
