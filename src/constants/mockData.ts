...
Chiều tối, trời mát, lái xe, đi chơi riêng hoặc dịp muốn mùi hương có bản sắc. Xịt 2 nhát: 1 cổ, 1 ngực. Đẹp nhất mùa thu đông. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh. Đừng xịt đi làm ban ngày — quá cá tính.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/tom-ford-ombre-leather-main.jpg", source: "amazon", caption: "TOM FORD Ombre Leather chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối nhẹ hoặc dùng đi làm môi trường mát. Nếu mày cần mùi thật nổi, nên tìm hướng mạnh hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/parfums-de-marly-herod-main.jpg", source: "amazon", caption: "PARFUMS DE MARLY Herod chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
