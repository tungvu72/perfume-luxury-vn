...
Với giá khoảng 5.4 triệu cho chai 60ml, Elixir đắt hơn Sauvage EDP (khoảng 3.2 triệu/100ml) và ngang với Tom Ford Noir Extreme (4 triệu/50ml). Nhưng vì mỗi lần chỉ cần xịt 2 nhát, chai 60ml dùng được rất lâu. So với Noir Extreme thì Elixir thơm xa hơn và bám lâu hơn. So với Sauvage EDP thì Elixir trưởng thành hơn, ít bị "đụng hàng" hơn. Nếu chưa quyết được, nên mua chiết 10ml dùng thử trước.
...
BR540 nổi tiếng là có lý do, vì nó thực sự tạo ra hiệu ứng nhận diện rất mạnh. Nhưng cũng cần nói thật: vì nổi quá nên cảm giác độc lạ của nó không còn như thời đầu nữa.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/tom-ford-noir-extreme-main.jpg", source: "ebay", caption: "Tom Ford Noir Extreme Eau de Parfum chai và hộp", verified: true }, { url: "/images/products/tom-ford-noir-extreme-bottle.jpg", source: "amazon", caption: "Tom Ford Noir Extreme chai", verified: true }],
...
Nên mua khi mày cần một chai tối thật đẹp. Nếu mày thích mùi sạch sáng, casual, đây không phải hướng phù hợp.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/acqua-di-gio-profumo-main.jpg", source: "amazon", caption: "GIORGIO ARMANI Acqua di Giò Profumo chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai buổi tối thật nổi. Nếu mày thích mùi nhẹ, airy hoặc quá dễ dùng ban ngày, đây không phải hướng ưu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/ysl-libre-le-parfum-main.jpg", source: "amazon", caption: "YVES SAINT LAURENT Libre Le Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối, đi chơi hoặc date night. Nếu mày ưu tiên sự sáng và linh hoạt ban ngày, bản EDP vẫn dễ sống hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/frederic-malle-portrait-of-a-lady-main.jpg", source: "amazon", caption: "FRÉDÉRIC MALLE Portrait of a Lady chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày đang tìm một signature ban ngày cao cấp. Nếu ưu tiên độ độc lạ hoặc chiều sâu buổi tối, mày nên có thêm một chai khác để bổ sung.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/hermes-terre-dhermes-parfum-main.jpg", source: "amazon", caption: "HERMÈS Terre d'Hermès Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai ban ngày lịch sự hoặc muốn hiểu một cột mốc lớn của nước hoa nam. Nếu mày thích mùi hiện đại, nổi và bám mạnh, có thể cần một hướng khác.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/marc-antoine-barrois-ganymede-main.jpg", source: "amazon", caption: "MARC-ANTOINE BARROIS Ganymède chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai signature có cá tính rất riêng hoặc muốn khám phá trường phái chypre đúng nghĩa. Nếu mày cần mùi dễ dùng mỗi ngày, đây không phải điểm bắt đầu tốt nhất.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-shalimar-lessence-main.webp", source: "amazon", caption: "GUERLAIN Shalimar L'Essence chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai event hoặc buổi tối cao cấp. Nếu mày ưu tiên sự tươi sáng, casual và giá dễ chịu hơn, nên cân nhắc hướng khác.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-lhomme-ideal-parfum-main.webp", source: "amazon", caption: "GUERLAIN L'Homme Idéal Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai signature đi làm hoặc muốn khám phá vetiver theo hướng dễ dùng. Nếu mày thích vetiver tối và nhiều cá tính, có thể sẽ hợp Encre Noire hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/frederic-malle-musc-ravageur-main.jpg", source: "amazon", caption: "FRÉDÉRIC MALLE Musc Ravageur chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối khác biệt với thị trường ngọt-fruity phổ biến. Nếu mày muốn mùi sáng, sạch và dùng dễ mỗi ngày, đây không phải hướng đầu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dior-addict-edp-2014-main.jpg", source: "amazon", caption: "DIOR Dior Addict Eau de Parfum 2014 chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai ban ngày có gu. Nếu mày thích mùi tối, ngọt hoặc cực mạnh, đây không phải hướng ưu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/giardini-di-toscana-bianco-latte-main.jpg", source: "amazon", caption: "GIARDINI DI TOSCANA Bianco Latte chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai ban ngày có gu. Nếu mày chỉ thích mùi ngọt ôm hoặc cực kỳ nữ tính cổ điển, nên test trước.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-allure-homme-edition-blanche-main.webp", source: "amazon", caption: "Ảnh chai Chanel Allure Homme Édition Blanche" }, { url: "/images/products/chanel-allure-edition-blanche-bottle.jpg", source: "studio", caption: "Ảnh chi tiết Chanel Allure Homme Édition Blanche" }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai signature ban ngày mùa nóng. Nếu mày ưu tiên chiều sâu buổi tối, bản EDT hoặc Parfum vẫn hợp hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-habit-rouge-parfum-main.webp", source: "amazon", caption: "Ảnh sản phẩm Guerlain Habit Rouge Parfum (chai và hộp)" }, { url: "/images/products/guerlain-habit-rouge-bottle.jpg", source: "studio", caption: "Ảnh chai Guerlain Habit Rouge Parfum" }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai buổi tối có khí chất. Nếu ưu tiên sự an toàn, thân thiện và dùng hằng ngày, đây không phải hướng đầu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-linstant-homme-edp-main.jpg", source: "amazon", caption: "GUERLAIN L'Instant de Guerlain pour Homme chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối tinh tế. Nếu mày thích mùi quá fresh hoặc quá dark, nên cân nhắc kỹ.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/hermes-un-jardin-sur-le-nil-main.jpg", source: "amazon", caption: "HERMÈS Un Jardin Sur Le Nil chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một mùi nữ trưởng thành và khác biệt. Nếu mày thích sự trong trẻo dễ thương, nên test trước kỹ.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/nishane-hundred-silent-ways-main.jpg", source: "amazon", caption: "NISHANE Hundred Silent Ways chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối nịnh mũi cao. Nếu mày thích mùi xanh, khô hoặc avant-garde, đây không phải hướng chính.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/jpg-la-belle-le-parfum-main.jpg", source: "amazon", caption: "JEAN PAUL GAULTIER La Belle Le Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai ban ngày nhẹ và có gu. Nếu mày muốn mùi nổi hoặc ngọt ấm, đây không phải hướng phù hợp.`,
  ...
  
  {
    ...
    images: [{ url: "/images/products/zadig-voltaire-this-is-her-main.jpg", source: "amazon", caption: "ZADIG & VOLTAIRE This Is Her! chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai đi chơi hoặc mùa mát có chất riêng. Nếu mày thích floral sáng hoặc gourmand rất ngọt, nên cân nhắc thêm.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/ysl-la-nuit-de-lhomme-bleu-electrique-main.jpg", source: "amazon", caption: "YVES SAINT LAURENT La Nuit de l'Homme Bleu Électrique chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày muốn một chai vintage gentle hơn. Nếu mày thích chiều sâu đậm và nhiều drama hơn, EDP sẽ hợp hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/frederic-malle-carnal-flower-main.jpg", source: "amazon", caption: "FRÉDÉRIC MALLE Carnal Flower chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai floral statement. Nếu mày thích mùi nhẹ, hiền và ít hoa trắng, nên test kỹ trước.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-linstant-de-guerlain-femme-main.jpg", source: "amazon", caption: "GUERLAIN L'Instant de Guerlain chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai cho dịp đẹp. Nếu mày thích mùi trẻ, ngọt hoặc quá casual, nên thử kỹ trước.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/lolita-lempicka-le-parfum-main.jpg", source: "amazon", caption: "LOLITA LEMPICKA Lolita Lempicka Le Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày muốn một chai date night hoặc mùa mát rất ăn tiền. Nếu mày ghét mùi ngọt ấm, nên test trước.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/essential-parfums-bois-imperial-main.jpg", source: "amazon", caption: "ESSENTIAL PARFUMS Bois Imperial chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tuyên ngôn cho buổi tối. Nếu mày muốn leather mềm, dễ mặc hơn, Ombré Leather thường hợp hơn.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dg-light-blue-intense-homme-main.jpg", source: "amazon", caption: "D&G Light Blue Eau Intense chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai mùa nóng dùng nhiều. Nếu mày thích mùi tối, dày hoặc quá cá tính, đây không phải hướng ưu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dg-the-one-for-men-eau-de-parfum-main.jpg", source: "amazon", caption: "DOLCE & GABBANA The One for Men Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
  ...
  },
  {
    ...
    images: [{ url: "/images/products/guerlain-l-homme-ideal-eau-de-parfum-main.webp", source: "amazon", caption: "Ảnh sản phẩm L'Homme Ideal EDP (chai và hộp)" }, { url: "/images/products/guerlain-l-homme-ideal-edp-bottle.jpg", source: "studio", caption: "Ảnh chai L'Homme Ideal EDP" }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày đã có ít nhất một chai fresh hoặc văn phòng, và đang cần một option tối hơn cho hẹn hò hay đi chơi tối. Không nên ưu tiên nó làm chai duy nhất nếu nhu cầu chính là đi làm mỗi ngày giữa thời tiết nóng.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/givenchy-gentleman-eau-de-parfum-reserve-privee-main.jpg", source: "amazon", caption: "GIVENCHY Gentleman Eau de Parfum Reserve Privee chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/givenchy-l-interdit-eau-de-parfum-rouge-main.jpg", source: "amazon", caption: "GIVENCHY L Interdit Eau de Parfum Rouge chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/versace-crystal-noir-eau-de-toilette-main.jpg", source: "amazon", caption: "VERSACE Crystal Noir Eau de Toilette chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-5-eau-de-parfum-main.jpg", source: "amazon", caption: "CHANEL Chanel No 5 Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-19-eau-de-parfum-main.webp", source: "amazon", caption: "CHANEL Chanel No 19 Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/givenchy-l-interdit-eau-de-parfum-main.jpg", source: "amazon", caption: "GIVENCHY L Interdit Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/hermes-elixir-des-merveilles-main.jpg", source: "amazon", caption: "HERMES Elixir des Merveilles chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/narciso-rodriguez-pure-musc-for-her-main.jpg", source: "amazon", caption: "NARCISO RODRIGUEZ Pure Musc For Her chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-coromandel-eau-de-parfum-main.jpg", source: "amazon", caption: "CHANEL Coromandel Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/mfk-oud-satin-mood-main.jpg", source: "amazon", caption: "MAISON FRANCIS KURKDJIAN Oud Satin Mood chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/initio-musk-therapy-main.jpg", source: "amazon", caption: "INITIO PARFUMS PRIVÉS Musk Therapy chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-coco-eau-de-toilette-main.jpg", source: "amazon", caption: "CHANEL Coco Eau de Toilette chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-5-eau-de-toilette-main.jpg", source: "amazon", caption: "CHANEL Chanel No 5 Eau de Toilette chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/narciso-rodriguez-musc-noir-rose-for-her-main.jpg", source: "amazon", caption: "NARCISO RODRIGUEZ Musc Noir Rose For Her chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
  ...
  },
  {
    ...
    images: [{ url: "/images/products/armani-acqua-di-gio-parfum-main.jpg", source: "amazon", caption: "GIORGIO ARMANI Acqua di Gio Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    score: { scent: 0, uniqueness: 0, compliments: 0, value: 0, total: 0 },
