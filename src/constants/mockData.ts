...
9PM hấp dẫn ở giá trị trên tiền bỏ ra. Điểm trừ là nó không phải kiểu mùi tinh tế hay kín đáo, nên cần dùng đúng hoàn cảnh.`,
  ...
  },
  {
    ...
    productCopy: `JPG Le Male Le Parfum là phiên bản trưởng thành và sang hơn của tinh thần Le Male. Mùi hương mở đầu với chút cay thơm của bạch đậu khấu, sau đó nhanh chóng đi vào lớp lavender mềm và vanilla ấm áp. Tổng thể mang cảm giác ngọt mượt, quyến rũ nhưng được kiểm soát rất tốt, không bị quá trẻ con hay quá ồn.

Điểm hấp dẫn của chai này là sự cân bằng giữa sexy và lịch lãm. Nó không chỉ hợp cho đi chơi tối hay hẹn hò, mà còn đủ đẹp để dùng trong những dịp cần ăn mặc chỉnh chu hơn. Mùi hương tạo cảm giác người mặc biết chăm chút hình ảnh, có sự tự tin và hơi gợi cảm theo kiểu rất hiện đại.

Khi lên da, Le Male Le Parfum trở nên dày hơn và ấm hơn sau lớp đầu. Vanilla ở đây mượt, ôm da và khá nịnh mũi, trong khi lavender giúp tổng thể vẫn giữ được sự sạch sẽ nhất định. Chính vì vậy, dù ngọt, nó vẫn không quá ngấy nếu dùng đúng thời điểm.

Về hiệu năng, chai này lưu hương tốt và tỏa hương ở mức khá. Nó phát huy đẹp nhất vào buổi tối, mùa mưa, phòng máy lạnh hoặc những dịp trời dịu. Trong khí hậu nóng ẩm Việt Nam, nếu xịt quá nhiều vào ban ngày có thể hơi dày, nên tiết chế để mùi lên đẹp hơn.

Nếu bạn cần một chai nước hoa nam vừa sexy vừa sang, dễ tạo ấn tượng trong khoảng cách gần, JPG Le Male Le Parfum là lựa chọn rất mạnh. Nó không dành cho người chỉ thích mùi fresh đơn giản, nhưng lại cực hợp với người muốn mùi hương của mình mang cảm giác ấm, cuốn và trưởng thành hơn.`,
...
Nếu bạn muốn một chai nước hoa unisex sang, mềm, tinh tế và mang cảm giác cao cấp rất rõ mà không quá phô trương, Gentle Fluidity Gold là lựa chọn cực kỳ đáng cân nhắc. Nó không dành cho người thích hiệu ứng bùng nổ, nhưng lại hoàn hảo với ai muốn thơm theo cách trưởng thành, mượt và có đẳng cấp thật sự.`,
  ...
  },
  {
    ...
    score: { scent: 9.2, uniqueness: 8.5, compliments: 9.3, value: 8, total: 8.8 },
  ...
  },
  {
    ...
    score: { scent: 9.5, uniqueness: 9.2, compliments: 9, value: 7.8, total: 8.9 },
    ...
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 6500000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9, uniqueness: 8.8, compliments: 8.5, value: 6.5, total: 8.2 },
    ...
    tags: ["Sang trọng", "Đa dụng", "Nam", "Xa xỉ"],
  ...
  },
  {
    ...
    tags: ["Niche", "Đa dụng", "Nam", "Dễ khen"],
    sizes: ["10ml Chiết", "75ml Fullbox", "125ml Fullbox"],
    basePrice: 6200000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9.4, uniqueness: 9, compliments: 8.5, value: 7.2, total: 8.5 },
  ...
  },
  {
    ...
    score: { scent: 9, uniqueness: 9.8, compliments: 7.5, value: 8.5, total: 8.7 },
    ...
    sizes: ["10ml Chiết", "50ml", "100ml", "200ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    tags: ["Tom Ford", "Da thuộc", "Nam", "Thu đông"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 4500000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9.3, uniqueness: 9, compliments: 8.2, value: 7, total: 8.4 },
    ...
    tags: ["Tom Ford", "Unisex", "Gỗ", "Sang trọng"],
    sizes: ["5ml Chiết", "10ml Chiết", "50ml", "100ml"],
    basePrice: 5500000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9.4, uniqueness: 9, compliments: 8.8, value: 7.5, total: 8.7 },
    ...
    tags: ["Buổi tối", "Cao cấp", "Nam", "Iris"],
    sizes: ["10ml Chiết", "100ml Fullbox"],
    basePrice: 5200000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9.1, uniqueness: 8.2, compliments: 9, value: 8, total: 8.6 },
    ...
    tags: ["Đa dụng", "Nam", "Biển", "Cao cấp"],
    sizes: ["10ml Chiết", "75ml", "125ml", "180ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    score: { scent: 9.2, uniqueness: 8, compliments: 9, value: 7.5, total: 8.4 },
    vibes: [{ label: "Sang trọng", icon: "✨" }, { label: "Đa dụng", icon: "🔄" }, { label: "Thanh lịch", icon: "🕴️" }],
    longevity: 9,
    sillage: 8,
    ...
    tags: ["Sang trọng", "Đa dụng", "Nam", "Gỗ"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 4800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ ngọt ấm với vani, hạnh nhân và gỗ đàn hương. Quyến rũ, bí ẩn và rất dễ gây nghiện.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani ngọt, hạnh nhân, bí ẩn. Quyến rũ kinh điển cho buổi tối.",
    verdictShort: "NGỌT, BÍ ẨN, CỰC CUỐN",
    score: { scent: 9, uniqueness: 8.5, compliments: 9, value: 8.5, total: 8.8 },
    vibes: [{ label: "Quyến rũ", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Kinh điển", icon: "👑" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 45, summer: 20, fall: 95, winter: 100 },
    dayNight: { day: 25, night: 100 },
    topNotes: [{ name: "Hạnh nhân đắng" }, { name: "Mận" }, { name: "Dừa" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa huệ" }, { name: "Hồng hoa" }],
    baseNotes: [{ name: "Vani" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Hổ phách", value: 72, color: "#d4a017" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Gia vị ấm", value: 42, color: "#e67e22" }
    ],
    tags: ["Nữ", "Buổi tối", "Ngọt", "Kinh điển"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại nữ với vani, trầm hương và cam bergamot. Sang trọng, cổ điển và đầy quyền lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Huyền thoại vani phương Đông. Sang, quyền lực và vượt thời gian.",
    verdictShort: "HUYỀN THOẠI, VANI, QUYỀN LỰC",
    score: { scent: 9.3, uniqueness: 9.5, compliments: 8.2, value: 8, total: 8.8 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Sang trọng", icon: "💎" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 50, summer: 25, fall: 90, winter: 100 },
    dayNight: { day: 35, night: 95 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }, { name: "Tiêu" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Iris" }],
    baseNotes: [{ name: "Vani" }, { name: "Trầm hương" }, { name: "Opoponax" }, { name: "Benzoin" }],
    accords: [
      { name: "Phương Đông", value: 100, color: "#8B0000" },
      { name: "Vani", value: 88, color: "#f5deb3" },
      { name: "Hổ phách", value: 72, color: "#d4a017" },
      { name: "Hoa", value: 55, color: "#e75480" }
    ],
    tags: ["Nữ", "Kinh điển", "Phương Đông", "Sang trọng"],
    sizes: ["10ml Chiết", "50ml", "90ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ hiện đại với oải hương, vani và gỗ đàn hương. Thanh lịch, nữ tính và rất dễ dùng.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Oải hương, vani, gỗ đàn hương. Thanh lịch hiện đại, dễ dùng quanh năm.",
    verdictShort: "THANH LỊCH, NỮ TÍNH, DỄ DÙNG",
    score: { scent: 8.8, uniqueness: 7.8, compliments: 9, value: 8.5, total: 8.5 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Hằng ngày", icon: "🧴" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 80, summer: 60, fall: 85, winter: 75 },
    dayNight: { day: 75, night: 70 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Iris" }, { name: "Hoa nhài" }, { name: "Hoa hồng" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Coumarin" }],
    accords: [
      { name: "Hoa", value: 85, color: "#e75480" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Ngọt", value: 58, color: "#FF6D00" },
      { name: "Thơm thảo mộc", value: 48, color: "#2c7a4b" }
    ],
    tags: ["Nữ", "Đa dụng", "Thanh lịch", "Hoa"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ gợi cảm với vani, hoa nhài đêm và gỗ đàn hương. Sang, cuốn và có chất đêm rõ.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani gợi cảm, hoa nhài đêm. Sang và cuốn theo kiểu rất Dior.",
    verdictShort: "GỢI CẢM, VANI, HOA NHÀI ĐÊM",
    score: { scent: 9, uniqueness: 8.5, compliments: 9, value: 8, total: 8.6 },
    vibes: [{ label: "Gợi cảm", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 90, winter: 85 },
    dayNight: { day: 40, night: 95 },
    topNotes: [{ name: "Quýt" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Hoa nhài Sambac" }, { name: "Hoa hồng Damascena" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Hoa trắng", value: 90, color: "#e75480" },
      { name: "Ngọt", value: 75, color: "#FF6D00" },
      { name: "Gỗ", value: 60, color: "#8B4513" },
      { name: "Phương Đông", value: 48, color: "#8B0000" }
    ],
    tags: ["Nữ", "Buổi tối", "Gợi cảm", "Sang trọng"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm nhất dòng Libre. Oải hương, cam ngọt và vani mạnh. Nữ tự tin và quyền lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Oải hương đậm, vani mạnh. Bản nâng cấp quyền lực nhất dòng Libre.",
    verdictShort: "OỐNG HƯƠNG ĐẬM, VANI, QUYỀN LỰC",
    score: { scent: 9, uniqueness: 8.5, compliments: 9.2, value: 8, total: 8.7 },
    vibes: [{ label: "Tự tin", icon: "🔥" }, { label: "Buổi tối", icon: "🌙" }, { label: "Quyền lực", icon: "👑" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 55, summer: 30, fall: 95, winter: 100 },
    dayNight: { day: 35, night: 100 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam ngọt" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa cam Ấn Độ" }],
    baseNotes: [{ name: "Vani Madagascar" }, { name: "Hổ phách" }, { name: "Xạ hương" }],
    accords: [
      { name: "Thơm thảo mộc", value: 88, color: "#2c7a4b" },
      { name: "Ngọt", value: 82, color: "#FF6D00" },
      { name: "Hoa", value: 68, color: "#e75480" },
      { name: "Hổ phách", value: 55, color: "#d4a017" }
    ],
    tags: ["Nữ", "Buổi tối", "Tự tin", "Cao cấp"],
    sizes: ["10ml Chiết", "50ml", "90ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche nữ huyền thoại với hoa hồng Thổ Nhĩ Kỳ, hoắc hương và trầm hương. Quyền lực và sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng, hoắc hương, trầm hương. Kiệt tác niche nữ, quyền lực tuyệt đối.",
    verdictShort: "HOA HỒNG, HOẮC HƯƠNG, KIỆT TÁC",
    score: { scent: 9.6, uniqueness: 9.5, compliments: 8.5, value: 7, total: 8.7 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Quyền lực", icon: "👑" }, { label: "Kiệt tác", icon: "✨" }],
    longevity: 10, sillage: 9,
    seasons: { spring: 50, summer: 20, fall: 95, winter: 100 },
    dayNight: { day: 30, night: 100 },
    topNotes: [{ name: "Hoa hồng Thổ Nhĩ Kỳ" }, { name: "Quế" }],
    middleNotes: [{ name: "Hoắc hương" }, { name: "Trầm hương" }, { name: "Nhục đậu khấu" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Xạ hương" }, { name: "Hổ phách" }, { name: "Benzoin" }],
    accords: [
      { name: "Hoa hồng", value: 100, color: "#c62828" },
      { name: "Gỗ", value: 85, color: "#8B4513" },
      { name: "Gia vị ấm", value: 72, color: "#e67e22" },
      { name: "Hổ phách", value: 60, color: "#d4a017" }
    ],
    tags: ["Niche", "Nữ", "Hoa hồng", "Kiệt tác"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 8500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi ngọt gourmand với kẹo dẻo, cam hoa và xạ hương. Dễ thương, cuốn hút và rất dễ được khen.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Kẹo dẻo ngọt, cam hoa, xạ hương. Ngọt dễ thương và cực kỳ dễ khen.",
    verdictShort: "NGỌT DỄ THƯƠNG, CỰC DỄ KHEN",
    score: { scent: 9, uniqueness: 8.8, compliments: 9.5, value: 7, total: 8.6 },
    vibes: [{ label: "Dễ khen", icon: "👍" }, { label: "Ngọt", icon: "🍬" }, { label: "Niche", icon: "💎" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 65, summer: 45, fall: 85, winter: 90 },
    dayNight: { day: 55, night: 90 },
    topNotes: [{ name: "Hoa cam" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoa diên vĩ" }],
    baseNotes: [{ name: "Đường kẹo" }, { name: "Vani" }, { name: "Xạ hương" }, { name: "Caramel" }],
    accords: [
      { name: "Ngọt", value: 100, color: "#FF6D00" },
      { name: "Hoa", value: 72, color: "#e75480" },
      { name: "Gourmand", value: 68, color: "#8B0000" },
      { name: "Xạ hương", value: 45, color: "#9b59b6" }
    ],
    tags: ["Niche", "Nữ", "Ngọt", "Dễ khen"],
    sizes: ["5ml", "10ml Chiết", "50ml"],
    basePrice: 7200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi hoa nữ kinh điển với hoa nhài, hoa hồng và ylang-ylang. Sang trọng, nữ tính và vượt thời gian.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa nhài, hoa hồng, ylang. Kinh điển nữ tính, sang trọng vượt thời gian.",
    verdictShort: "HOA KINH ĐIỂN, SANG, VƯỢT THỜI GIAN",
    score: { scent: 9, uniqueness: 8, compliments: 9, value: 8.5, total: 8.6 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Nữ tính", icon: "💐" }, { label: "Thanh lịch", icon: "🕴️" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 80, summer: 65, fall: 80, winter: 60 },
    dayNight: { day: 75, night: 65 },
    topNotes: [{ name: "Lê" }, { name: "Dưa vàng" }, { name: "Mộc lan" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Ylang-ylang" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Xạ hương trắng" }],
    accords: [
      { name: "Hoa", value: 100, color: "#e75480" },
      { name: "Tươi", value: 65, color: "#2ecc71" },
      { name: "Gỗ", value: 48, color: "#8B4513" },
      { name: "Ngọt", value: 38, color: "#FF6D00" }
    ],
    tags: ["Nữ", "Kinh điển", "Hoa", "Thanh lịch"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml", "150ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản Parfum đặc của Shalimar. Vani, trầm hương cực sâu. Kinh điển xa xỉ cho dịp đặc biệt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Bản Parfum đặc nhất của Shalimar. Vani sâu, trầm hương. Xa xỉ tuyệt đối.",
    verdictShort: "PARFUM ĐẶC, XA XỈ, CỰC SÂU",
    score: { scent: 9.5, uniqueness: 9.5, compliments: 8, value: 7, total: 8.5 },
    vibes: [{ label: "Xa xỉ", icon: "💎" }, { label: "Kinh điển", icon: "👑" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 10, sillage: 7,
    seasons: { spring: 40, summer: 15, fall: 95, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Iris" }],
    baseNotes: [{ name: "Vani" }, { name: "Trầm hương" }, { name: "Benzoin" }, { name: "Opoponax" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phương Đông", value: 100, color: "#8B0000" },
      { name: "Vani", value: 95, color: "#f5deb3" },
      { name: "Hổ phách", value: 78, color: "#d4a017" },
      { name: "Hoa", value: 55, color: "#e75480" }
    ],
    tags: ["Nữ", "Kinh điển", "Xa xỉ", "Phương Đông"],
    sizes: ["10ml Chiết", "30ml"],
    basePrice: 5500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ huyền thoại đậm với gia vị, quả mọng sẫm và trầm hương. Bí ẩn, quyến rũ và rất có lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gia vị đậm, quả mọng sẫm, trầm hương. Huyền thoại bí ẩn và quyền lực.",
    verdictShort: "BÍ ẨN, GIA VỊ ĐẬM, QUYỀN LỰC",
    score: { scent: 8.8, uniqueness: 9.5, compliments: 8, value: 8.5, total: 8.7 },
    vibes: [{ label: "Bí ẩn", icon: "🖤" }, { label: "Quyền lực", icon: "👑" }, { label: "Huyền thoại", icon: "✨" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 30, summer: 15, fall: 90, winter: 100 },
    dayNight: { day: 15, night: 100 },
    topNotes: [{ name: "Rau mùi" }, { name: "Mận" }, { name: "Tiêu" }],
    middleNotes: [{ name: "Quế" }, { name: "Gia vị" }, { name: "Hoa huệ" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Opoponax" }, { name: "Trầm hương" }, { name: "Xạ hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Gia vị ấm", value: 100, color: "#e67e22" },
      { name: "Phương Đông", value: 88, color: "#8B0000" },
      { name: "Hổ phách", value: 72, color: "#d4a017" },
      { name: "Hoa", value: 48, color: "#e75480" }
    ],
    tags: ["Nữ", "Kinh điển", "Bí ẩn", "Quyền lực"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam thể thao sang với bạc hà, tiêu và gỗ. Tươi sạch, mạnh mẽ và dễ dùng quanh năm.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Thể thao sang, bạc hà tươi, gỗ ấm. Dễ dùng quanh năm, rất popular.",
    verdictShort: "THỂ THAO SANG, TƯƠI, DỄ DÙNG",
    score: { scent: 9, uniqueness: 8, compliments: 9.2, value: 8, total: 8.6 },
    vibes: [{ label: "Thể thao", icon: "⚡" }, { label: "Đa dụng", icon: "🔄" }, { label: "Nam tính", icon: "🖤" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 82, summer: 72, fall: 85, winter: 65 },
    dayNight: { day: 78, night: 65 },
    topNotes: [{ name: "Bạc hà" }, { name: "Tiêu" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Xô thơm" }, { name: "Hồ tiêu" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Xạ hương" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Tươi", value: 92, color: "#2ecc71" },
      { name: "Thơm thảo mộc", value: 75, color: "#2c7a4b" },
      { name: "Gỗ", value: 62, color: "#8B4513" },
      { name: "Gia vị ấm", value: 48, color: "#e67e22" }
    ],
    tags: ["Nam", "Thể thao", "Đa dụng", "Tươi"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche citrus-gỗ với dứa, grapefruit và hoắc hương. Tươi mạnh, năng lượng cao, bám rất lâu.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Dứa, grapefruit, hoắc hương. Fresh niche cực mạnh, bám lâu phi thường.",
    verdictShort: "DỨA, CITRUS MẠNH, BÁM CỰC LÂU",
    score: { scent: 9.2, uniqueness: 9, compliments: 9, value: 8, total: 8.8 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Năng lượng", icon: "⚡" }, { label: "Đa dụng", icon: "🔄" }],
    longevity: 10, sillage: 9,
    seasons: { spring: 85, summer: 78, fall: 75, winter: 55 },
    dayNight: { day: 82, night: 58 },
    topNotes: [{ name: "Dứa" }, { name: "Bưởi" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoắc hương" }, { name: "Hoa hồng" }, { name: "Rêu sồi" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Xạ hương" }, { name: "Cây bách xù" }],
    accords: [
      { name: "Tươi", value: 95, color: "#2ecc71" },
      { name: "Cam chanh", value: 85, color: "#f7c242" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Trái cây", value: 62, color: "#f39c12" }
    ],
    tags: ["Niche", "Unisex", "Tươi", "Citrus"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 5800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm hơn Prada L'Homme. Iris, hoắc hương và hổ phách. Sang, tối và tinh tế hơn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Iris đậm, hoắc hương, hổ phách. Bản nâng cấp sang và tối hơn L'Homme.",
    verdictShort: "IRIS ĐẬM, SANG, TINH TẾ",
    score: { scent: 9, uniqueness: 8.5, compliments: 8.8, value: 8, total: 8.6 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Buổi tối", icon: "🌙" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 30, fall: 92, winter: 88 },
    dayNight: { day: 40, night: 92 },
    topNotes: [{ name: "Iris" }, { name: "Cam bergamot" }, { name: "Bạch đậu khấu" }],
    middleNotes: [{ name: "Neroli" }, { name: "Hổ phách" }, { name: "Hoắc hương" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Xạ hương" }, { name: "Da thuộc" }],
    accords: [
      { name: "Iris / Phấn", value: 90, color: "#9b59b6" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Hổ phách", value: 60, color: "#d4a017" },
      { name: "Gia vị ấm", value: 48, color: "#e67e22" }
    ],
    tags: ["Nam", "Buổi tối", "Iris", "Sang trọng"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche ngọt ấm với hoa hồng, oud và vani. Phương Đông xa hoa và rất cuốn hút.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng, oud, vani. Phương Đông xa hoa, rất nổi bật và cuốn hút.",
    verdictShort: "HOA HỒNG, OUD, XA HOA",
    score: { scent: 8.8, uniqueness: 8.5, compliments: 8.8, value: 7.5, total: 8.4 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Phương Đông", icon: "🌙" }, { label: "Xa hoa", icon: "✨" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 40, summer: 20, fall: 90, winter: 100 },
    dayNight: { day: 25, night: 100 },
    topNotes: [{ name: "Gia vị" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Oud" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Vani" }, { name: "Hổ phách" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Phương Đông", value: 92, color: "#8B0000" },
      { name: "Hoa", value: 78, color: "#e75480" },
      { name: "Oud", value: 65, color: "#3E2723" },
      { name: "Ngọt", value: 55, color: "#FF6D00" }
    ],
    tags: ["Niche", "Unisex", "Phương Đông", "Oud"],
    sizes: ["10ml Chiết", "100ml"],
    basePrice: 5200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản Parfum của Terre. Gỗ, đất, cam ngọt. Sâu hơn, ấm hơn và sang hơn bản EDT.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gỗ đất sâu, cam ngọt, tinh tế. Bản tinh chỉnh hoàn hảo nhất dòng Terre.",
    verdictShort: "GỖ SÂU, ĐẤT, TINH TẾ TUYỆT ĐỐI",
    score: { scent: 9.2, uniqueness: 8.8, compliments: 8.5, value: 7.8, total: 8.6 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Sang trọng", icon: "💎" }, { label: "Đa dụng", icon: "🔄" }],
    longevity: 9, sillage: 7,
    seasons: { spring: 65, summer: 45, fall: 90, winter: 85 },
    dayNight: { day: 65, night: 80 },
    topNotes: [{ name: "Cam ngọt" }, { name: "Bưởi" }],
    middleNotes: [{ name: "Lửa đá" }, { name: "Tiêu" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Benzoin" }, { name: "Vetiver" }],
    accords: [
      { name: "Gỗ", value: 100, color: "#8B4513" },
      { name: "Đất / Khoáng", value: 82, color: "#616161" },
      { name: "Cam chanh", value: 68, color: "#f7c242" },
      { name: "Gia vị ấm", value: 48, color: "#e67e22" }
    ],
    tags: ["Nam", "Gỗ", "Thanh lịch", "Cao cấp"],
    sizes: ["10ml Chiết", "75ml", "200ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam xanh cổ điển với iris, cỏ xanh và gỗ đàn hương. Sang, sạch và lịch lãm theo kiểu cũ.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cỏ xanh, iris, gỗ đàn hương. Kinh điển gentleman, sang và sạch vượt thời gian.",
    verdictShort: "CỎ XANH, IRIS, GENTLEMAN",
    score: { scent: 9, uniqueness: 8.5, compliments: 8.5, value: 6.5, total: 8.1 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Niche", icon: "💎" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 90, summer: 65, fall: 75, winter: 55 },
    dayNight: { day: 82, night: 48 },
    topNotes: [{ name: "Hoa violet lá" }, { name: "Chanh" }],
    middleNotes: [{ name: "Iris" }, { name: "Xô thơm" }, { name: "Hoa violet" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Hổ phách" }, { name: "Xạ hương" }],
    accords: [
      { name: "Xanh / Green", value: 95, color: "#2c7a4b" },
      { name: "Tươi", value: 78, color: "#2ecc71" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Phấn / Iris", value: 48, color: "#9b59b6" }
    ],
    tags: ["Niche", "Nam", "Kinh điển", "Green"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 7500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại nam citrus với cam bergamot, oải hương và vetiver. Thanh lịch cổ điển, vượt thời gian.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Citrus cổ điển, oải hương, vetiver. Huyền thoại thanh lịch vượt mọi thời đại.",
    verdictShort: "HUYỀN THOẠI CITRUS, THANH LỊCH",
    score: { scent: 8.8, uniqueness: 9.2, compliments: 7.8, value: 8.5, total: 8.6 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Ban ngày", icon: "☀️" }],
    longevity: 6, sillage: 6,
    seasons: { spring: 90, summer: 80, fall: 65, winter: 45 },
    dayNight: { day: 88, night: 35 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }, { name: "Lá basilic" }],
    middleNotes: [{ name: "Vetiver" }, { name: "Oải hương" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Gỗ sồi" }, { name: "Xạ hương" }],
    accords: [
      { name: "Cam chanh", value: 100, color: "#f7c242" },
  ...
  },
  {
    ...
    description: "Mùi niche da thuộc suede với violet, tiêu hồng và xạ hương. Thanh lịch hiện đại, rất cuốn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Da suede mềm, violet, xạ hương. Thanh lịch hiện đại, unisex hoàn hảo.",
    verdictShort: "DA SUEDE, VIOLET, THANH LỊCH",
    score: { scent: 9.3, uniqueness: 9.2, compliments: 8.8, value: 7.5, total: 8.7 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Phi giới tính", icon: "✨" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 75, summer: 50, fall: 85, winter: 80 },
    dayNight: { day: 60, night: 82 },
    topNotes: [{ name: "Tiêu hồng" }, { name: "Cam bergamot" }, { name: "Bưởi" }],
    middleNotes: [{ name: "Da suede" }, { name: "Hoa violet" }, { name: "Iris" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Gỗ tuyết tùng" }, { name: "Hổ phách" }],
    accords: [
      { name: "Da thuộc", value: 88, color: "#5D4037" },
      { name: "Tươi", value: 72, color: "#2ecc71" },
      { name: "Gỗ", value: 60, color: "#8B4513" },
      { name: "Xạ hương", value: 48, color: "#9b59b6" }
    ],
    tags: ["Niche", "Unisex", "Da", "Thanh lịch"],
    sizes: ["10ml Chiết", "30ml", "100ml"],
    basePrice: 5800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam ngọt ấm với tiramisu, vani và xạ hương. Gourmand sang, dễ khen và rất addictive.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Tiramisu, vani, xạ hương. Gourmand sang trọng, cực dễ khen và gây nghiện.",
    verdictShort: "TIRAMISU, NGỌT SANG, DỄ KHEN",
    score: { scent: 9, uniqueness: 8.8, compliments: 9.5, value: 7.8, total: 8.8 },
    vibes: [{ label: "Ngọt", icon: "🍬" }, { label: "Dễ khen", icon: "👍" }, { label: "Niche", icon: "💎" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 45, summer: 20, fall: 95, winter: 100 },
    dayNight: { day: 30, night: 100 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Lá bạc hà" }],
    middleNotes: [{ name: "Đậu tonka" }, { name: "Quế" }, { name: "Tiramisu" }],
    baseNotes: [{ name: "Vani" }, { name: "Xạ hương" }, { name: "Hổ phách" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Ngọt", value: 100, color: "#FF6D00" },
      { name: "Gourmand", value: 88, color: "#8B0000" },
      { name: "Gia vị ấm", value: 68, color: "#e67e22" },
      { name: "Gỗ", value: 42, color: "#8B4513" }
    ],
    tags: ["Niche", "Nam", "Gourmand", "Dễ khen"],
    sizes: ["10ml Chiết", "75ml", "125ml"],
    basePrice: 6200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche vani phương Đông với hoa bạch chỉ, vani và cam thảo. Ấm, sâu và ngọt sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani phương Đông, hoa bạch chỉ. Niche Guerlain sang và sâu.",
    verdictShort: "VANI PHƯƠNG ĐÔNG, ẤM, SANG",
    score: { scent: 9.2, uniqueness: 9, compliments: 8.2, value: 7, total: 8.4 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Buổi tối", icon: "🌙" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 9, sillage: 7,
    seasons: { spring: 40, summer: 20, fall: 90, winter: 100 },
    dayNight: { day: 25, night: 100 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Hoa bạch chỉ" }],
    middleNotes: [{ name: "Cam thảo" }, { name: "Gia vị" }],
    baseNotes: [{ name: "Vani" }, { name: "Benzoin" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Phương Đông", value: 95, color: "#8B0000" },
      { name: "Vani", value: 88, color: "#f5deb3" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Gia vị ấm", value: 48, color: "#e67e22" }
    ],
    tags: ["Niche", "Unisex", "Vani", "Phương Đông"],
    sizes: ["10ml Chiết", "75ml", "125ml"],
    basePrice: 7500000,
    shopeeOffers: []
  },
  {
    ...
    name: "Pure Poison",
    subName: "Eau de Parfum",
    perfumer: "Carlos Benaïm, Olivier Polge & Dominique Ropion",
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "DIOR Pure Poison chính hãng", verified: false }],
    description: "Mùi nữ hoa trắng sang với hoa nhài, cam hoa và gỗ đàn hương. Tinh khiết, sang và quyến rũ kín đáo.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa trắng tinh khiết, cam hoa, gỗ đàn hương. Sang và quyến rũ kín đáo.",
    verdictShort: "HOA TRẮNG TINH KHIẾT, SANG",
    score: { scent: 8.8, uniqueness: 8.2, compliments: 8.8, value: 8, total: 8.5 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Nữ tính", icon: "💐" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 75, summer: 55, fall: 80, winter: 65 },
    dayNight: { day: 65, night: 75 },
    topNotes: [{ name: "Cam ngọt" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa cam" }, { name: "Hoa gardenia" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Xạ hương trắng" }, { name: "Hổ phách" }],
    accords: [
      { name: "Hoa trắng", value: 95, color: "#e75480" },
      { name: "Gỗ", value: 65, color: "#8B4513" },
      { name: "Tươi", value: 55, color: "#2ecc71" },
      { name: "Ngọt", value: 38, color: "#FF6D00" }
    ],
    tags: ["Nữ", "Hoa trắng", "Thanh lịch", "Sang"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại nữ phương Đông với gia vị, hoa cẩm chướng và trầm hương. Quyền lực và bí ẩn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gia vị phương Đông, cẩm chướng, trầm hương. Huyền thoại nữ quyền lực.",
    verdictShort: "PHƯƠNG ĐÔNG, GIA VỊ, QUYỀN LỰC",
    score: { scent: 9, uniqueness: 9.5, compliments: 8, value: 8, total: 8.6 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Quyền lực", icon: "🔥" }, { label: "Bí ẩn", icon: "🖤" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 35, summer: 15, fall: 90, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Quả mận" }, { name: "Rau mùi" }, { name: "Tiêu" }],
    middleNotes: [{ name: "Hoa cẩm chướng" }, { name: "Quế" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Trầm hương" }, { name: "Xạ hương" }, { name: "Vani" }, { name: "Benzoin" }],
    accords: [
      { name: "Gia vị ấm", value: 100, color: "#e67e22" },
      { name: "Phương Đông", value: 92, color: "#8B0000" },
    ...
    tags: ["Nữ", "Kinh điển", "Phương Đông", "Gia vị"],
    sizes: ["10ml Chiết", "50ml", "90ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm nhất Black Opium. Cà phê, vani sữa và hoa cam. Sâu hơn, ngọt hơn, sang hơn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cà phê đậm, vani sữa. Bản nâng cấp mạnh nhất dòng Black Opium.",
    verdictShort: "CÀ PHÊ ĐẬM, VANI SỮA, SANG",
    score: { scent: 9, uniqueness: 8.5, compliments: 9.2, value: 7.8, total: 8.6 },
    vibes: [{ label: "Quyến rũ", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Sang trọng", icon: "💎" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 45, summer: 25, fall: 92, winter: 100 },
    dayNight: { day: 30, night: 100 },
    topNotes: [{ name: "Cà phê" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Vani sữa" }, { name: "Hoa nhài" }, { name: "Hổ phách" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Gỗ tuyết tùng" }, { name: "Benzoin" }],
    accords: [
      { name: "Cà phê", value: 95, color: "#3e1f00" },
      { name: "Ngọt", value: 85, color: "#FF6D00" },
      { name: "Vani", value: 78, color: "#f5deb3" },
      { name: "Hoa trắng", value: 48, color: "#e75480" }
    ],
    tags: ["Nữ", "Cà phê", "Buổi tối", "Sang"],
    sizes: ["10ml Chiết", "30ml", "50ml", "90ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "CHLOÉ Chloé Eau de Parfum chính hãng", verified: false }],
    description: "Mùi hoa hồng nữ tính với mẫu đơn, lê và gỗ tuyết tùng. Thanh lịch, nhẹ nhàng và rất dễ yêu.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng, lê, gỗ tuyết tùng. Nữ tính thanh lịch, dễ yêu và dễ dùng.",
    verdictShort: "HOA HỒNG NHẸ, THANH LỊCH, DỄ YÊU",
    score: { scent: 8.8, uniqueness: 7.8, compliments: 9, value: 8.5, total: 8.5 },
    vibes: [{ label: "Nữ tính", icon: "💐" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Hằng ngày", icon: "🧴" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 85, summer: 68, fall: 78, winter: 55 },
    dayNight: { day: 78, night: 52 },
    topNotes: [{ name: "Lê" }, { name: "Hoa mẫu đơn" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa huệ" }, { name: "Hoa mộc lan" }],
    baseNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Xạ hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Hoa", value: 95, color: "#e75480" },
      { name: "Tươi", value: 68, color: "#2ecc71" },
      { name: "Gỗ", value: 48, color: "#8B4513" },
      { name: "Phấn", value: 35, color: "#9b59b6" }
    ],
    tags: ["Nữ", "Hoa", "Thanh lịch", "Dễ dùng"],
    sizes: ["10ml Chiết", "30ml", "50ml", "75ml"],
    basePrice: 2600000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ violet mạnh với hoa hồng, iris và quả mọng. Nổi loạn, cá tính và rất đặc biệt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Violet mạnh, hoa hồng, iris. Cá tính nổi loạn và rất đặc biệt.",
    verdictShort: "VIOLET MẠNH, NỔI LOẠN, CÁ TÍNH",
    score: { scent: 8.8, uniqueness: 9, compliments: 8.2, value: 8, total: 8.5 },
    vibes: [{ label: "Cá tính", icon: "🔥" }, { label: "Nổi loạn", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 55, summer: 30, fall: 85, winter: 90 },
    dayNight: { day: 40, night: 88 },
    topNotes: [{ name: "Quả mọng tím" }, { name: "Violet" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Iris" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Đậu tonka" }, { name: "Xạ hương" }, { name: "Gỗ tuyết tùng" }],
    accords: [
      { name: "Violet", value: 95, color: "#9b59b6" },
      { name: "Hoa", value: 78, color: "#e75480" },
      { name: "Phấn", value: 55, color: "#9b59b6" },
      { name: "Ngọt", value: 42, color: "#FF6D00" }
    ],
    tags: ["Nữ", "Violet", "Cá tính", "Nổi loạn"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm của Mon Guerlain. Oải hương, vani và hoa nhài mạnh hơn. Ấm, sâu, nữ tính hơn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Mon Guerlain bản đậm hơn. Oải hương, vani sâu. Ấm và sang hơn bản gốc.",
    verdictShort: "BẢN ĐẬM, VANI SÂU, SANG",
    score: { scent: 8.8, uniqueness: 8, compliments: 8.8, value: 8, total: 8.4 },
    vibes: [{ label: "Sang trọng", icon: "✨" }, { label: "Nữ tính", icon: "💐" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 30, fall: 90, winter: 90 },
    dayNight: { day: 40, night: 90 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Iris" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Coumarin" }, { name: "Benzoin" }],
    accords: [
      { name: "Hoa", value: 82, color: "#e75480" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Ngọt", value: 65, color: "#FF6D00" },
      { name: "Thơm thảo mộc", value: 48, color: "#2c7a4b" }
    ],
    tags: ["Nữ", "Hoa", "Ấm", "Sang trọng"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ gỗ đàn hương với hoa nhài, ylang và vani. Phương Đông cổ điển, ấm và đầy chiều sâu.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gỗ đàn hương, hoa nhài, vani. Phương Đông cổ điển, ấm và sâu.",
    verdictShort: "GỖ ĐÀN HƯƠNG, ẤM, CỔ ĐIỂN",
    score: { scent: 9, uniqueness: 9, compliments: 8, value: 7.5, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Phương Đông", icon: "🌙" }, { label: "Ấm", icon: "🍂" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 45, summer: 25, fall: 88, winter: 92 },
    dayNight: { day: 30, night: 90 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Ylang-ylang" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa narcissus" }, { name: "Hoa hồng" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Đậu tonka" }, { name: "Iris" }],
    accords: [
      { name: "Gỗ", value: 95, color: "#8B4513" },
      { name: "Phương Đông", value: 82, color: "#8B0000" },
      { name: "Hoa", value: 65, color: "#e75480" },
      { name: "Ngọt", value: 48, color: "#FF6D00" }
    ],
    tags: ["Nữ", "Gỗ", "Phương Đông", "Kinh điển"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ biển cát với oải hương, hổ phách và hoa lily. Ấm, mềm và gợi cảm giác sa mạc ven biển.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Biển cát, hổ phách, lily. Ấm mềm, gợi sa mạc ven biển, rất đặc biệt.",
    verdictShort: "BIỂN CÁT, ẤM, RẤT ĐẶC BIỆT",
    score: { scent: 8.8, uniqueness: 9.2, compliments: 7.8, value: 8, total: 8.5 },
    vibes: [{ label: "Đặc biệt", icon: "✨" }, { label: "Ấm", icon: "🍂" }, { label: "Kinh điển", icon: "👑" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 60, summer: 45, fall: 82, winter: 78 },
    dayNight: { day: 55, night: 72 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Quýt" }, { name: "Bạch đậu khấu" }],
    middleNotes: [{ name: "Hoa lily" }, { name: "Hoa hồng" }, { name: "Mẫu đơn" }],
    baseNotes: [{ name: "Hổ phách" }, { name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Benzoin" }],
    accords: [
      { name: "Hổ phách", value: 88, color: "#d4a017" },
      { name: "Hoa", value: 72, color: "#e75480" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Tươi", value: 42, color: "#2ecc71" }
    ],
    tags: ["Nữ", "Kinh điển", "Hổ phách", "Đặc biệt"],
    sizes: ["10ml Chiết", "30ml", "50ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche citrus-gỗ lấy cảm hứng Châu Phi. Cam bergamot, hoa violet và vetiver. Tươi và nghệ thuật.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cam bergamot, violet, vetiver. Tươi nghệ thuật, unisex và rất có gu.",
    verdictShort: "TƯƠI NGHỆ THUẬT, UNISEX, CÓ GU",
    score: { scent: 9, uniqueness: 9.2, compliments: 8.5, value: 7, total: 8.4 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Nghệ thuật", icon: "✨" }, { label: "Phi giới tính", icon: "🌍" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 82, summer: 68, fall: 75, winter: 55 },
    dayNight: { day: 75, night: 55 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }, { name: "Hoa bạch chỉ" }],
    middleNotes: [{ name: "Hoa violet" }, { name: "Hoa nhài" }, { name: "Xạ đen" }],
    baseNotes: [{ name: "Vetiver" }, { name: "Gỗ tuyết tùng" }, { name: "Xạ hương" }],
    accords: [
      { name: "Tươi", value: 88, color: "#2ecc71" },
      { name: "Cam chanh", value: 78, color: "#f7c242" },
      { name: "Gỗ", value: 62, color: "#8B4513" },
      { name: "Hoa", value: 48, color: "#e75480" }
    ],
    tags: ["Niche", "Unisex", "Tươi", "Nghệ thuật"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 5500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại chypre nữ với đào, rêu sồi và gỗ. Phức tạp, sang và có chiều sâu phi thường.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Chypre huyền thoại, đào, rêu sồi. Phức tạp nhưng đẹp phi thường.",
    verdictShort: "CHYPRE HUYỀN THOẠI, PHỨC TẠP, ĐẸP",
    score: { scent: 9.5, uniqueness: 9.8, compliments: 7.5, value: 7.5, total: 8.6 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Phức tạp", icon: "✨" }, { label: "Niche", icon: "💎" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 30, fall: 88, winter: 82 },
    dayNight: { day: 45, night: 82 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }],
    middleNotes: [{ name: "Đào" }, { name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoa lily" }],
    baseNotes: [{ name: "Rêu sồi" }, { name: "Gỗ đàn hương" }, { name: "Vetiver" }, { name: "Gia vị" }],
    accords: [
      { name: "Chypre", value: 100, color: "#6D4C41" },
      { name: "Trái cây", value: 72, color: "#f39c12" },
      { name: "Gỗ", value: 65, color: "#8B4513" },
      { name: "Hoa", value: 55, color: "#e75480" }
    ],
    tags: ["Nữ", "Kinh điển", "Chypre", "Phức tạp"],
    sizes: ["10ml Chiết", "50ml", "75ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản hiện đại của Shalimar với vani kem, trầm hương và hoa hồng. Sang, mềm và đẹp tuyệt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani kem, trầm hương, hoa hồng. Shalimar bản hiện đại, sang và mềm hơn.",
    verdictShort: "VANI KEM, SANG, HIỆN ĐẠI",
    score: { scent: 9, uniqueness: 8.8, compliments: 8.5, value: 7.5, total: 8.5 },
    vibes: [{ label: "Sang trọng", icon: "💎" }, { label: "Kinh điển", icon: "👑" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 50, summer: 25, fall: 88, winter: 95 },
    dayNight: { day: 30, night: 95 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Tiêu hồng" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Iris" }],
    baseNotes: [{ name: "Vani" }, { name: "Trầm hương" }, { name: "Benzoin" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phương Đông", value: 88, color: "#8B0000" },
      { name: "Vani", value: 82, color: "#f5deb3" },
      { name: "Hoa", value: 65, color: "#e75480" },
    ...
    tags: ["Nữ", "Phương Đông", "Vani", "Sang trọng"],
    sizes: ["10ml Chiết", "30ml", "50ml"],
    basePrice: 4200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi vetiver tối sâu với cypress và xạ hương. Tối, đất và rất nam tính theo kiểu không phổ thông.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vetiver tối, cypress. Nam tính sâu, giá cực tốt. Không phải cho người thích ngọt.",
    verdictShort: "VETIVER TỐI, ĐẤT, GIÁ TỐT",
    score: { scent: 8.8, uniqueness: 9.2, compliments: 7.5, value: 9.5, total: 8.8 },
    vibes: [{ label: "Tối", icon: "🖤" }, { label: "Giá tốt", icon: "💰" }, { label: "Nam tính", icon: "🌲" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 45, summer: 20, fall: 95, winter: 90 },
    dayNight: { day: 35, night: 90 },
    topNotes: [{ name: "Cypress" }],
    middleNotes: [{ name: "Vetiver" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Cashmere wood" }],
    accords: [
      { name: "Gỗ", value: 100, color: "#8B4513" },
      { name: "Đất / Khoáng", value: 88, color: "#616161" },
      { name: "Xanh / Green", value: 55, color: "#2c7a4b" },
      { name: "Tối", value: 48, color: "#1a1a1a" }
    ],
    tags: ["Nam", "Gỗ", "Tối", "Giá tốt"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 950000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản đậm nhất Le Male. Oải hương, vani và hổ phách cực mạnh. Ngọt ấm quyền lực cho buổi tối.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Oải hương đậm, vani mạnh, hổ phách. Bản quyền lực nhất dòng Le Male.",
    verdictShort: "ĐẬM NHẤT LE MALE, QUYỀN LỰC",
    score: { scent: 9, uniqueness: 8.5, compliments: 9.2, value: 8, total: 8.7 },
    vibes: [{ label: "Buổi tối", icon: "🌙" }, { label: "Quyền lực", icon: "🔥" }, { label: "Ngọt", icon: "🍬" }],
    longevity: 9, sillage: 9,
    seasons: { spring: 30, summer: 10, fall: 95, winter: 100 },
    dayNight: { day: 15, night: 100 },
    topNotes: [{ name: "Oải hương" }, { name: "Bạc hà" }],
    middleNotes: [{ name: "Vani" }, { name: "Hổ phách" }, { name: "Đậu tonka" }],
    baseNotes: [{ name: "Benzoin" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Thơm thảo mộc", value: 82, color: "#2c7a4b" },
      { name: "Hổ phách", value: 75, color: "#d4a017" },
      { name: "Gia vị ấm", value: 58, color: "#e67e22" }
    ],
    tags: ["Nam", "Buổi tối", "Ngọt", "Quyền lực"],
    sizes: ["10ml Chiết", "75ml", "125ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển nam với oải hương, vani và bạc hà. Trẻ trung, dễ khen và rất phổ biến.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Oải hương, vani, bạc hà. Kinh điển nam trẻ trung, dễ khen vô cùng.",
    verdictShort: "KINH ĐIỂN, DỄ KHEN, TRẺ TRUNG",
    score: { scent: 8.8, uniqueness: 8, compliments: 9.2, value: 9, total: 8.8 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Dễ khen", icon: "👍" }, { label: "Trẻ trung", icon: "⚡" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 65, summer: 45, fall: 85, winter: 80 },
    dayNight: { day: 55, night: 80 },
    topNotes: [{ name: "Oải hương" }, { name: "Bạc hà" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Quế" }, { name: "Hoa cam" }, { name: "Bạch đậu khấu" }],
    baseNotes: [{ name: "Vani" }, { name: "Đậu tonka" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Thơm thảo mộc", value: 92, color: "#2c7a4b" },
      { name: "Ngọt", value: 72, color: "#FF6D00" },
      { name: "Gia vị ấm", value: 58, color: "#e67e22" },
      { name: "Tươi", value: 48, color: "#2ecc71" }
    ],
    tags: ["Nam", "Kinh điển", "Dễ khen", "Trẻ trung"],
    sizes: ["10ml Chiết", "75ml", "125ml", "200ml"],
    basePrice: 2200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm hơn của Aventus. Trái cây, gỗ và gia vị cô đặc. Sang hơn và sâu hơn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Aventus bản đậm. Trái cây cô đặc, gỗ sâu. Sang và quyền lực hơn bản gốc.",
    verdictShort: "AVENTUS ĐẬM, CÔ ĐẶC, QUYỀN LỰC",
    score: { scent: 9.3, uniqueness: 9, compliments: 9, value: 6.5, total: 8.5 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Quyền lực", icon: "👑" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 60, summer: 35, fall: 90, winter: 85 },
    dayNight: { day: 55, night: 88 },
    topNotes: [{ name: "Dứa" }, { name: "Táo" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Gỗ bạch dương" }, { name: "Hoắc hương" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Hổ phách" }, { name: "Vani" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Trái cây", value: 90, color: "#f39c12" },
      { name: "Gỗ", value: 78, color: "#8B4513" },
      { name: "Khói", value: 55, color: "#616161" },
      { name: "Gia vị ấm", value: 42, color: "#e67e22" }
    ],
    tags: ["Niche", "Nam", "Sang trọng", "Trái cây"],
    sizes: ["5ml", "10ml Chiết", "100ml"],
    basePrice: 9500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche vani-gia vị với bạch đậu khấu, vani Madagascar và gỗ đàn hương. Ấm, ngọt và cực sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani Madagascar, bạch đậu khấu, gỗ đàn hương. Vani niche sang nhất phân khúc.",
    verdictShort: "VANI NICHE, GIA VỊ, CỰC SANG",
    score: { scent: 9.3, uniqueness: 9, compliments: 9.2, value: 8, total: 8.9 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Ấm", icon: "🍂" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 10, sillage: 8,
    seasons: { spring: 45, summer: 25, fall: 95, winter: 100 },
    dayNight: { day: 30, night: 100 },
    topNotes: [{ name: "Bạch đậu khấu" }, { name: "Cam bergamot" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Vani Madagascar" }, { name: "Hoa nhài" }, { name: "Quế" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Đậu tonka" }, { name: "Benzoin" }, { name: "Xạ hương" }],
    accords: [
      { name: "Vani", value: 100, color: "#f5deb3" },
      { name: "Gia vị ấm", value: 85, color: "#e67e22" },
      { name: "Ngọt", value: 78, color: "#FF6D00" },
      { name: "Gỗ", value: 55, color: "#8B4513" }
    ],
    tags: ["Niche", "Unisex", "Vani", "Gia vị"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 5800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam thể thao tươi với cam, tiêu và gỗ tuyết tùng. Năng động, sạch và rất dễ dùng.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Thể thao tươi, cam, tiêu, gỗ. Năng động và sạch, rất dễ dùng ban ngày.",
    verdictShort: "THỂ THAO TƯƠI, SẠCH, NĂNG ĐỘNG",
    score: { scent: 8.5, uniqueness: 7.5, compliments: 8.8, value: 8, total: 8.2 },
    vibes: [{ label: "Thể thao", icon: "⚡" }, { label: "Ban ngày", icon: "☀️" }, { label: "Năng động", icon: "🏃" }],
    longevity: 6, sillage: 7,
    seasons: { spring: 85, summer: 80, fall: 65, winter: 45 },
    dayNight: { day: 85, night: 40 },
    topNotes: [{ name: "Cam" }, { name: "Quýt" }, { name: "Hồ tiêu hồng" }],
    middleNotes: [{ name: "Neroli" }, { name: "Gỗ tuyết tùng" }],
    baseNotes: [{ name: "Xạ hương trắng" }, { name: "Đậu tonka" }, { name: "Hổ phách" }],
    accords: [
      { name: "Tươi", value: 92, color: "#2ecc71" },
      { name: "Cam chanh", value: 82, color: "#f7c242" },
      { name: "Gỗ", value: 52, color: "#8B4513" },
      { name: "Gia vị tươi", value: 42, color: "#c58a2b" }
    ],
    tags: ["Nam", "Thể thao", "Tươi", "Ban ngày"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche hoắc hương-gia vị với tiêu đen và gỗ tuyết tùng. Tối, sang và rất quyền lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoắc hương đen, tiêu, gỗ tuyết tùng. Tối, sang và quyền lực tuyệt đối.",
    verdictShort: "HOẮC HƯƠNG ĐEN, TỐI, QUYỀN LỰC",
    score: { scent: 9.2, uniqueness: 9, compliments: 8.5, value: 7, total: 8.4 },
    vibes: [{ label: "Quyền lực", icon: "👑" }, { label: "Tối", icon: "🖤" }, { label: "Niche", icon: "💎" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 35, summer: 15, fall: 92, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Tiêu đen" }, { name: "Hồ tiêu hồng" }],
    middleNotes: [{ name: "Hoắc hương" }, { name: "Cypress" }],
    baseNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Hổ phách" }, { name: "Xạ hương" }],
    accords: [
      { name: "Gỗ", value: 95, color: "#8B4513" },
      { name: "Gia vị ấm", value: 82, color: "#e67e22" },
      { name: "Hổ phách", value: 62, color: "#d4a017" },
      { name: "Tối", value: 55, color: "#1a1a1a" }
    ],
    tags: ["Niche", "Unisex", "Tối", "Quyền lực"],
    sizes: ["10ml Chiết", "75ml", "125ml"],
    basePrice: 6500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản Parfum đậm nhất dòng L'Homme Idéal. Vani, hổ phách và anh đào. Ngọt sang, rất beast mode.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani, hổ phách, anh đào. Bản đậm nhất dòng Idéal, ngọt sang beast mode.",
    verdictShort: "VANI ĐẬM, ANH ĐÀO, BEAST MODE",
    score: { scent: 9, uniqueness: 8.5, compliments: 9.2, value: 8.5, total: 8.8 },
    vibes: [{ label: "Beast mode", icon: "🔥" }, { label: "Buổi tối", icon: "🌙" }, { label: "Ngọt", icon: "🍬" }],
    longevity: 9, sillage: 9,
    seasons: { spring: 35, summer: 15, fall: 95, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Anh đào" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hổ phách" }, { name: "Vani" }, { name: "Quế" }],
    baseNotes: [{ name: "Đậu tonka" }, { name: "Gỗ đàn hương" }, { name: "Benzoin" }, { name: "Xạ hương" }],
    accords: [
      { name: "Ngọt", value: 100, color: "#FF6D00" },
      { name: "Gourmand", value: 85, color: "#8B0000" },
      { name: "Hổ phách", value: 72, color: "#d4a017" },
      { name: "Gỗ", value: 48, color: "#8B4513" }
    ],
    tags: ["Nam", "Ngọt", "Buổi tối", "Gourmand"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển vetiver nam với thuốc lá, tiêu và gỗ. Thanh lịch cổ điển kiểu Pháp, rất gentleman.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vetiver kinh điển, thuốc lá, tiêu. Gentleman Pháp vượt thời gian.",
    verdictShort: "VETIVER KINH ĐIỂN, GENTLEMAN",
    score: { scent: 8.8, uniqueness: 8.8, compliments: 7.8, value: 8.5, total: 8.5 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Gentleman", icon: "🕴️" }, { label: "Thanh lịch", icon: "✨" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 75, summer: 55, fall: 80, winter: 65 },
    dayNight: { day: 78, night: 48 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Chanh" }, { name: "Tiêu" }],
    middleNotes: [{ name: "Vetiver" }, { name: "Thuốc lá" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Đậu tonka" }, { name: "Xạ hương" }],
    accords: [
      { name: "Xanh / Green", value: 92, color: "#2c7a4b" },
      { name: "Gỗ", value: 78, color: "#8B4513" },
      { name: "Cam chanh", value: 55, color: "#f7c242" },
      { name: "Gia vị ấm", value: 42, color: "#e67e22" }
    ],
    tags: ["Nam", "Kinh điển", "Vetiver", "Thanh lịch"],
    sizes: ["10ml Chiết", "100ml", "200ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche xạ hương quyến rũ với vani, hổ phách và quế. Sexy, ấm và cực kỳ cuốn hút.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Xạ hương, vani, quế. Sexy tuyệt đối. Niche kinh điển cho buổi tối.",
    verdictShort: "XẠ HƯƠNG SEXY, VANI, CỰC CUỐN",
    score: { scent: 9.4, uniqueness: 9.2, compliments: 9, value: 7, total: 8.7 },
    vibes: [{ label: "Sexy", icon: "🔥" }, { label: "Niche", icon: "💎" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 35, summer: 15, fall: 92, winter: 100 },
    dayNight: { day: 15, night: 100 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Quế" }, { name: "Hoa cam" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Vani" }, { name: "Hổ phách" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Xạ hương", value: 100, color: "#9b59b6" },
      { name: "Ngọt", value: 82, color: "#FF6D00" },
      { name: "Gia vị ấm", value: 75, color: "#e67e22" },
      { name: "Hổ phách", value: 62, color: "#d4a017" }
    ],
    tags: ["Niche", "Unisex", "Xạ hương", "Sexy"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 7500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ ngọt ấm với lê, vani và đậu tonka. Gợi cảm, trẻ trung và dễ gây nghiện.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Lê ngọt, vani, đậu tonka. Gợi cảm trẻ trung, rất dễ khen.",
    verdictShort: "LÊ NGỌT, VANI, GỢI CẢM",
    score: { scent: 8.8, uniqueness: 8, compliments: 9.2, value: 8.5, total: 8.6 },
    vibes: [{ label: "Gợi cảm", icon: "✨" }, { label: "Trẻ trung", icon: "⚡" }, { label: "Dễ khen", icon: "👍" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 90, winter: 85 },
    dayNight: { day: 40, night: 92 },
    topNotes: [{ name: "Lê" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Vani" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Đậu tonka" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Hoa", value: 65, color: "#e75480" },
    ...
    tags: ["Nữ", "Ngọt", "Gợi cảm", "Dễ khen"],
    sizes: ["10ml Chiết", "30ml", "50ml", "80ml"],
    basePrice: 2200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ bí ẩn với hoa hồng đêm, hoắc hương và hổ phách. Tối, sang và rất đặc biệt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng đêm, hoắc hương, hổ phách. Tối, bí ẩn và sang.",
    verdictShort: "HOA HỒNG ĐÊM, TỐI, BÍ ẨN",
    score: { scent: 9, uniqueness: 9.2, compliments: 8.2, value: 7.5, total: 8.5 },
    vibes: [{ label: "Bí ẩn", icon: "🖤" }, { label: "Sang trọng", icon: "💎" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 40, summer: 20, fall: 90, winter: 95 },
    dayNight: { day: 25, night: 100 },
    topNotes: [{ name: "Quýt" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoắc hương" }],
    baseNotes: [{ name: "Hổ phách" }, { name: "Gỗ đàn hương" }, { name: "Vani" }],
    accords: [
      { name: "Hoa", value: 88, color: "#e75480" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Hổ phách", value: 58, color: "#d4a017" },
      { name: "Tối", value: 48, color: "#1a1a1a" }
    ],
    tags: ["Nữ", "Bí ẩn", "Hoa hồng", "Buổi tối"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản 2014 của Addict. Hoa nhài đêm, vani và gỗ đàn hương. Gợi cảm và sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa nhài đêm, vani, gỗ. Gợi cảm và sang theo kiểu Dior.",
    verdictShort: "HOA NHÀI ĐÊM, VANI, SANG",
    score: { scent: 8.8, uniqueness: 8.2, compliments: 8.8, value: 8, total: 8.5 },
    vibes: [{ label: "Gợi cảm", icon: "✨" }, { label: "Sang trọng", icon: "💎" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 85, winter: 82 },
    dayNight: { day: 40, night: 88 },
    topNotes: [{ name: "Quýt" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Hoa nhài Sambac" }, { name: "Hoa hồng" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Hoa trắng", value: 88, color: "#e75480" },
      { name: "Ngọt", value: 72, color: "#FF6D00" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Phương Đông", value: 42, color: "#8B0000" }
    ],
    tags: ["Nữ", "Gợi cảm", "Hoa", "Sang"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ cổ điển phấn mềm với iris, hoa violet và vani. Hoài niệm, tinh tế và rất đẹp.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Iris phấn, violet, vani. Cổ điển hoài niệm, tinh tế tuyệt đối.",
    verdictShort: "PHẤN MỀM, IRIS, HOÀI NIỆM",
    score: { scent: 9.2, uniqueness: 9.5, compliments: 7.5, value: 7.5, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Hoài niệm", icon: "✨" }, { label: "Tinh tế", icon: "💐" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 60, summer: 35, fall: 85, winter: 80 },
    dayNight: { day: 50, night: 78 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Hồi" }],
    middleNotes: [{ name: "Iris" }, { name: "Hoa violet" }, { name: "Hoa hồng" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Vani" }, { name: "Benzoin" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phấn / Iris", value: 95, color: "#9b59b6" },
      { name: "Hoa", value: 78, color: "#e75480" },
      { name: "Ngọt", value: 55, color: "#FF6D00" },
      { name: "Vani", value: 48, color: "#f5deb3" }
    ],
    tags: ["Nữ", "Kinh điển", "Iris", "Phấn"],
    sizes: ["10ml Chiết", "50ml", "75ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản đậm của Libre. Oải hương, cam hoa và vani sâu hơn. Ấm, sang và quyền lực hơn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Libre bản đậm. Oải hương, vani sâu. Ấm và quyền lực hơn bản gốc.",
    verdictShort: "LIBRE ĐẬM, ẤM, QUYỀN LỰC",
    score: { scent: 8.8, uniqueness: 8.2, compliments: 9, value: 8, total: 8.5 },
    vibes: [{ label: "Tự tin", icon: "🔥" }, { label: "Buổi tối", icon: "🌙" }, { label: "Ấm", icon: "🍂" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 50, summer: 25, fall: 90, winter: 95 },
    dayNight: { day: 35, night: 95 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam ngọt" }],
    middleNotes: [{ name: "Hoa cam" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Vani" }, { name: "Hổ phách" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Thơm thảo mộc", value: 85, color: "#2c7a4b" },
      { name: "Ngọt", value: 78, color: "#FF6D00" },
      { name: "Hoa", value: 62, color: "#e75480" },
      { name: "Hổ phách", value: 48, color: "#d4a017" }
    ],
    tags: ["Nữ", "Buổi tối", "Tự tin", "Ấm"],
    sizes: ["10ml Chiết", "30ml", "50ml", "90ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển nữ với hoa cam, hoa hồng và vani. Gợi cảm, ấm và rất nữ tính.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa cam, hoa hồng, vani. Kinh điển nữ gợi cảm và ấm.",
    verdictShort: "KINH ĐIỂN NỮ, GỢI CẢM, ẤM",
    score: { scent: 8.5, uniqueness: 8, compliments: 8.5, value: 8.5, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Gợi cảm", icon: "✨" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 60, summer: 40, fall: 82, winter: 78 },
    dayNight: { day: 48, night: 82 },
    topNotes: [{ name: "Hoa cam" }, { name: "Cam bergamot" }, { name: "Lê" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa cam" }, { name: "Quế" }],
  ...
  },
  {
    ...
    subName: "Eau de Parfum",
    perfumer: "Sylvaine Delacourte",
    gender: "unisex",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "GUERLAIN Spiritueuse Double Vanille chính hãng", verified: false }],
    description: "Mùi niche vani đôi với rượu rum, gia vị và gỗ. Cực kỳ ấm, sâu và sang theo kiểu phương Đông.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani đôi, rượu rum, gia vị. Gourmand niche cực sang và cực sâu.",
    verdictShort: "VANI ĐÔI, RUM, CỰC SANG",
    score: { scent: 9.5, uniqueness: 9.2, compliments: 8.5, value: 7, total: 8.6 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Xa xỉ", icon: "👑" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 9, sillage: 7,
    seasons: { spring: 25, summer: 10, fall: 90, winter: 100 },
    dayNight: { day: 10, night: 100 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Tiêu hồng" }],
    middleNotes: [{ name: "Vani Madagascar" }, { name: "Rượu rum" }, { name: "Quế" }],
    baseNotes: [{ name: "Benzoin" }, { name: "Gỗ đàn hương" }, { name: "Trầm hương" }],
    accords: [
      { name: "Vani", value: 100, color: "#f5deb3" },
      { name: "Gourmand", value: 88, color: "#8B0000" },
      { name: "Gia vị ấm", value: 72, color: "#e67e22" },
    ...
    tags: ["Niche", "Unisex", "Vani", "Gourmand"],
    sizes: ["10ml Chiết", "75ml", "125ml"],
    basePrice: 7500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ thanh lịch với mẫu đơn, vani và vetiver. Kiểu sang sạch rất Chanel, dễ dùng.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Mẫu đơn, vani, vetiver. Nữ thanh lịch và sang kiểu Chanel.",
    verdictShort: "THANH LỊCH, SANG SẠC, CHANEL",
    score: { scent: 8.5, uniqueness: 7.8, compliments: 8.5, value: 7.8, total: 8.2 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Nữ tính", icon: "💐" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 75, summer: 55, fall: 80, winter: 68 },
    dayNight: { day: 68, night: 62 },
    topNotes: [{ name: "Quýt" }, { name: "Cam bergamot" }, { name: "Lê" }],
    middleNotes: [{ name: "Mẫu đơn" }, { name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoa huệ" }],
    baseNotes: [{ name: "Vani" }, { name: "Vetiver" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Hoa", value: 88, color: "#e75480" },
      { name: "Tươi", value: 62, color: "#2ecc71" },
      { name: "Gỗ", value: 48, color: "#8B4513" },
    ...
    tags: ["Nữ", "Thanh lịch", "Hoa", "Chanel"],
    sizes: ["10ml Chiết", "35ml", "50ml", "100ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche da trắng clean với xạ hương, iris và gỗ. Tối giản và cực kỳ cuốn hút.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Da trắng, xạ hương, iris. Tối giản niche nhưng cực cuốn.",
    verdictShort: "DA TRẮNG, XẠ HƯƠNG, TỐI GIẢN",
    score: { scent: 9, uniqueness: 9.5, compliments: 8, value: 7, total: 8.4 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Tối giản", icon: "✨" }, { label: "Nghệ thuật", icon: "🎨" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 65, summer: 45, fall: 80, winter: 78 },
    dayNight: { day: 55, night: 78 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Bạch đậu khấu" }],
    middleNotes: [{ name: "Xạ hương trắng" }, { name: "Iris" }, { name: "Da suede" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Hổ phách" }, { name: "Gỗ tuyết tùng" }],
    accords: [
      { name: "Xạ hương", value: 92, color: "#9b59b6" },
      { name: "Da thuộc", value: 72, color: "#5D4037" },
      { name: "Gỗ", value: 58, color: "#8B4513" },
      { name: "Phấn / Iris", value: 48, color: "#9b59b6" }
    ],
    tags: ["Niche", "Unisex", "Da", "Tối giản"],
    sizes: ["10ml Chiết", "100ml"],
    basePrice: 6800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi iris thanh lịch với cam bergamot, gỗ tuyết tùng và benzoin. Sạch, sang và rất tinh tế.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Iris sạch, cam bergamot, gỗ. Thanh lịch tinh tế kiểu Prada.",
    verdictShort: "IRIS SẠCH, THANH LỊCH, TINH TẾ",
    score: { scent: 9, uniqueness: 8.8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Tinh tế", icon: "✨" }, { label: "Ban ngày", icon: "☀️" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 85, summer: 65, fall: 75, winter: 55 },
    dayNight: { day: 78, night: 45 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Quýt" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Iris" }, { name: "Hoa violet" }, { name: "Gỗ tuyết tùng" }],
    baseNotes: [{ name: "Benzoin" }, { name: "Vetiver" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phấn / Iris", value: 95, color: "#9b59b6" },
      { name: "Tươi", value: 72, color: "#2ecc71" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
  ...
  },
  {
    ...
    description: "Mùi lá sung và gỗ sung với nhựa cây. Tươi xanh, tự nhiên và rất nghệ thuật.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Lá sung, gỗ sung, nhựa cây. Tươi xanh nghệ thuật, rất đặc biệt.",
    verdictShort: "LÁ SUNG, XANH, NGHỆ THUẬT",
    score: { scent: 9, uniqueness: 9.5, compliments: 7.8, value: 7.5, total: 8.5 },
    vibes: [{ label: "Nghệ thuật", icon: "🎨" }, { label: "Tự nhiên", icon: "🌿" }, { label: "Niche", icon: "💎" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 88, summer: 72, fall: 65, winter: 40 },
    dayNight: { day: 82, night: 38 },
    topNotes: [{ name: "Lá sung" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Nhựa sung" }, { name: "Dừa" }],
    baseNotes: [{ name: "Gỗ sung" }, { name: "Gỗ tuyết tùng" }, { name: "Xạ hương" }],
    accords: [
      { name: "Xanh / Green", value: 100, color: "#2c7a4b" },
      { name: "Tươi", value: 82, color: "#2ecc71" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Trái cây", value: 42, color: "#f39c12" }
    ],
    tags: ["Niche", "Unisex", "Green", "Nghệ thuật"],
    sizes: ["10ml Chiết", "50ml", "75ml"],
    basePrice: 4200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi sữa trắng ngọt với dừa, vani và xạ hương. Gourmand nhẹ, dễ thương và rất dễ khen.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Sữa trắng, dừa, vani. Gourmand nhẹ dễ thương, rất dễ khen.",
    verdictShort: "SỮA TRẮNG, DỪA, DỄ THƯƠNG",
    score: { scent: 8.5, uniqueness: 8.5, compliments: 9.2, value: 8, total: 8.6 },
    vibes: [{ label: "Dễ thương", icon: "🍬" }, { label: "Dễ khen", icon: "👍" }, { label: "Niche", icon: "💎" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 68, summer: 52, fall: 78, winter: 72 },
    dayNight: { day: 62, night: 72 },
    topNotes: [{ name: "Sữa" }, { name: "Dừa" }, { name: "Cam" }],
    middleNotes: [{ name: "Vani" }, { name: "Hoa cam" }, { name: "Caramel" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Gourmand", value: 95, color: "#8B0000" },
      { name: "Ngọt", value: 85, color: "#FF6D00" },
      { name: "Sữa / Kem", value: 78, color: "#f5deb3" },
      { name: "Gỗ", value: 32, color: "#8B4513" }
    ],
    tags: ["Niche", "Unisex", "Gourmand", "Sữa"],
    sizes: ["10ml Chiết", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ tươi với mận, hoa hồng và rêu sồi. Phiêu lưu, tự do và rất nữ tính.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Mận, hoa hồng, rêu sồi. Phiêu lưu nữ tính, tươi và tự do.",
    verdictShort: "MẬN, HOA HỒNG, PHIÊU LƯU",
    score: { scent: 8.5, uniqueness: 8, compliments: 8.8, value: 8.5, total: 8.5 },
    vibes: [{ label: "Phiêu lưu", icon: "🌍" }, { label: "Nữ tính", icon: "💐" }, { label: "Tươi", icon: "🌿" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 80, summer: 62, fall: 78, winter: 55 },
    dayNight: { day: 72, night: 55 },
    topNotes: [{ name: "Mận Mirabelle" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Freesia" }, { name: "Hoa hồng" }, { name: "Mẫu đơn" }],
    baseNotes: [{ name: "Rêu sồi" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương trắng" }],
    accords: [
      { name: "Hoa", value: 88, color: "#e75480" },
      { name: "Tươi", value: 72, color: "#2ecc71" },
      { name: "Chypre", value: 55, color: "#6D4C41" },
      { name: "Gỗ", value: 42, color: "#8B4513" }
    ],
    tags: ["Nữ", "Phiêu lưu", "Hoa", "Tươi"],
    sizes: ["10ml Chiết", "30ml", "50ml", "75ml"],
    basePrice: 2600000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam citrus trắng sang với chanh, gỗ đàn hương và vani. Sạch, sang và rất thanh lịch.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Citrus trắng, gỗ đàn hương, vani. Sạch sang thanh lịch kiểu Chanel.",
    verdictShort: "CITRUS TRẮNG, SANG, THANH LỊCH",
    score: { scent: 9, uniqueness: 8.5, compliments: 8.8, value: 7.8, total: 8.5 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Sang trọng", icon: "✨" }, { label: "Đa dụng", icon: "🔄" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 78, summer: 62, fall: 80, winter: 60 },
    dayNight: { day: 72, night: 58 },
    topNotes: [{ name: "Chanh" }, { name: "Quýt" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hồ tiêu" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Vetiver" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Cam chanh", value: 92, color: "#f7c242" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Tươi", value: 65, color: "#2ecc71" },
      { name: "Ngọt", value: 38, color: "#FF6D00" }
    ],
    tags: ["Nam", "Citrus", "Thanh lịch", "Chanel"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản tươi mát nhất dòng Terre. Cam tươi, gỗ và khoáng. Sạch, nhẹ và sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cam tươi, gỗ, khoáng. Terre bản tươi nhất, sạch nhẹ và sang.",
    verdictShort: "CAM TƯƠI, KHOÁNG, NHẸ SANG",
    score: { scent: 8.8, uniqueness: 8.2, compliments: 8.5, value: 8, total: 8.4 },
    vibes: [{ label: "Tươi", icon: "🍊" }, { label: "Ban ngày", icon: "☀️" }, { label: "Thanh lịch", icon: "🕴️" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 90, summer: 78, fall: 68, winter: 45 },
    dayNight: { day: 85, night: 42 },
    topNotes: [{ name: "Cam tươi" }, { name: "Bưởi" }, { name: "Chanh" }],
    middleNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Oải hương" }],
    baseNotes: [{ name: "Vetiver" }, { name: "Xạ hương" }, { name: "Khoáng" }],
    accords: [
      { name: "Cam chanh", value: 95, color: "#f7c242" },
      { name: "Tươi", value: 85, color: "#2ecc71" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Đất / Khoáng", value: 42, color: "#616161" }
    ],
    tags: ["Nam", "Citrus", "Tươi", "Ban ngày"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản Parfum của Habit Rouge. Cam, vani phương Đông và da thuộc. Cổ điển Pháp tối thượng.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cam, vani, da thuộc. Cổ điển Pháp tối thượng, rất gentleman.",
    verdictShort: "CỔ ĐIỂN PHÁP, VANI, DA THUỘC",
    score: { scent: 9, uniqueness: 9, compliments: 8, value: 7.5, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Gentleman", icon: "🕴️" }, { label: "Phương Đông", icon: "🌙" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 50, summer: 30, fall: 88, winter: 85 },
    dayNight: { day: 40, night: 85 },
    topNotes: [{ name: "Cam" }, { name: "Chanh" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Quế" }, { name: "Hoa cam" }, { name: "Hoa cẩm chướng" }],
    baseNotes: [{ name: "Vani" }, { name: "Da thuộc" }, { name: "Hổ phách" }, { name: "Benzoin" }],
    accords: [
      { name: "Phương Đông", value: 88, color: "#8B0000" },
      { name: "Cam chanh", value: 75, color: "#f7c242" },
      { name: "Da thuộc", value: 62, color: "#5D4037" },
      { name: "Vani", value: 55, color: "#f5deb3" }
    ],
    tags: ["Nam", "Kinh điển", "Phương Đông", "Gentleman"],
    sizes: ["10ml Chiết", "100ml"],
    basePrice: 3800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche hoa hồng đen với oud, gia vị và nhựa thông. Tối, bí ẩn và cực kỳ sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng đen, oud, gia vị. Tối bí ẩn, niche Anh quốc cực sang.",
    verdictShort: "HOA HỒNG ĐEN, OUD, TỐI SANG",
    score: { scent: 9.3, uniqueness: 9.2, compliments: 8.5, value: 7, total: 8.5 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Tối", icon: "🖤" }, { label: "Bí ẩn", icon: "✨" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 35, summer: 15, fall: 92, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Bưởi" }, { name: "Cam bergamot" }, { name: "Gia vị" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Oải hương" }, { name: "Nhục đậu khấu" }],
    baseNotes: [{ name: "Oud" }, { name: "Nhựa thông" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Phương Đông", value: 95, color: "#8B0000" },
      { name: "Hoa", value: 78, color: "#e75480" },
  ...
  },
  {
    ...
    description: "Mùi nam cổ điển da thuộc với hoắc hương, quế và rêu sồi. Quyền lực, trưởng thành và rất nam.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Da thuộc, hoắc hương, quế. Cổ điển quyền lực, rất trưởng thành.",
    verdictShort: "DA THUỘC, QUYỀN LỰC, TRƯỞNG THÀNH",
    score: { scent: 8.8, uniqueness: 9.2, compliments: 7.5, value: 8, total: 8.4 },
    vibes: [{ label: "Quyền lực", icon: "👑" }, { label: "Trưởng thành", icon: "🖤" }, { label: "Kinh điển", icon: "✨" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 40, summer: 20, fall: 90, winter: 85 },
    dayNight: { day: 30, night: 90 },
    topNotes: [{ name: "Quế" }, { name: "Hồ tiêu" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Cẩm chướng" }, { name: "Hoắc hương" }, { name: "Hoa hồng" }],
    baseNotes: [{ name: "Rêu sồi" }, { name: "Da thuộc" }, { name: "Castoreum" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Da thuộc", value: 92, color: "#5D4037" },
      { name: "Gia vị ấm", value: 78, color: "#e67e22" },
      { name: "Gỗ", value: 65, color: "#8B4513" },
      { name: "Chypre", value: 52, color: "#6D4C41" }
    ],
    tags: ["Nam", "Kinh điển", "Da", "Quyền lực"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển aquatic nam với biển, bạc hà và oải hương. Tươi sạch, dễ dùng và giá rất tốt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Biển, bạc hà, oải hương. Kinh điển aquatic, giá tốt và rất dễ dùng.",
    verdictShort: "BIỂN KINH ĐIỂN, TƯƠI, GIÁ TỐT",
    score: { scent: 8, uniqueness: 7.5, compliments: 8.5, value: 9.5, total: 8.4 },
    vibes: [{ label: "Ban ngày", icon: "☀️" }, { label: "Kinh điển", icon: "👑" }, { label: "Giá tốt", icon: "💰" }],
    longevity: 5, sillage: 6,
    seasons: { spring: 88, summer: 85, fall: 55, winter: 35 },
    dayNight: { day: 88, night: 30 },
    topNotes: [{ name: "Bạc hà" }, { name: "Cam" }, { name: "Oải hương" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Phong lữ" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Xạ hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Tươi", value: 100, color: "#2ecc71" },
      { name: "Biển / Aquatic", value: 88, color: "#1abc9c" },
      { name: "Thơm thảo mộc", value: 58, color: "#2c7a4b" },
      { name: "Gỗ", value: 35, color: "#8B4513" }
    ],
    tags: ["Nam", "Kinh điển", "Aquatic", "Giá tốt"],
    sizes: ["10ml Chiết", "40ml", "75ml", "125ml", "200ml"],
    basePrice: 850000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển fougère nam 80s với oải hương, rêu và gỗ. Mạnh, nam tính và rất có lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Oải hương, rêu, gỗ. Kinh điển 80s mạnh, nam tính có lực.",
    verdictShort: "KINH ĐIỂN 80S, MẠNH, NAM TÍNH",
    score: { scent: 8.2, uniqueness: 8.5, compliments: 7.5, value: 9.2, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Mạnh", icon: "🔥" }, { label: "Retro", icon: "🕰️" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 50, summer: 30, fall: 85, winter: 80 },
    dayNight: { day: 40, night: 82 },
    topNotes: [{ name: "Oải hương" }, { name: "Cam bergamot" }, { name: "Hồi" }],
    middleNotes: [{ name: "Bách xù" }, { name: "Rau mùi" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Rêu sồi" }, { name: "Da thuộc" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Thơm thảo mộc", value: 95, color: "#2c7a4b" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Gia vị ấm", value: 55, color: "#e67e22" },
      { name: "Xanh / Green", value: 42, color: "#2c7a4b" }
    ],
    tags: ["Nam", "Kinh điển", "Fougère", "Retro"],
    sizes: ["10ml Chiết", "50ml", "100ml", "200ml"],
    basePrice: 650000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche da thuộc với nghệ tây, oud và hoa. Da sang kiểu Châu Phi, ấm và rất cuốn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Da thuộc, nghệ tây, oud. Da niche sang kiểu Châu Phi, ấm và cuốn.",
    verdictShort: "DA THUỘC SANG, NGHỆ TÂY, OUD",
    score: { scent: 9.2, uniqueness: 9.2, compliments: 8.8, value: 7, total: 8.6 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Xa hoa", icon: "👑" }, { label: "Ấm", icon: "🍂" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 40, summer: 20, fall: 90, winter: 100 },
    dayNight: { day: 25, night: 100 },
    topNotes: [{ name: "Nghệ tây" }, { name: "Cam bergamot" }, { name: "Bạch đậu khấu" }],
    middleNotes: [{ name: "Da thuộc" }, { name: "Hoa phong lan" }, { name: "Phong lữ" }],
    baseNotes: [{ name: "Oud" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }, { name: "Xạ hương" }],
    accords: [
      { name: "Da thuộc", value: 100, color: "#5D4037" },
    ...
    tags: ["Niche", "Unisex", "Da", "Oud"],
    sizes: ["10ml Chiết", "75ml"],
    basePrice: 7500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam cacao ngọt với cam, gừng và hoắc hương. Ấm, ngọt sang và rất nam tính.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cacao, cam, gừng. Ấm ngọt sang theo kiểu rất Guerlain.",
    verdictShort: "CACAO, CAM, ẤM NGỌT SANG",
    score: { scent: 9, uniqueness: 8.8, compliments: 8.5, value: 7.5, total: 8.5 },
    vibes: [{ label: "Sang trọng", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Ấm", icon: "🍂" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 50, summer: 30, fall: 90, winter: 88 },
    dayNight: { day: 38, night: 90 },
    topNotes: [{ name: "Cam" }, { name: "Cam bergamot" }, { name: "Hồi" }],
    middleNotes: [{ name: "Cacao" }, { name: "Gừng" }, { name: "Quế" }],
    baseNotes: [{ name: "Hoắc hương" }, { name: "Gỗ đàn hương" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Gourmand", value: 88, color: "#8B0000" },
      { name: "Gia vị ấm", value: 78, color: "#e67e22" },
      { name: "Cam chanh", value: 62, color: "#f7c242" },
  ...
  },
  {
    ...
    description: "Mùi tươi xanh với xoài xanh, cà chua và gỗ. Tự nhiên, nhẹ và rất nghệ thuật.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Xoài xanh, cà chua, gỗ. Tươi tự nhiên, nhẹ nhàng và nghệ thuật.",
    verdictShort: "XOÀI XANH, TƯƠI, NGHỆ THUẬT",
    score: { scent: 8.8, uniqueness: 9.2, compliments: 7.8, value: 8, total: 8.5 },
    vibes: [{ label: "Tươi", icon: "🌿" }, { label: "Nghệ thuật", icon: "🎨" }, { label: "Ban ngày", icon: "☀️" }],
    longevity: 6, sillage: 6,
    seasons: { spring: 90, summer: 82, fall: 55, winter: 35 },
    dayNight: { day: 85, night: 30 },
    topNotes: [{ name: "Xoài xanh" }, { name: "Cam bergamot" }, { name: "Cà chua" }],
    middleNotes: [{ name: "Hoa sen" }, { name: "Hoa cam" }, { name: "Tiêu" }],
    baseNotes: [{ name: "Gỗ tuyết tùng" }, { name: "Xạ hương" }, { name: "Vetiver" }],
    accords: [
      { name: "Xanh / Green", value: 95, color: "#2c7a4b" },
      { name: "Tươi", value: 88, color: "#2ecc71" },
    ...
    tags: ["Unisex", "Tươi", "Green", "Nghệ thuật"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    name: "Dolce Vita",
    subName: "Eau de Toilette",
    perfumer: "Maurice Roger & Pierre Bourdon",
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "DIOR Dolce Vita chính hãng", verified: false }],
    description: "Mùi nữ cổ điển hoa-gỗ với mận, hoa huệ và gỗ đàn hương. Ấm, sang và rất Ý.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Mận, hoa huệ, gỗ đàn hương. Cổ điển sang, ấm kiểu La Dolce Vita.",
    verdictShort: "MẬN, HOA HUỆ, SANG CỔ ĐIỂN",
    score: { scent: 8.8, uniqueness: 8.8, compliments: 8, value: 7.5, total: 8.3 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Sang trọng", icon: "✨" }, { label: "Ấm", icon: "🍂" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 60, summer: 40, fall: 82, winter: 75 },
    dayNight: { day: 52, night: 75 },
    topNotes: [{ name: "Mận" }, { name: "Quýt" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa huệ" }, { name: "Hoa hồng" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Xạ hương" }],
    accords: [
      { name: "Hoa", value: 88, color: "#e75480" },
      { name: "Trái cây", value: 72, color: "#f39c12" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Ngọt", value: 45, color: "#FF6D00" }
    ],
    tags: ["Nữ", "Kinh điển", "Hoa", "Sang"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi niche phấn mềm với iris, vani và xạ hương. Mềm mại, ấm và cực kỳ dễ chịu.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Iris phấn, vani, xạ hương. Mềm ấm niche, cực dễ chịu và sang.",
    verdictShort: "IRIS PHẤN, MỀM, CỰC DỄ CHỊU",
    score: { scent: 9.2, uniqueness: 9, compliments: 9, value: 8, total: 8.8 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Mềm", icon: "✨" }, { label: "Dễ chịu", icon: "🧴" }],
    longevity: 9, sillage: 7,
    seasons: { spring: 65, summer: 42, fall: 88, winter: 85 },
    dayNight: { day: 52, night: 85 },
    topNotes: [{ name: "Hồ tiêu hồng" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Iris" }, { name: "Hoa nhài" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Vani" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Phấn / Iris", value: 92, color: "#9b59b6" },
      { name: "Ngọt", value: 72, color: "#FF6D00" },
      { name: "Gỗ", value: 58, color: "#8B4513" },
      { name: "Xạ hương", value: 48, color: "#9b59b6" }
    ],
    tags: ["Niche", "Unisex", "Iris", "Phấn"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 5800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản đậm của La Belle. Lê, vani và hoa cam mạnh hơn. Gợi cảm sang hơn bản gốc.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Lê, vani, hoa cam. La Belle bản đậm, gợi cảm sang hơn.",
    verdictShort: "LA BELLE ĐẬM, GỢI CẢM SANG",
    score: { scent: 8.8, uniqueness: 8.2, compliments: 9, value: 8, total: 8.5 },
    vibes: [{ label: "Gợi cảm", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Sang trọng", icon: "💎" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 45, summer: 25, fall: 90, winter: 92 },
    dayNight: { day: 30, night: 95 },
    topNotes: [{ name: "Lê" }, { name: "Hoa cam" }],
    middleNotes: [{ name: "Vani" }, { name: "Hoa nhài" }, { name: "Quế" }],
    baseNotes: [{ name: "Đậu tonka" }, { name: "Benzoin" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Hoa", value: 68, color: "#e75480" },
      { name: "Trái cây", value: 55, color: "#f39c12" },
  ...
  },
  {
    ...
    name: "Cinéma",
    subName: "Eau de Parfum",
    perfumer: "Pierre Wargnye & Jacques Cavallier",
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "YVES SAINT LAURENT Cinéma chính hãng", verified: false }],
    description: "Mùi nữ hoa-gỗ với hoa hồng, hoa nhài và xạ hương trắng. Hollywood sang và quyến rũ.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa hồng, nhài, xạ hương. Hollywood sang, quyến rũ kiểu cổ điển.",
    verdictShort: "HOLLYWOOD SANG, HOA HỒNG, QUYẾN RŨ",
    score: { scent: 8.5, uniqueness: 8.2, compliments: 8.5, value: 7.5, total: 8.2 },
    vibes: [{ label: "Sang trọng", icon: "✨" }, { label: "Quyến rũ", icon: "❤️" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 60, summer: 40, fall: 80, winter: 72 },
    dayNight: { day: 48, night: 78 },
    topNotes: [{ name: "Quýt" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoa huệ" }],
    baseNotes: [{ name: "Xạ hương trắng" }, { name: "Gỗ đàn hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Hoa", value: 92, color: "#e75480" },
      { name: "Gỗ", value: 58, color: "#8B4513" },
      { name: "Ngọt", value: 48, color: "#FF6D00" },
      { name: "Xạ hương", value: 38, color: "#9b59b6" }
    ],
    tags: ["Nữ", "Hoa", "Sang", "Quyến rũ"],
    sizes: ["10ml Chiết", "35ml", "50ml", "90ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại hoa linh lan với lá xanh và hoa nhài. Tinh khiết, nhẹ nhàng và đẹp phi thường.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa linh lan tinh khiết. Huyền thoại nhẹ nhàng, đẹp phi thường.",
    verdictShort: "LINH LAN, TINH KHIẾT, TỐI THƯỢNG",
    score: { scent: 9.2, uniqueness: 9.5, compliments: 7.5, value: 7, total: 8.3 },
    vibes: [{ label: "Huyền thoại", icon: "👑" }, { label: "Tinh khiết", icon: "✨" }, { label: "Xuân", icon: "🌸" }],
    longevity: 5, sillage: 5,
    seasons: { spring: 92, summer: 75, fall: 58, winter: 35 },
    dayNight: { day: 85, night: 30 },
    topNotes: [{ name: "Hoa linh lan" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Cam bergamot" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Hoa", value: 100, color: "#e75480" },
      { name: "Xanh / Green", value: 72, color: "#2c7a4b" },
      { name: "Tươi", value: 65, color: "#2ecc71" },
      { name: "Phấn", value: 38, color: "#9b59b6" }
    ],
    tags: ["Nữ", "Huyền thoại", "Hoa", "Tinh khiết"],
    sizes: ["10ml Chiết", "50ml"],
    basePrice: 3500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Bản Extrait đặc của Samsara. Gỗ đàn hương, vani và hoa nhài cô đặc. Xa xỉ tuyệt đối.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gỗ đàn hương, vani cô đặc. Samsara bản xa xỉ tuyệt đối.",
    verdictShort: "EXTRAIT ĐẶC, XA XỈ, CÔ ĐẶC",
    score: { scent: 9.5, uniqueness: 9.2, compliments: 8, value: 6.5, total: 8.3 },
    vibes: [{ label: "Xa xỉ", icon: "💎" }, { label: "Kinh điển", icon: "👑" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 10, sillage: 7,
    seasons: { spring: 35, summer: 15, fall: 90, winter: 100 },
    dayNight: { day: 15, night: 100 },
    topNotes: [{ name: "Ylang-ylang" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Hoa narcissus" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Vani" }, { name: "Đậu tonka" }, { name: "Iris" }],
    accords: [
      { name: "Gỗ", value: 100, color: "#8B4513" },
      { name: "Phương Đông", value: 88, color: "#8B0000" },
    ...
    tags: ["Nữ", "Xa xỉ", "Gỗ", "Phương Đông"],
    sizes: ["10ml Chiết", "15ml"],
    basePrice: 5500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ ngọt ấm với cà phê, gỗ đàn hương và dừa. Dễ thương, trẻ trung và dễ khen.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cà phê, gỗ đàn hương, dừa. Ngọt ấm dễ thương, rất dễ khen.",
    verdictShort: "CÀ PHÊ, DỪA, DỄ THƯƠNG DỄ KHEN",
    score: { scent: 8.5, uniqueness: 8, compliments: 9, value: 8.5, total: 8.5 },
    vibes: [{ label: "Dễ thương", icon: "🍬" }, { label: "Dễ khen", icon: "👍" }, { label: "Trẻ trung", icon: "⚡" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 82, winter: 78 },
    dayNight: { day: 48, night: 82 },
    topNotes: [{ name: "Cà phê" }, { name: "Quả mọng" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Dừa" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Gỗ đàn hương" }, { name: "Cashmeran" }, { name: "Xạ hương" }],
    accords: [
      { name: "Ngọt", value: 88, color: "#FF6D00" },
      { name: "Gourmand", value: 72, color: "#8B0000" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Hoa", value: 42, color: "#e75480" }
    ],
    tags: ["Nữ", "Ngọt", "Dễ khen", "Trẻ trung"],
    sizes: ["10ml Chiết", "30ml", "50ml", "100ml"],
    basePrice: 1800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Phiên bản tươi hơn của La Nuit. Bạch đậu khấu, gừng và oải hương xanh. Hiện đại và cuốn.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "La Nuit bản tươi hơn. Bạch đậu khấu, gừng, xanh hơn. Hiện đại và cuốn.",
    verdictShort: "LA NUIT XANH, TƯƠI, HIỆN ĐẠI",
    score: { scent: 9, uniqueness: 8.5, compliments: 9.2, value: 8, total: 8.7 },
    vibes: [{ label: "Hẹn hò", icon: "❤️" }, { label: "Hiện đại", icon: "⚡" }, { label: "Buổi tối", icon: "🌙" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 65, summer: 45, fall: 88, winter: 78 },
    dayNight: { day: 45, night: 92 },
    topNotes: [{ name: "Bạch đậu khấu" }, { name: "Gừng" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Oải hương" }, { name: "Phong lữ" }, { name: "Hoa violet" }],
    baseNotes: [{ name: "Vetiver" }, { name: "Gỗ tuyết tùng" }, { name: "Đậu tonka" }],
    accords: [
      { name: "Gia vị ấm", value: 88, color: "#e67e22" },
      { name: "Thơm thảo mộc", value: 78, color: "#2c7a4b" },
      { name: "Tươi", value: 62, color: "#2ecc71" },
  ...
  },
  {
    ...
    description: "Kinh điển nam Pháp với cam, quế và da thuộc. Cổ điển lịch lãm, rất gentleman.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cam, quế, da thuộc. Kinh điển Pháp lịch lãm, rất gentleman.",
    verdictShort: "CỔ ĐIỂN PHÁP, LỊCH LÃM",
    score: { scent: 8.5, uniqueness: 8.8, compliments: 7.8, value: 8.5, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Gentleman", icon: "🕴️" }, { label: "Lịch lãm", icon: "✨" }],
    longevity: 6, sillage: 6,
    seasons: { spring: 60, summer: 40, fall: 80, winter: 72 },
    dayNight: { day: 55, night: 70 },
    topNotes: [{ name: "Cam" }, { name: "Chanh" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Quế" }, { name: "Hoa cam" }, { name: "Cẩm chướng" }],
    baseNotes: [{ name: "Da thuộc" }, { name: "Vani" }, { name: "Hổ phách" }],
    accords: [
      { name: "Cam chanh", value: 82, color: "#f7c242" },
      { name: "Phương Đông", value: 72, color: "#8B0000" },
      { name: "Da thuộc", value: 55, color: "#5D4037" },
      { name: "Gia vị ấm", value: 48, color: "#e67e22" }
    ],
    tags: ["Nam", "Kinh điển", "Pháp", "Gentleman"],
    sizes: ["10ml Chiết", "50ml", "100ml", "200ml"],
    basePrice: 2200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nam thanh lịch với cam, gỗ và tiêu. Sạch, sang và rất đa dụng kiểu Chanel.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Cam, gỗ, tiêu. Sạch sang thanh lịch, đa dụng kiểu Chanel.",
    verdictShort: "SẠCH SANG, ĐA DỤNG, CHANEL",
    score: { scent: 8.5, uniqueness: 7.8, compliments: 8.5, value: 7.8, total: 8.2 },
    vibes: [{ label: "Thanh lịch", icon: "🕴️" }, { label: "Đa dụng", icon: "🔄" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 78, summer: 62, fall: 75, winter: 58 },
    dayNight: { day: 72, night: 55 },
    topNotes: [{ name: "Quýt" }, { name: "Cam bergamot" }, { name: "Đào" }],
    middleNotes: [{ name: "Tiêu" }, { name: "Gỗ tuyết tùng" }, { name: "Hoa nhài" }],
    baseNotes: [{ name: "Vani" }, { name: "Đậu tonka" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Cam chanh", value: 82, color: "#f7c242" },
      { name: "Gỗ", value: 72, color: "#8B4513" },
      { name: "Tươi", value: 58, color: "#2ecc71" },
    ...
    tags: ["Nam", "Thanh lịch", "Đa dụng", "Chanel"],
    sizes: ["10ml Chiết", "50ml", "100ml", "150ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    id: "creed-absolu-aventus-2",
    brandSlug: "creed",
    brand: "CREED",
    name: "Absolu Aventus",
    subName: "Eau de Parfum",
    ...
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "CREED Absolu Aventus chính hãng", verified: false }],
    description: "Phiên bản đậm của Aventus. Trái cây cô đặc, gỗ sâu. Sang và quyền lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Aventus bản đậm. Trái cây cô đặc, gỗ sâu. Quyền lực.",
    verdictShort: "AVENTUS ĐẬM, CÔ ĐẶC",
    score: { scent: 9.3, uniqueness: 9, compliments: 9, value: 6.5, total: 8.5 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Quyền lực", icon: "👑" }, { label: "Sang trọng", icon: "✨" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 60, summer: 35, fall: 90, winter: 85 },
    dayNight: { day: 55, night: 88 },
    topNotes: [{ name: "Dứa" }, { name: "Táo" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Gỗ bạch dương" }, { name: "Hoắc hương" }],
    baseNotes: [{ name: "Xạ hương" }, { name: "Hổ phách" }, { name: "Vani" }],
    accords: [
      { name: "Trái cây", value: 90, color: "#f39c12" },
      { name: "Gỗ", value: 78, color: "#8B4513" },
      { name: "Khói", value: 55, color: "#616161" },
  ...
  },
  {
    ...
    description: "Bản đậm hơn Encre Noire. Vetiver, cypress và hổ phách sâu hơn. Tối, mạnh và giá tốt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vetiver sâu hơn, hổ phách. Encre Noire bản mạnh, tối hơn, giá vẫn tốt.",
    verdictShort: "VETIVER CỰC SÂU, TỐI, GIÁ TỐT",
    score: { scent: 9, uniqueness: 9.2, compliments: 7.8, value: 9.5, total: 8.9 },
    vibes: [{ label: "Tối", icon: "🖤" }, { label: "Giá tốt", icon: "💰" }, { label: "Mạnh", icon: "🔥" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 35, summer: 12, fall: 95, winter: 100 },
    dayNight: { day: 20, night: 100 },
    topNotes: [{ name: "Cypress" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Vetiver" }, { name: "Hổ phách" }],
    baseNotes: [{ name: "Cashmere wood" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Gỗ", value: 100, color: "#8B4513" },
      { name: "Đất / Khoáng", value: 88, color: "#616161" },
      { name: "Hổ phách", value: 62, color: "#d4a017" },
  ...
  },
  {
    ...
    description: "Mùi nữ chypre hiện đại với hoa gardenia, rêu sồi và xạ hương. Sang, cá tính và quyền lực.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Gardenia, rêu sồi, xạ hương. Chypre hiện đại, sang và quyền lực.",
    verdictShort: "CHYPRE HIỆN ĐẠI, SANG, CÁ TÍNH",
    score: { scent: 9, uniqueness: 9, compliments: 8.5, value: 7.8, total: 8.6 },
    vibes: [{ label: "Sang trọng", icon: "💎" }, { label: "Cá tính", icon: "🔥" }, { label: "Quyền lực", icon: "👑" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 65, summer: 40, fall: 88, winter: 82 },
    dayNight: { day: 48, night: 88 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Cam ngọt" }],
    middleNotes: [{ name: "Gardenia" }, { name: "Hoa hồng" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Rêu sồi" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Hoa", value: 88, color: "#e75480" },
      { name: "Chypre", value: 78, color: "#6D4C41" },
      { name: "Gỗ", value: 55, color: "#8B4513" },
      { name: "Xạ hương", value: 42, color: "#9b59b6" }
    ],
    tags: ["Nữ", "Chypre", "Sang trọng", "Cá tính"],
    sizes: ["10ml Chiết", "30ml", "50ml", "75ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    id: "kayali-vanilla-28-2",
    brandSlug: "kayali",
    brand: "KAYALI",
    name: "Vanilla 28",
    subName: "Eau de Parfum",
    ...
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "KAYALI Vanilla 28 chính hãng", verified: false }],
    description: "Mùi vani ấm sạch với hoa cam, vani Madagascar và đậu tonka. Ngọt ấm rất dễ khen.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani ấm sạch, hoa cam, đậu tonka. Ngọt ấm cực dễ khen.",
    verdictShort: "VANI ẤM SẠCH, DỄ KHEN",
    score: { scent: 8.5, uniqueness: 7.8, compliments: 9.2, value: 8, total: 8.4 },
    vibes: [{ label: "Ngọt", icon: "🍬" }, { label: "Dễ khen", icon: "👍" }, { label: "Ấm", icon: "🍂" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 85, winter: 82 },
    dayNight: { day: 48, night: 85 },
    topNotes: [{ name: "Hoa cam" }, { name: "Quýt" }],
    middleNotes: [{ name: "Vani Madagascar" }, { name: "Hoa gardenia" }],
    baseNotes: [{ name: "Đậu tonka" }, { name: "Xạ hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Vani", value: 95, color: "#f5deb3" },
      { name: "Ngọt", value: 82, color: "#FF6D00" },
      { name: "Hoa", value: 48, color: "#e75480" },
      { name: "Ấm", value: 42, color: "#e67e22" }
    ],
    tags: ["Nữ", "Vani", "Ngọt", "Dễ khen"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 2800000,
    shopeeOffers: []
  },
  {
    ...
    description: "Huyền thoại chypre xanh với cam bergamot, hoa hồng và vetiver. Thanh lịch kiểu Paris cổ điển.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Chypre xanh huyền thoại. Cam bergamot, hồng, vetiver. Paris cổ điển.",
    verdictShort: "CHYPRE PARIS, HUYỀN THOẠI, THANH LỊCH",
    score: { scent: 8.8, uniqueness: 9.5, compliments: 7.5, value: 8, total: 8.5 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Paris", icon: "✨" }],
    longevity: 6, sillage: 6,
    seasons: { spring: 82, summer: 62, fall: 68, winter: 45 },
    dayNight: { day: 78, night: 38 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Hồi" }, { name: "Aldehyde" }],
    middleNotes: [{ name: "Hoa hồng" }, { name: "Hoa nhài" }, { name: "Hoa huệ" }],
    baseNotes: [{ name: "Vetiver" }, { name: "Rêu sồi" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Chypre", value: 95, color: "#6D4C41" },
      { name: "Hoa", value: 78, color: "#e75480" },
      { name: "Xanh / Green", value: 62, color: "#2c7a4b" },
      { name: "Aldehyde", value: 48, color: "#c0c0c0" }
    ],
    tags: ["Nữ", "Kinh điển", "Chypre", "Paris"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 2200000,
    shopeeOffers: []
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "GUERLAIN L'Heure Bleue chính hãng", verified: false }],
    description: "Bản EDT nhẹ hơn của L'Heure Bleue. Iris phấn mềm, violet, vani. Nhẹ nhàng và hoài niệm.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "L'Heure Bleue bản nhẹ. Iris phấn, violet. Nhẹ nhàng hoài niệm.",
    verdictShort: "PHẤN NHẸ, IRIS, HOÀI NIỆM",
    score: { scent: 9, uniqueness: 9.2, compliments: 7.2, value: 7.5, total: 8.2 },
    vibes: [{ label: "Hoài niệm", icon: "✨" }, { label: "Nhẹ nhàng", icon: "🧴" }, { label: "Kinh điển", icon: "👑" }],
    longevity: 5, sillage: 5,
    seasons: { spring: 72, summer: 45, fall: 78, winter: 62 },
    dayNight: { day: 65, night: 55 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Hồi" }],
    middleNotes: [{ name: "Hoa violet" }, { name: "Iris" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Vani" }, { name: "Benzoin" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phấn / Iris", value: 92, color: "#9b59b6" },
  ...
  },
  {
    ...
    description: "Mùi niche hoa tuberose kinh điển. Quyền lực, gợi cảm và đẹp phi thường.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Tuberose niche kinh điển. Quyền lực, gợi cảm, đẹp phi thường.",
    verdictShort: "TUBEROSE, QUYỀN LỰC, KIỆT TÁC",
    score: { scent: 9.5, uniqueness: 9.5, compliments: 8.2, value: 6.8, total: 8.5 },
    vibes: [{ label: "Niche", icon: "💎" }, { label: "Kiệt tác", icon: "👑" }, { label: "Quyền lực", icon: "🔥" }],
    longevity: 8, sillage: 8,
    seasons: { spring: 70, summer: 50, fall: 78, winter: 55 },
    dayNight: { day: 58, night: 78 },
    topNotes: [{ name: "Bạc hà" }, { name: "Cam bergamot" }],
    middleNotes: [{ name: "Hoa huệ" }, { name: "Hoa cam" }, { name: "Dừa" }],
    baseNotes: [{ name: "Xạ hương trắng" }, { name: "Benzoin" }, { name: "Gỗ tuyết tùng" }],
    accords: [
      { name: "Hoa trắng", value: 100, color: "#e75480" },
      { name: "Tươi", value: 55, color: "#2ecc71" },
      { name: "Xanh / Green", value: 42, color: "#2c7a4b" },
      { name: "Kem / Ngọt", value: 38, color: "#FF6D00" }
    ],
    tags: ["Niche", "Unisex", "Hoa", "Kiệt tác"],
    sizes: ["5ml", "10ml Chiết", "50ml", "100ml"],
    basePrice: 8500000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ mật ong-hổ phách với hoa mộc lan, cam bergamot và xạ hương. Ấm, mềm và sang.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Mật ong, mộc lan, hổ phách. Ấm mềm sang kiểu Guerlain nữ.",
    verdictShort: "MẬT ONG, MỘC LAN, ẤM SANG",
    score: { scent: 9, uniqueness: 8.5, compliments: 8.5, value: 7.5, total: 8.4 },
    vibes: [{ label: "Sang trọng", icon: "💎" }, { label: "Nữ tính", icon: "💐" }, { label: "Ấm", icon: "🍂" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 30, fall: 88, winter: 85 },
    dayNight: { day: 38, night: 88 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Cam" }],
    middleNotes: [{ name: "Hoa mộc lan" }, { name: "Mật ong" }, { name: "Hoa cam" }],
    baseNotes: [{ name: "Hổ phách" }, { name: "Xạ hương" }, { name: "Gỗ đàn hương" }],
    accords: [
      { name: "Hoa", value: 82, color: "#e75480" },
      { name: "Hổ phách", value: 75, color: "#d4a017" },
      { name: "Ngọt", value: 58, color: "#FF6D00" },
  ...
  },
  {
    ...
    description: "Mùi nữ hoa-gỗ sang với hoa cam, vani và gỗ đàn hương. Xa xỉ, lịch lãm kiểu Hermès.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa cam, vani, gỗ đàn hương. Xa xỉ lịch lãm kiểu Hermès.",
    verdictShort: "HOA CAM, VANI, XA XỈ HERMÈS",
    score: { scent: 9, uniqueness: 8.8, compliments: 8.2, value: 7.5, total: 8.4 },
    vibes: [{ label: "Xa xỉ", icon: "💎" }, { label: "Thanh lịch", icon: "🕴️" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 60, summer: 42, fall: 82, winter: 75 },
    dayNight: { day: 52, night: 78 },
    topNotes: [{ name: "Hoa cam" }, { name: "Cam bergamot" }, { name: "Đào" }],
    middleNotes: [{ name: "Hoa nhài" }, { name: "Hoa hồng" }, { name: "Iris" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Hoắc hương" }, { name: "Hổ phách" }],
    accords: [
      { name: "Hoa", value: 92, color: "#e75480" },
      { name: "Gỗ", value: 68, color: "#8B4513" },
      { name: "Ngọt", value: 48, color: "#FF6D00" },
  ...
  },
  {
    ...
    description: "Mùi nữ ngọt hoa violet với cam thảo, hoa iris và xạ hương. Cổ tích, ngọt ngào và rất đặc biệt.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Violet ngọt, cam thảo, iris. Cổ tích ngọt ngào, rất đặc biệt.",
    verdictShort: "VIOLET NGỌT, CỔ TÍCH, ĐẶC BIỆT",
    score: { scent: 8.8, uniqueness: 9, compliments: 8.8, value: 9, total: 8.9 },
    vibes: [{ label: "Cổ tích", icon: "✨" }, { label: "Ngọt", icon: "🍬" }, { label: "Đặc biệt", icon: "💐" }],
    longevity: 8, sillage: 7,
    seasons: { spring: 55, summer: 35, fall: 85, winter: 80 },
    dayNight: { day: 42, night: 85 },
    topNotes: [{ name: "Hồi" }, { name: "Anh đào" }],
    middleNotes: [{ name: "Iris" }, { name: "Hoa violet" }, { name: "Cam thảo" }],
    baseNotes: [{ name: "Vani" }, { name: "Xạ hương" }, { name: "Đậu tonka" }, { name: "Praline" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Hoa", value: 78, color: "#e75480" },
      { name: "Gourmand", value: 62, color: "#8B0000" },
      { name: "Phấn / Iris", value: 48, color: "#9b59b6" }
    ],
    tags: ["Nữ", "Ngọt", "Cổ tích", "Đặc biệt"],
    sizes: ["10ml Chiết", "30ml", "50ml", "80ml"],
    basePrice: 1500000,
    shopeeOffers: []
  },
  {
    id: "dior-hypnotic-poison-edp",
    brandSlug: "dior",
    brand: "DIOR",
    name: "Hypnotic Poison Eau de Parfum",
    subName: "Eau de Parfum",
    perfumer: "François Demachy",
    gender: "nu",
    image: PENDING_IMAGE,
    images: [{ url: PENDING_IMAGE, source: "fragram", caption: "DIOR Hypnotic Poison Eau de Parfum chính hãng", verified: false }],
    description: "Phiên bản EDP đậm hơn Hypnotic Poison. Vani, hạnh nhân và gỗ sâu hơn. Quyến rũ mạnh.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Vani EDP đậm, hạnh nhân sâu. Hypnotic Poison bản quyến rũ mạnh hơn.",
    verdictShort: "VANI ĐẬM, HẠNH NHÂN, QUYẾN RŨ MẠNH",
    score: { scent: 9, uniqueness: 8.5, compliments: 9, value: 8, total: 8.6 },
    vibes: [{ label: "Quyến rũ", icon: "✨" }, { label: "Buổi tối", icon: "🌙" }, { label: "Sang trọng", icon: "💎" }],
    longevity: 9, sillage: 8,
    seasons: { spring: 40, summer: 18, fall: 92, winter: 100 },
    dayNight: { day: 22, night: 100 },
    topNotes: [{ name: "Hạnh nhân" }, { name: "Quýt" }],
    middleNotes: [{ name: "Hoa nhài Sambac" }, { name: "Hoa huệ" }],
    baseNotes: [{ name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương" }, { name: "Benzoin" }],
    accords: [
      { name: "Ngọt", value: 95, color: "#FF6D00" },
      { name: "Hổ phách", value: 78, color: "#d4a017" },
      { name: "Gỗ", value: 58, color: "#8B4513" },
      { name: "Hoa trắng", value: 42, color: "#e75480" }
    ],
    tags: ["Nữ", "Ngọt", "Quyến rũ", "Buổi tối"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  },
  {
    ...
    description: "Kinh điển phương Đông 80s với hổ phách, vani và gia vị. Ấm, bí ẩn và gợi cảm.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hổ phách, vani, gia vị. Kinh điển 80s phương Đông, gợi cảm.",
    verdictShort: "KINH ĐIỂN 80S, HỔ PHÁCH, GỢI CẢM",
    score: { scent: 8.2, uniqueness: 8.5, compliments: 8, value: 9, total: 8.4 },
    vibes: [{ label: "Kinh điển", icon: "👑" }, { label: "Gợi cảm", icon: "✨" }, { label: "Retro", icon: "🕰️" }],
    longevity: 7, sillage: 7,
    seasons: { spring: 40, summer: 20, fall: 88, winter: 90 },
    dayNight: { day: 25, night: 92 },
    topNotes: [{ name: "Quýt" }, { name: "Cam bergamot" }, { name: "Quế" }],
    middleNotes: [{ name: "Hoa cam" }, { name: "Hoa nhài" }, { name: "Hoa cẩm chướng" }],
    baseNotes: [{ name: "Hổ phách" }, { name: "Vani" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương" }],
    accords: [
      { name: "Phương Đông", value: 95, color: "#8B0000" },
    ...
    tags: ["Nữ", "Kinh điển", "Phương Đông", "Giá tốt"],
    sizes: ["10ml Chiết", "50ml", "100ml"],
    basePrice: 850000,
    shopeeOffers: []
  },
  {
    ...
    description: "Mùi nữ hoa mimosa với cam bergamot, hoa hồng và hổ phách. Tươi sáng, vui và rất Paris.",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "Hoa mimosa, cam bergamot, hoa hồng. Tươi sáng và vui kiểu Paris.",
    verdictShort: "MIMOSA, TƯƠI SÁNG, PARIS",
    score: { scent: 8.5, uniqueness: 8.2, compliments: 8, value: 7.5, total: 8.1 },
    vibes: [{ label: "Paris", icon: "✨" }, { label: "Tươi sáng", icon: "☀️" }, { label: "Nữ tính", icon: "💐" }],
    longevity: 7, sillage: 6,
    seasons: { spring: 82, summer: 65, fall: 65, winter: 42 },
    dayNight: { day: 78, night: 38 },
    topNotes: [{ name: "Cam bergamot" }, { name: "Đào" }, { name: "Quýt" }],
    middleNotes: [{ name: "Mimosa" }, { name: "Hoa hồng" }, { name: "Hoa huệ" }],
    baseNotes: [{ name: "Hổ phách" }, { name: "Gỗ đàn hương" }, { name: "Xạ hương" }],
    accords: [
      { name: "Hoa", value: 92, color: "#e75480" },
      { name: "Tươi", value: 72, color: "#2ecc71" },
      { name: "Cam chanh", value: 58, color: "#f7c242" },
      { name: "Gỗ", value: 35, color: "#8B4513" }
    ],
    tags: ["Nữ", "Hoa", "Tươi", "Paris"],
    sizes: ["10ml Chiết", "50ml", "75ml", "100ml"],
    basePrice: 3200000,
    shopeeOffers: []
  }
];
