...
La Vie Est Belle mạnh ở độ đại chúng và dễ dùng. Điểm yếu là không còn quá mới mẻ với người chơi lâu.`,
    ...
    seoTitle: "La Vie Est Belle chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá La Vie Est Belle chính hãng: mùi iris praline ngọt sang, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Nên mua khi mày muốn một signature văn phòng hoặc gặp gỡ lịch sự. Nếu mày cần mùi tối, ngọt hoặc nổi mạnh, nên cân nhắc chai khác.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dior-fahrenheit-main.jpg", source: "amazon", caption: "DIOR Fahrenheit chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai ngọt nổi cho buổi tối. Nếu mày muốn sự thanh, khô hoặc ít ngọt, nên né hướng này.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/dior-jadore-edp-main.jpg", source: "amazon", caption: "DIOR J'adore chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày đang cần một chai buổi tối có sức công phá. Nếu mày thích sự tinh tế, kín đáo hoặc khí hậu dùng chủ yếu là trưa nóng ngoài trời, nên cân nhắc kỹ.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/jpg-le-male-edt-bottle.jpg", source: "studio", caption: "Ảnh sản phẩm JPG Le Male EDT (chai và hộp)" },
      { url: "/images/products/jpg-le-male-edt-main.jpg", source: "studio", caption: "Ảnh chi tiết JPG Le Male EDT" }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
