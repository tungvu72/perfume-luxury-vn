...
Jazz Club hay ở chỗ có mood rất riêng. Điểm yếu là không linh hoạt bằng các chai đa dụng hơn.`,
    ...
    score: { scent: 8.8, uniqueness: 8.4, compliments: 8.5, value: 8, total: 8.4 },
    vibes: [{ label: "Buổi tối", icon: "🌙" }, { label: "Chill", icon: "🥃" }, { label: "Thu đông", icon: "🍂" }],
    longevity: 7,
    sillage: 7,
    ...
    seoTitle: "Jazz Club chính hãng giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Jazz Club chính hãng: mùi rum thuốc lá ấm áp, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026 tại Maison De Son.",
