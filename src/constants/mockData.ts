...
Hẹn hò, tiệc, buổi tối, sự kiện. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất mùa thu đông. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/xerjoff-dama-bianca-main.jpg", source: "amazon", caption: "XERJOFF Dama Bianca chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
...
Dùng hằng ngày — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng rất thoải mái.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/xerjoff-naxos-main.jpg", source: "amazon", caption: "XERJOFF Naxos chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
