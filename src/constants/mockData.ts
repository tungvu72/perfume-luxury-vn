...
Hẹn hò, tối, dịp riêng tư. Xịt 1-2 nhát: cổ hoặc ngực. Đẹp nhất thu đông (15-25°C). Ở Việt Nam dùng tối phòng máy lạnh. Chai cho người đã biết mình thích gì — không phải chai an toàn cho người mới.`,
...
},
  {
    ...
    topNotes: [{"name":"Hương An-đê-hít"},{"name":"Hoa hồng trắng"},{"name":"Hạt tiêu hồng"}],
    middleNotes: [{"name":"Hoa mẫu đơn"},{"name":"Hoa violet"},{"name":"Hoa cam African"}],
    baseNotes: [{"name":"Xạ hương"},{"name":"Hương gỗ"},{"name":"Gỗ đàn hương"}],
...
},
  {
    ...
    topNotes: [{"name":"Hoa lan Nam Phi"},{"name":"Cây anh thảo"},{"name":"Đại hoàng"}],
    middleNotes: [{"name":"Hoa Tulip phấn"}],
    baseNotes: [{"name":"Hương gỗ vàng"},{"name":"Cỏ hương bài"},{"name":"Hương lục"}],
...
},
  {
    ...
    description: "Bản tôn vinh đóa hồng đài các thuần khiết, nhẹ nhàng và nữ tính. Mùi hương ngập tràn sự e ấp và thanh thoát, tựa như đang đứng giữa một thung lũng hoa hồng ướt đẫm sương sớm.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thanh lịch","icon":"👗"},{"label":"Quyến rũ","icon":"💋"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Tinh chất sương"}],
    middleNotes: [{"name":"Hoa hồng Damask"}],
    baseNotes: [{"name":"Gỗ trắng"},{"name":"Xạ hương"}],
...
},
  {
    ...
    description: "Một góc nhìn khác về gỗ đàn hương: thơm mùi kem, nhẹ nhàng, trong trẻo. Chloe Santalum không gai góc mà bao quanh bởi sự ấm áp, mượt mà dịu êm của những đốt gỗ ngậm sữa.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thư giãn","icon":"🧘‍♀️"},{"label":"Trưởng thành","icon":"🧥"}],
    topNotes: [{"name":"Gỗ đàn hương Úc"}],
    middleNotes: [{"name":"Hương sữa"},{"name":"Gỗ trắng"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Vanilla mộc"}],
...
},
  {
    ...
    description: "Biểu tượng của quyền lực và thành công. Creed Aventus là sự phối hợp vĩ đại giữa hương dứa mọng nước ngập tràn sức sống và nền rêu sồi, long diên hương dũng mãnh.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Quyền lực","icon":"👑"},{"label":"Thành công","icon":"🏆"},{"label":"Đẳng cấp","icon":"💎"}],
    topNotes: [{"name":"Quả dứa"},{"name":"Cam Bergamot"},{"name":"Quả lý chua đen"},{"name":"Táo xanh"}],
    middleNotes: [{"name":"Gỗ phong vàng"},{"name":"Hoắc hương"},{"name":"Bạch dương"},{"name":"Hồng Maroc"}],
    baseNotes: [{"name":"Xạ hương"},{"name":"Rêu sồi"},{"name":"Long diên hương"},{"name":"Vani"}],
...
},
  {
    ...
    description: "Nước hoa mang sắc thái tinh khiết được kết tinh từ những nguyên liệu chọn lọc trải dài trên 5 châu lục. Love in White mở ra cánh cổng đầy chất tinh khôi, sang trọng tôn vinh vẻ đẹp trí thức của phái nữ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Trí thức","icon":"📚"},{"label":"Thượng lưu","icon":"🥂"}],
    topNotes: [{"name":"Quả cam từ Tây Ban Nha"}],
    middleNotes: [{"name":"Hoa mộc lan Ý"},{"name":"Thủy tiên Pháp"},{"name":"Hoa hồng Bulgaria"},{"name":"Gạo Tonkin"}],
    baseNotes: [{"name":"Vani nguyên thủy"},{"name":"Long diên hương"},{"name":"Gỗ đàn hương Ấn Độ"}],
...
},
  {
    ...
    description: "Khí trời mát lạnh sắc bén trên những đỉnh núi tuyết sừng sững Thụy Sĩ. Dòng suối lấp lánh chảy qua khu rừng trà xanh và cam quýt, đem lại một cảm giác vô cùng phóng khoáng và sảng khoái.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Mát lạnh","icon":"❄️"},{"label":"Phóng khoáng","icon":"🌬️"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Quả quýt hồng"}],
    middleNotes: [{"name":"Trà xanh"},{"name":"Quả lý chua đen"}],
    baseNotes: [{"name":"Xạ hương"},{"name":"Gỗ đàn hương"},{"name":"Sứ ngọc"},{"name":"Nhựa Galbanum"}],
...
},
  {
    ...
    description: "Hương hoa trắng lấp lánh pha chút uyển chuyển của xạ hương bồng bềnh. Deliah Blanc đại diện cho vẻ đẹp tiểu thư tinh túy, nhẹ nhàng, bay bổng cho bốn mùa.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tiểu thư","icon":"🎀"},{"label":"Mềm mại","icon":"☁️"}],
    topNotes: [{"name":"Hoa nhài"},{"name":"Mộc qua"}],
    middleNotes: [{"name":"Hoa huệ diên vĩ"},{"name":"Vani"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Hổ phách"}],
...
},
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: { spring: 78, summer: 72, fall: 45, winter: 35 },
    dayNight: { day: 75, night: 55 },
    ...
    seoTitle: "Diptyque Do Son EDP chính hãng mua ở đâu? Review 2026",
    metaDescription: "Đánh giá Diptyque Do Son Eau de Parfum chính hãng: hoa huệ Đồ Sơn gợi cảm, độ bám tỏa thực tế và tư vấn mua uy tín 2026 tại Maison De Son.",
    tags: ["Unisex", "Hoa huệ", "Hoài niệm", "Việt Nam"],
    sizes: ["100ml"],
    basePrice: 0,
    shopeeOffers: [],
    isPublished: true
...
},
  {
    ...
    topNotes: [{"name":"Tiêu đen"},{"name":"Gia vị"}],
    middleNotes: [{"name":"Xạ hương tự nhiên"},{"name":"Hoa nghệ tây"}],
    baseNotes: [{"name":"Trầm hương"},{"name":"Gỗ Guaiac"}],
...
},
  {
    ...
    description: "Viên ngọc xanh mang sức mạnh phong thủy đầy năng lượng tích cực từ Ex Nihilo. Hương lê tươi mọng chìm trong gỗ hiện đại Akigalawood và ambrofix tạo nên sự sắc sảo, vương giả bừng sáng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Hiện đại","icon":"🏙️"},{"label":"Vương giả","icon":"💎"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Quả cam"},{"name":"Lê"},{"name":"Gừng"}],
    middleNotes: [{"name":"Ngọc lan tây"},{"name":"Georgywood"}],
    baseNotes: [{"name":"Akigalawood"},{"name":"Xạ hương"},{"name":"Ambrofix"}],
...
},
  {
    ...
    description: "Chuyến lặn sâu vào thăm thẳm đại dương nước Ý. Bản Profondo nhấn mạnh nốt hương nước biển mặn mòi, làm lạnh gắt hơn bằng hoắc hương và hương lục. Một vũ khí giải nhiệt hoàn hảo.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Đại dương","icon":"🌊"},{"label":"Sảng khoái","icon":"🧊"}],
    topNotes: [{"name":"Hương biển"},{"name":"Aquozone"},{"name":"Cam Bergamot xanh"},{"name":"Quýt xanh"}],
    middleNotes: [{"name":"Hương thảo"},{"name":"Cây bách"},{"name":"Hoa oải hương"},{"name":"Nhũ hương"}],
...
},
  {
    ...
    description: "Vũ khí bí mật bùng nổ của mẫu giày gót nhọn lừng danh. Good Girl phô trương nét cá tính mạnh mẽ bằng chocolate đen béo ngậy, đậu tonka ấm ngọt và hoa nhài đài các, mang đến vẻ quyến rũ không thể cưỡng lại.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Quyến rũ","icon":"👠"},{"label":"Tiệc đêm","icon":"✨"}],
    topNotes: [{"name":"Hạnh nhân"},{"name":"Cà phê"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hoa nhài Sambac"},{"name":"Hoa huệ trắng"},{"name":"Hoa cam"},{"name":"Hoa hồng Bulgaria"}],
    baseNotes: [{"name":"Đậu Tonka"},{"name":"Cacao"},{"name":"Vani"},{"name":"Kẹo Praline"},{"name":"Xạ hương"}],
...
},
  {
    ...
    description: "Tuyệt phẩm múa ballet ngọt ngào trên làn da. Gritti TuTu rực rỡ với quả dừa, đào tươi, đan xen cùng xạ hương thanh thoát, tạo ra một áng mây phấn mịn màng tuyệt diệu.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Dễ thương","icon":"🎀"},{"label":"Thơ mộng","icon":"🦢"}],
    topNotes: [{"name":"Dừa tươi"},{"name":"Cam hồng"},{"name":"Lá dâu tằm"},{"name":"Kem vanilla"}],
    middleNotes: [{"name":"Hoa hồng nữ hoàng"},{"name":"Hoa nghệ tây"},{"name":"Quả mâm xôi tây"}],
  ...
  
  {
    ...
    description: "Cẩm tú cầu lộng lẫy và ngọt lịm mùa hè. Flora Gorgeous Gardenia tràn ngập niềm vui từ đường nâu và hoa trắng tỏa nắng, xứng đáng là lọ nước hoa quốc dân cho các thiếu nữ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Ngọt ngào","icon":"🍭"},{"label":"Vui vẻ","icon":"🌸"}],
    topNotes: [{"name":"Hoa lê"},{"name":"Quả mọng Ý"},{"name":"Quả quýt"}],
    middleNotes: [{"name":"Hoa dành dành"},{"name":"Hoa nhài"},{"name":"Frangipani"}],
    baseNotes: [{"name":"Đường nâu"},{"name":"Cây hoắc hương"}],
...
},
  {
    ...
    description: "Chất thơ cổ điển của rừng gỗ Palissandro kết duyên cùng hoa hồng chưng cất mạnh mẽ. Bản Forte đẩy cường độ lưu hương lên rất cao, lan tỏa sự sang trọng thanh lịch.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thanh lịch","icon":"👗"},{"label":"Sang trọng","icon":"💎"}],
    topNotes: [{"name":"Chanh vàng"},{"name":"Rau bina tươi"}],
    middleNotes: [{"name":"Hoa hồng Damask"},{"name":"Gỗ balsa"},{"name":"Hoa oải hương"}],
    baseNotes: [{"name":"Gỗ Palissandro"},{"name":"Đàn hương"},{"name":"Hoắc hương"}],
...
},
  {
    ...
    description: "Mặt trời chói chang chiếu xuống cánh đồng cỏ hương bài và cam đắng. Sự kết đôi quá hoàn hảo giữa Neroli xanh dịu nhẹ và cỏ Vetiver rễ mộc, một mùi hương thanh tịnh tuyệt đối.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thanh tịnh","icon":"🌿"},{"label":"Mát mẻ","icon":"☀️"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Lá sung"},{"name":"Tinh dầu lá chanh"}],
    middleNotes: [{"name":"Hoa cam Neroli"},{"name":"Cỏ Vetiver xanh"}],
    baseNotes: [{"name":"Trái vả"},{"name":"Đâu Tonka"},{"name":"Xạ hương thiên nhiên"}],
...
},
  {
    ...
    description: "Nettare di Sole – 'Mật hoa mặt trời'. Những giọt mật ong sóng sánh tắm đẫm búp hoa mộc lan trắng buốt. Rực rỡ, ngọt ngào vừa phải và mang đậm chất tiên nữ dạo chơi vườn hạ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tráng lệ","icon":"☀️"},{"label":"Gợi cảm","icon":"🍯"}],
    topNotes: [{"name":"Cam Calabria"},{"name":"Hương nước"},{"name":"Hoa cam non"}],
    middleNotes: [{"name":"Mật ong hoàng gia"},{"name":"Hoa mộc lan"},{"name":"Hoa nhài Sambac"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Vanilla đậu"}],
...
},
  {
    ...
    description: "Khoảng trời đầy sao rụng xuống bãi biển thênh thang. Merveilles Bleue mang vị của đá cuội nước mặn, gỗ biển trôi và hoắc hương vô cùng phóng khoáng. Sang trọng nhưng không kiểu cách.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Biển xanh","icon":"🌊"},{"label":"Tinh tế","icon":"💎"}],
    topNotes: [{"name":"Nước biển xanh"},{"name":"Hương sương mặn"}],
    middleNotes: [{"name":"Hoắc hương"},{"name":"Gỗ bãi biển (driftwood)"}],
    baseNotes: [{"name":"Gỗ mun"},{"name":"Cây hoắc hương nhạt"}],
...
},
  {
    ...
    description: "Phiên bản Twilly trưởng thành và cay nồng táo bạo hơn. Hạt tiêu hồng nhảy nhót trên nền hoa hồng tươi thắm và hoắc hương, tạo ra nét cá tính của một quý cô Paris hiện đại độc lập.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Cá tính","icon":"🌶️"},{"label":"Cô gái Pháp","icon":"🇫🇷"}],
    topNotes: [{"name":"Hạt tiêu hồng"}],
    middleNotes: [{"name":"Hoa hồng hoang dã"}],
    baseNotes: [{"name":"Hoắc hương khô"}],
...
},
  {
    ...
    description: "Lọ mứt đào ngon ngọt ngập ngụa Vani rực rỡ. I Want Choo là sự nữ tính năng động, bung tỏa cực tốt, phù hợp cho mọi cuộc hẹn hò mà cô gái nào cũng nên vứt một lọ vào giỏ xách.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Năng động","icon":"💃"},{"label":"Cuốn hút hẹn hò","icon":"💋"}],
    topNotes: [{"name":"Kem dâu"},{"name":"Quả đào núi"}],
    middleNotes: [{"name":"Hoa nhài lửa đỏ"},{"name":"Hoa huệ đồng thau"}],
    baseNotes: [{"name":"Vani"},{"name":"Xạ hương kẹo"}],
...
},
  {
    ...
    description: "Mùi hương 'gái hư' kinh điển của nhà Kilian. Gái ngoan biến chất chưa bao giờ lôi cuốn đến vậy, với sự hòa trộn của mộc tề trắng tuyết, trầm hương gợi tình và hổ phách nhung nhớ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Sang chảnh","icon":"🥂"},{"label":"Bad Girl","icon":"👠"}],
    topNotes: [{"name":"Hoa nhài"},{"name":"Hoa mộc tề"},{"name":"Hoa hồng tháng Năm"}],
    middleNotes: [{"name":"Hoa huệ diên vĩ"},{"name":"Hoa thủy tiên vàng"}],
    baseNotes: [{"name":"Hổ phách"},{"name":"Cây tuyết tùng"},{"name":"Xạ hương thuần"}],
...
},
  {
    ...
    description: "Chạm sát vào da để cảm nhận nhịp đập của sự si mê. Rolling in Love phủ lấp hạnh nhân bùi bùi và hoa diên vĩ mỏng nhẹ, mang sắc đỏ chói chang của tình yêu say đắm cháy bỏng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Lãng mạn","icon":"❤️"},{"label":"Da thịt mịn","icon":"🧸"}],
    topNotes: [{"name":"Sữa hạnh nhân"},{"name":"Hạt dền Ambrette"}],
    middleNotes: [{"name":"Hoa diên vĩ đỏ"},{"name":"Hoa lan Nam Phi"}],
    baseNotes: [{"name":"Đậu Tonka"},{"name":"Vanilla trắng"},{"name":"Hoa huệ hương"},{"name":"Xạ hươn"}],
...
},
  {
    ...
    description: "Trải nghiệm dạo phím đàn piano trong một sân khấu phủ đầy bọt sữa nóng và gỗ hương trắng. Piano Santal mịn màng như nhung, một bản hòa ca thư giãn đến từ nghệ sĩ lừng danh của L'Orchestre.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Hòa ca","icon":"🎹"},{"label":"Thư thái mộc","icon":"🎼"}],
    topNotes: [{"name":"Cam Bergamot mát"},{"name":"Hương sữa bột"}],
    middleNotes: [{"name":"Gỗ đàn hương mượt"},{"name":"Gỗ tuyết tùng xám"}],
    baseNotes: [{"name":"Ambroxan đục"},{"name":"Hoa nhài cashmere"}],
...
},
  {
    ...
    description: "Huyền thoại của lọ mực đen. Cỏ hương bài đen kịt và gỗ trắc hòa vào nhau tựa như một góc rừng tối tăm sau mưa, ma mị, lạnh lùng, phong trần và cực kì nam tính.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Lạnh lùng","icon":"🖤"},{"label":"Ma mị chững","icon":"🎩"}],
    topNotes: [{"name":"Cây bách"}],
    middleNotes: [{"name":"Cỏ hương bài Bourbon"},{"name":"Cỏ hương bài Haiti"}],
    baseNotes: [{"name":"Gỗ cashmere đen"},{"name":"Xạ hương trầm"}],
...
},
  {
    ...
    description: "Tinh thần đường phố NY. Santal 33 quá nổi tiếng với mùi cưa gỗ đàn hương tươi quyện mùi đồ da sắc nét, bám tỏa cực bền như một thói quen gây nghiện mãnh liệt.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Bụi bặm","icon":"🕰️"},{"label":"Chất chơi","icon":"🚬"}],
    topNotes: [{"name":"Bạch đậu khấu"},{"name":"Giáp vân"},{"name":"Violet lá"}],
    middleNotes: [{"name":"Da thuộc cũ"},{"name":"Hoa diên vĩ khô"}],
    baseNotes: [{"name":"Gỗ đàn hương mạnh"},{"name":"Tuyết tùng Virginia"},{"name":"Hổ phách"}],
...
},
  {
    ...
    description: "Mùi hương quả mâm xôi tây và hoa nhài trẻ trung, năng động mang hình dáng chiếc balo sành điệu. Thơm nhẹ nhàng, ngọt dịu và rất dễ dùng cho lối sống thành thị.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Năng động","icon":"🎒"},{"label":"Dễ thương","icon":"🧸"}],
    topNotes: [{"name":"Quả mâm xôi"},{"name":"Quả mơ"}],
    middleNotes: [{"name":"Hoa nhài"},{"name":"Hoa mẫu đơn trắng"},{"name":"Lá Violet"}],
    baseNotes: [{"name":"Vani"},{"name":"Gỗ đàn hương"},{"name":"Rêu hương"}],
...
},
  {
    ...
    description: "Ly nước chanh đá mát lạnh, tinh khiết. Ánh sáng của cam Bergamot, chanh vàng và hoa huệ thung lũng hòa quyện đem lại cảm giác tươm tất, trong lành như sương mai.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Trong trẻo","icon":"💧"},{"label":"Sạch sẽ","icon":"✨"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Chanh vàng"}],
    middleNotes: [{"name":"Hoa linh lan"},{"name":"Hoa cam ngọt"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Gỗ sáng"}],
...
},
  {
    ...
    description: "Giỏ trái cây mùa hè rực rỡ dưới nắng vàng Địa Trung Hải. Sicily kết hợp mổ bưởi, cam quýt, dứa, táo, đào một cách cuồng nhiệt và tràn trề nhựa sống.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Rực rỡ","icon":"🌞"},{"label":"Trái cây","icon":"🍍"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Quả bưởi"},{"name":"Quả quýt"},{"name":"Dứa"},{"name":"Táo"}],
    middleNotes: [{"name":"Hoa nhài"},{"name":"Ngọc lan tây"},{"name":"Hoa dâm bụt"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Gỗ tuyết tùng"}],
...
},
  {
    ...
    description: "Một trong những trụ cột làm nên tên tuổi Mancera. Cedrat Boise là sự tổng hòa của cam chanh rực rỡ, gỗ tuyết tùng ấm áp và da thuộc cá tính. Rất bám và bay bổng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thành thị","icon":"🏙️"},{"label":"Nam tính","icon":"😎"}],
    topNotes: [{"name":"Chanh vàng"},{"name":"Nho đen"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hương trái cây"},{"name":"Lá hoắc hương"},{"name":"Nhài nước"}],
    baseNotes: [{"name":"Gỗ tuyết tùng"},{"name":"Da thuộc"},{"name":"Rêu sồi"}],
...
},
  {
    ...
    description: "Huyền thoại đương đại khó có thể bị soán ngôi. Baccarat Rouge 540 mang thứ đường nung chảy kỳ diệu pha với nhựa linh sam và nhụy hoa nghệ tây đẳng cấp, tạo ra đám mây hương tỏa cực mạnh.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Huyền thoại","icon":"👑"},{"label":"Sang trọng","icon":"💎"}],
    topNotes: [{"name":"Nhụy hoa nghệ tây"},{"name":"Hoa nhài"}],
    middleNotes: [{"name":"Gỗ hổ phách"},{"name":"Long diên hương"}],
    baseNotes: [{"name":"Nhựa linh sam"},{"name":"Gỗ tuyết tùng"}],
...
},
  {
    ...
    description: "Kính ngữ dành tặng những cánh hồng kiêu sa. À la rose chứa đựng tinh hoa của hơn 400 đóa hồng tươi nhất nước Pháp, mang tới một cảm giác vô cùng thanh tao, thơ mộng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Nữ tính","icon":"👗"},{"label":"Dịu dàng","icon":"🌸"}],
    topNotes: [{"name":"Cam ngọt"},{"name":"Chanh vàng"}],
    middleNotes: [{"name":"Hồng Damascus"},{"name":"Hồng Centifolia"},{"name":"Hoa Violet"}],
    baseNotes: [{"name":"Gỗ tuyết tùng"},{"name":"Xạ hương"}],
...
},
  {
    ...
    description: "Bản nâng cấp 2025 với lượng tinh chất cô đặc nhất. Miss Dior Essence nhấn mạnh vào những nốt hoa quý ngập sương mai và gỗ ấm nồng nàng, lưu hương dai dẳng hoàn hảo.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Đẳng cấp","icon":"🌟"},{"label":"Tinh hoa","icon":"💎"}],
    topNotes: [{"name":"Quả mận lấp lánh"},{"name":"Ớt hồng"}],
    middleNotes: [{"name":"Hồng Grasse"},{"name":"Hoa lài hoang"}],
    baseNotes: [{"name":"Vani nguyên chất"},{"name":"Gỗ đàn hương"}],
...
},
  {
    ...
    description: "Khoảnh khắc hồi sinh của dòng họ Miss Dior. Chuyên gia Francis Kurkdjian tạo ra đóa hoa ngọt ngào đầy tính hiện đại, chìm trong vani và sự rực rỡ tươi sáng của trái cây.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Hiện đại","icon":"💅"},{"label":"Trẻ trung","icon":"🐣"}],
    topNotes: [{"name":"Cam quýt Ý"},{"name":"Đào ngâm"}],
    middleNotes: [{"name":"Dâu rừng"},{"name":"Hồng quyến rũ"}],
    baseNotes: [{"name":"Gỗ hổ phách"},{"name":"Hoắc hương"}],
...
},
  {
    ...
    description: "Chú gấu đen ngỗ nghịch mang bên trong bó hoa hồng gai góc cay nồng. Nhựa cây và tiêu đen bám phủ lên nét quyến rũ chết người, Toy Boy là kẻ chơi bời biết cách ăn mặc.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Chơi bời","icon":"🎩"},{"label":"Hấp dẫn","icon":"🫦"}],
    topNotes: [{"name":"Tiêu hồng"},{"name":"Lê"},{"name":"Mùi nhục đậu khấu"},{"name":"Elemi"}],
    middleNotes: [{"name":"Hoa hồng đen"},{"name":"Mộc lan"},{"name":"Đinh hương"}],
    baseNotes: [{"name":"Hoắc hương"},{"name":"Gia vị"},{"name":"Xạ hương"}],
...
},
  {
    ...
    topNotes: [{"name":"Tiêu trắng"},{"name":"Clove"}],
    middleNotes: [{"name":"Xạ hương trắng nguyên bản"},{"name":"Hoa trắng"}],
    baseNotes: [{"name":"Gỗ hổ phách"},{"name":"Sữa nhạt"}],
...
},
  {
    ...
    description: "Hành trình mở mang thế giới của cô gái tự do. My Way hội tụ hoa cam trắng muốt và hoa huệ Ấn Độ, mang vị ngọt chua vui vẻ, tạo sự hứng khởi suốt ngày dài.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tự do","icon":"🌍"},{"label":"Vui vẻ","icon":"😄"}],
    topNotes: [{"name":"Hoa cam"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hoa huệ Tuberose"},{"name":"Hoa nhài Ấn"}],
    baseNotes: [{"name":"Vani Madagascar"},{"name":"Xạ hương trắng"},{"name":"Gỗ tuyết tùng"}],
...
},
  {
    ...
    description: "Lăng kính pha lê trong suốt, sạch sẽ và nữ tính đến tận cùng. Xạ hương được làm nhẹ tâng, quyện cùng đóa hoa trắng lấp lánh như giọt sương buổi bình minh.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tinh khiết","icon":"💎"},{"label":"Mỏng manh","icon":"🧊"}],
    topNotes: [{"name":"Hoa lan Nam Phi"},{"name":"Cam Bergamot"},{"name":"Hoa cam"}],
    middleNotes: [{"name":"Hoa hồng"},{"name":"Xạ hương nhạt"},{"name":"Hoa trắng"}],
    baseNotes: [{"name":"Gỗ tuyết tùng"},{"name":"Cashmeran"}],
...
},
  {
    ...
    description: "Đám mây phấn hồng mềm mại, quyến rũ chết người. Narciso Poudrée che phủ làn da bằng lớp xạ hương phấn mịn hòa với cỏ vetiver, cực kì gợi tình và đẫy đà.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Phấn hồng","icon":"🪞"},{"label":"Gợi cảm","icon":"💋"}],
    topNotes: [{"name":"Hoa nhài đỏ"},{"name":"Hoa hồng Bulgary"},{"name":"Hoa cam"}],
    middleNotes: [{"name":"Xạ hương phấn"}],
    baseNotes: [{"name":"Coumarin"},{"name":"Tuyết tùng đỏ"},{"name":"Hoắc hương"}],
...
},
  {
    ...
    description: "Ánh nắng mật ong trên da thịt trần. Ambrée là ly cocktail hoa đại mượt mà, điểm thêm hổ phách và vani, cực kì nịnh mũi và tỏa nắng trong những ngày dạo biển.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tỏa nắng","icon":"☀️"},{"label":"Mật ngọt","icon":"🍯"}],
    topNotes: [{"name":"Hoa đại Frangipani"},{"name":"Hoa ngọc lan tây"}],
    middleNotes: [{"name":"Xạ hương mặt trời"},{"name":"Hổ phách"}],
    baseNotes: [{"name":"Vani"},{"name":"Gỗ tuyết tùng"}],
...
},
  {
    ...
    description: "Khẳng định lại uy quyền nữ giới trong năm 2025 bằng hàm lượng xạ hương cực khủng. Lẳng lơ, cuốn hút và đánh gục đối phương ngay từ lần chạm đầu tiên.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Thống trị","icon":"🔥"},{"label":"Thu hút","icon":"🧲"}],
    topNotes: [{"name":"Hoa mộc tề"},{"name":"Hoa hồng đậm"}],
    middleNotes: [{"name":"Xạ hương Ai Cập nguyên chất"}],
    baseNotes: [{"name":"Gỗ hổ phách"},{"name":"Hoắc hương đen"}],
...
},
  {
    ...
    description: "Trần trụi, tinh tuyền và mộc mạc nhất. Musc Nude mang lại cảm giác mơn trớn, da kề da vô cùng chân thật và ngây thơ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Nhẹ nhàng","icon":"🕊️"},{"label":"Chân thành","icon":"🤍"}],
    topNotes: [{"name":"Hoa nhài kem"},{"name":"Cam đào trắng"}],
    middleNotes: [{"name":"Xạ hương thực vật"},{"name":"Hoa hồng Đan Mạch"}],
    baseNotes: [{"name":"Vani"},{"name":"Gỗ trắng"}],
...
},
  {
    ...
    description: "Một bản giao hưởng hoa hiện đại từ Narciso thay vì xạ hương thuần túy. Hồng Centifolia kiêu chảnh, trộn lẫn lá Geranium tạo sự năng động chưa từng thấy.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Năng động","icon":"🏃‍♀️"},{"label":"Hoa xuân","icon":"🌸"}],
    topNotes: [{"name":"Lá phong lữ"},{"name":"Quả quýt"}],
    middleNotes: [{"name":"Hoa hồng Centifolia"},{"name":"Hoa xương rồng"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Gỗ đàn hương"}],
...
},
  {
    ...
    description: "Chai nước hoa quốc dân màu hồng nhạt. Sự hoàn hảo tuyệt đối của xạ hương và hoa hồng, đem lại khí chất nữ tính, chững chạc và cực kì có uy tín trong giới đi làm hẹn hò.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Quốc dân","icon":"🥇"},{"label":"Uy tín","icon":"💼"}],
    topNotes: [{"name":"Hoa hồng nương"},{"name":"Quả đào"}],
    middleNotes: [{"name":"Xạ hương Ai Cập"},{"name":"Nhựa thông"}],
    baseNotes: [{"name":"Hoắc hương"},{"name":"Gỗ đàn hương"}],
...
},
  {
    ...
    topNotes: [{"name":"Chanh Ý"},{"name":"Cam Bergamot"},{"name":"Gừng"}],
    middleNotes: [{"name":"Nhài trắng"},{"name":"Hoa oải hương"}],
    baseNotes: [{"name":"Xạ hương xạ"},{"name":"Cỏ Vetiver"}],
...
},
  {
    ...
    topNotes: [{"name":"Cam Mandarin"},{"name":"Cây xô thơm"}],
    middleNotes: [{"name":"Caramel cháy"},{"name":"Đậu Tonka"}],
    baseNotes: [{"name":"Cỏ Vetiver"},{"name":"Hoắc hương đen"}],
...
},
  {
    ...
    description: "Tinh thần Ả Rập bứt phá. Mùi trầm hương quyện khói và gia vị phương đông, mang uy quyền lãnh chúa, cay nồng và cực kì bền bỉ trước mọi điều kiện thời tiết.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Uy quyền","icon":"🦅"},{"label":"Cổ điển Ả Rập","icon":"🕌"}],
    topNotes: [{"name":"Nghệ tây"},{"name":"Nhục đậu khấu"}],
    middleNotes: [{"name":"Trầm hương (Oud)"},{"name":"Hoa hoắc hương"}],
    baseNotes: [{"name":"Da thuộc"},{"name":"Xạ hương đen"},{"name":"Hoắc hương"}],
...
},
  {
    ...
    description: "Sức hút xác thịt bùng cháy ngay phút đầu tiên. Pure XS là sự kết hợp của nhựa thơm Myrrh và vani ngọt, khỏa lấp bởi vẻ nam tính phóng túng gợi dục.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Phóng túng","icon":"🔥"},{"label":"Trap boy","icon":"😎"}],
    topNotes: [{"name":"Gừng trắng"},{"name":"Cây bách xù"}],
    middleNotes: [{"name":"Vani ngọt"},{"name":"Quế cờ"},{"name":"Da lộn"}],
    baseNotes: [{"name":"Nhựa Myrrh"},{"name":"Đường tuyết"},{"name":"Tuyết tùng"}],
...
},
  {
    ...
    description: "Sự quý tộc lấp lánh của hoàng gia Pháp. Hương mật đào ngọt lịm chìm trong hoa hồng cao ngạo, tạo sự sang chảnh thượng lưu cho những quý cô quyền lực.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Quý tộc","icon":"👑"},{"label":"Kiêu ngạo","icon":"👸"}],
    topNotes: [{"name":"Cam Bergamot"},{"name":"Lá ngò"},{"name":"Mật đào"}],
    middleNotes: [{"name":"Hồng thổ"},{"name":"Hoa ngọc lan"}],
    baseNotes: [{"name":"Vani Bourbon"},{"name":"Xạ hương"},{"name":"Đàn hương trắng"}],
...
},
  {
    ...
    description: "Đóa hoa trắng mướt đắt giá, sạch sẽ và thanh tao tuyệt đối. Valaya là hơi thở của sự thanh tao, ngửi như chiếc váy voan nhẹ, mỏng nhưng lưu hương mạnh mẽ dai dẳng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Tinh hoa","icon":"🕊️"},{"label":"Bám lâu","icon":"🛡️"}],
    topNotes: [{"name":"Mandarin"},{"name":"Đào trắng"}],
    middleNotes: [{"name":"Hoa cam"},{"name":"Hoa mộc lan"},{"name":"Xạ hương gỗ"}],
    baseNotes: [{"name":"Ambroxan"},{"name":"Gỗ xạ hương"}],
...
},
  {
    ...
    description: "Tinh chất độc quyền cô đặc hơn. Kéo dài sự lộng lẫy và vương giả, các note xạ hương và ambroxan được làm đậm đặc, mượt mà đánh gục trái tim lạnh lùng nhất.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Độc bản","icon":"🏆"},{"label":"Hoàng kim","icon":"💳"}],
    topNotes: [{"name":"Cam tươi"},{"name":"Lựu mọng"}],
    middleNotes: [{"name":"Cánh hoa hồng Pháp"},{"name":"Hoa huệ trắng"}],
    baseNotes: [{"name":"Hổ phách đậm"},{"name":"Gỗ trắng"},{"name":"Ambroxan lạch cạch"}],
...
},
  {
    ...
    description: "Đóa cam chanh thượng lưu nhất hành tinh từ tay phù thủy Roja Dove. Sự chuyển mình xuất sắc từ bưởi cay xé sang gỗ rêu phong ấm nhẹ, toát lên sự đẳng cấp giàu sang.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Triệu phú","icon":"💰"},{"label":"Chuyên nghiệp","icon":"👔"}],
    topNotes: [{"name":"Bưởi chùm"},{"name":"Chanh đào"},{"name":"Lá bạc hà"}],
    middleNotes: [{"name":"Gừng cay"},{"name":"Tiêu trắng"}],
    baseNotes: [{"name":"Long diên hương"},{"name":"Rêu sồi tươi"},{"name":"Xạ hương"}],
...
},
  {
    ...
    description: "Đêm đông giá rét ngồi cạnh chiếc lò sưởi bập bùng, cắn một viên hạt dẻ nướng ngào đường. Mùi hương sưởi ấm tâm hồn, khói ngọt cực kỳ lãng mạn lôi cuốn.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Lò sưởi","icon":"🔥"},{"label":"Giáng sinh","icon":"🎄"}],
    topNotes: [{"name":"Tiêu hồng"},{"name":"Hoa cam"},{"name":"Đinh hương"}],
    middleNotes: [{"name":"Hạt dẻ lùi tro"},{"name":"Gỗ Guaiac đỏ"},{"name":"Quả bách xù"}],
    baseNotes: [{"name":"Vani nướng"},{"name":"Nhựa Peru"},{"name":"Cashmeran"}],
...
},
  {
    ...
    description: "Buổi sáng chủ nhật cuộn tròn trong chiếc chăn bông trắng muốt vừa giặt xong thơm phức. Hương hoa linh lan và An-đê-hít xé dọc sảng khoái và thư thái vô bờ.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Trong vắt","icon":"☁️"},{"label":"Sáng cuối tuần","icon":"☕"}],
    topNotes: [{"name":"Hương An-đê-hít"},{"name":"Trái lê non"},{"name":"Linh lan"}],
    middleNotes: [{"name":"Hoa Diên Diên"},{"name":"Hoa hồng nụ"},{"name":"Hoa cam non"}],
    baseNotes: [{"name":"Xạ hương trắng bong"},{"name":"Hoắc hương trắng"},{"name":"Cây vông vang"}],
...
},
  {
    ...
    description: "Tách trà đen ngâm quả vả rực rỡ và đượm vị mộc mạc. Thé Noir 29 mang nét trầm mặc, thanh lịch có chiều sâu, gây nghiện ngấm ngầm càng ngửi càng ghiền.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Trầm tĩnh","icon":"🍵"},{"label":"Nội tâm","icon":"🍂"}],
    topNotes: [{"name":"Quả sung ngâm"},{"name":"Lá trà xanh"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Gỗ tuyết tùng xám"},{"name":"Rễ cỏ hương bài"},{"name":"Hoa hồng trà"}],
    baseNotes: [{"name":"Cỏ hoắc hương"},{"name":"Xạ hương tuyết"},{"name":"Phấn hoa"}],
...
},
  {
    ...
    description: "Cỗ máy tỏa hương mạnh bậc nhất hiện tại. No4 mang âm hưởng của BR540 nhưng bớt ngọt, nhấn mạnh vỏ chanh và Ambroxan để càn quét mọi không gian xung quanh.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Canh gác","icon":"🚨"},{"label":"Quái vật","icon":"🦖"}],
    topNotes: [{"name":"Vỏ chanh đắng"},{"name":"Vỏ đào nhám"}],
    middleNotes: [{"name":"Gia vị cay mát"}],
    baseNotes: [{"name":"Ambroxan siêu bám"},{"name":"Gỗ trắng"},{"name":"Xạ hương dai"}],
...
},
  {
    ...
    description: "Quyền lực, tăm tối, gợi dục bậc nhất mọi thời đại. Phong lan đen và nấm truffle của Tom Ford nhấn chiềm khứu giác vào sự hoang dại xa xỉ không có điểm dừng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Sex-appeal","icon":"🫦"},{"label":"Áp đảo","icon":"👑"}],
    topNotes: [{"name":"Nấm Truffle đen"},{"name":"Ylang-Ylang lẳng lơ"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Phong lan đen"},{"name":"Trái cây đỏ đen"},{"name":"Hoa sen gai"}],
    baseNotes: [{"name":"Cacao đậm"},{"name":"Hoắc hương"},{"name":"Hương nhang trầm"},{"name":"Sôcôla Mexico"}],
...
},
  {
    ...
    description: "Viên pha lê hồng trong vắt huyền thoại. Lựa chọn bất bại cho sự tươi mát, nữ tính, an toàn ngửi là ưng cái mũi với quả Yuzu thanh chua và mẫu đơn đỏ thắm.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Quốc dân","icon":"🥇"},{"label":"Bánh bèo","icon":"🎀"}],
    topNotes: [{"name":"Quả Yuzu chát"},{"name":"Quả lựu đỏ"},{"name":"Hương băng mát"}],
    middleNotes: [{"name":"Hoa mẫu đơn"},{"name":"Hoa sen trắng"},{"name":"Hoa mộc lan"}],
    baseNotes: [{"name":"Xạ hương đào"},{"name":"Cây gụ"},{"name":"Hổ phách"}],
...
},
  {
    ...
    description: "Khoảng nạp điện năng lượng vô tận của mùa hè. Chanh vàng Ý xé toạc định kiến ngọt khé của phiên bản cũ, đây là Eros phiên bản rực sáng chói chang cho dân vận động.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Năng lượng","icon":"⚡"},{"label":"Gym","icon":"🏋️‍♂️"}],
    topNotes: [{"name":"Chanh Calabrian"},{"name":"Cam máu đỏ"},{"name":"Bưởi"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hồng tiêu xé"},{"name":"Nhựa cây trắng"},{"name":"Hổ phách"}],
    baseNotes: [{"name":"Cây sồi đen"},{"name":"Xạ hương xạ"},{"name":"Cỏ hoắc hương"}],
...
},
  {
    ...
    description: "Ngọn lửa nồng thắm đam mê. Thiết kế đỏ rực cùng với nốt quýt nheo và tiêu đen tạo sinh khí tươi mới hơn rất nhiều và cực kì lôi kéo sự chú ý vào mùa thu đông.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Lửa tình","icon":"❤️‍🔥"},{"label":"Nam thần","icon":"🦸‍♂️"}],
    topNotes: [{"name":"Quả quýt cam"},{"name":"Chanh vàng"},{"name":"Tiêu Madagascar"}],
    middleNotes: [{"name":"Hồng tiêu"},{"name":"Cây phong lữ"},{"name":"Hoa hồng gai"}],
    baseNotes: [{"name":"Vani ngọt"},{"name":"Đậu Tonka"},{"name":"Gỗ đàn hương"},{"name":"Gỗ tuyết tùng"}],
...
},
  {
    ...
    description: "Chai nước hoa mùa hè bất tử cho nam giới. Versace Pour Homme tinh tươm, sạch sẽ, thơm mùi cơ thể vừa tắm gội xong pha với múi chanh xanh căng bóng.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Sạch sẽ nam tính","icon":"🚿"},{"label":"Cơ động","icon":"🏃‍♂️"}],
    topNotes: [{"name":"Chanh vàng tươi"},{"name":"Hoa tuyết điểm"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hoa dạ lan"},{"name":"Gỗ tùng tuyết"},{"name":"Xô thơm"}],
    baseNotes: [{"name":"Xạ hương trắng"},{"name":"Đậu Tonka"},{"name":"Hổ phách"}],
...
},
  {
    ...
    description: "Hào quang vương giả của giới thượng lưu Ý. Mefisto giống hệt Silver Mountain Water nhưng được nâng lên một tầm cao xa xỉ hoàn toàn mới, sắc sảo trơn tru và nịnh mũi xuất thần.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Hoàng gia","icon":"🏰"},{"label":"Xuất chúng","icon":"🪞"}],
    topNotes: [{"name":"Bưởi Ý"},{"name":"Chanh Amalfi"},{"name":"Cam Calabria"}],
    middleNotes: [{"name":"Hoa Lavender thảo mộc"},{"name":"Hoa hồng sắc"},{"name":"Iris phủ phấn"}],
    baseNotes: [{"name":"Gỗ đàn hương"},{"name":"Cỏ tuyết"},{"name":"Hổ phách"}],
...
},
  {
    ...
    description: "Cú giao bóng Tennis mát mẻ xanh rờn của Torino 21. Lá bạc hà và húng quế mát rười rượi, lưu tâm bám dai nhất trong những dòng nước hoa trà xanh mùa hè cao cấp.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Sân Tennis","icon":"🎾"},{"label":"Giải nhiệt","icon":"🧊"}],
    topNotes: [{"name":"Bạc hà lanh"},{"name":"Húng quế ngát"},{"name":"Chanh thơm"}],
    middleNotes: [{"name":"Lá cassis"},{"name":"Hoa nhài trắng"},{"name":"Hoa oải hương"}],
    baseNotes: [{"name":"Xạ hương thực vật sâu"}],
...
},
  {
    ...
    description: "Đập tan định kiến với viên kim cương đen kim tuyến lộng lẫy 2025. Vẫn là DNA ly cà phê Vani siêu gây nghiện nhưng bừng lên sự hoa lệ của một buổi party thâu đêm.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Nữ hoàng tiệc","icon":"🎇"},{"label":"Hút hồn","icon":"💃"}],
    topNotes: [{"name":"Lá xô chua"},{"name":"Hạt dẻ xé"},{"name":"Pink Pepper"}],
    middleNotes: [{"name":"Hoa cam lấp lánh"},{"name":"Hoa lài mờ"},{"name":"Cà phê ủ"}],
    baseNotes: [{"name":"Vani ngậy đen"},{"name":"Gỗ Cashmere tuyết"},{"name":"Xạ hương"}],
...
},
  {
    ...
    description: "Sự tuyên ngôn giải phóng phụ nữ của YSL. Libre Intense cực kỳ ngạo nghễ, độc lập với hoa cam đậm đặc hơn, sắc ấm của Vanila và rễ cỏ hoắc hương.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Boss Queen","icon":"👑"},{"label":"Chững chạc","icon":"🍷"}],
    topNotes: [{"name":"Hoa oải hương mềm"},{"name":"Dầu quýt"},{"name":"Cam Bergamot"}],
    middleNotes: [{"name":"Hoa cam Ma Rốc"},{"name":"Hoa nhài rực"},{"name":"Phong lan dại"}],
    baseNotes: [{"name":"Vani đen nhạy"},{"name":"Long diên hương nguyên thủy"},{"name":"Đậu Tonka"}],
...
},
  {
    ...
    description: "Nam vương đắt khách số một hiện tại. Mùi hương sắc nhọn của táo xanh và cây xô thơm mượt mà bám da suốt 12 tiếng liên tục, cực kì đa dụng và nịnh mũi.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Boy phố","icon":"🎧"},{"label":"Trẻ trung nịnh túi","icon":"🤟"}],
    topNotes: [{"name":"Táo xanh chín"},{"name":"Lá gừng cay"},{"name":"Cam Bergamot tươi"}],
    middleNotes: [{"name":"Vỏ thảo mộc non"},{"name":"Hoa phong lữ"},{"name":"Cây bách xù"}],
    baseNotes: [{"name":"Long diên hương xốp"},{"name":"Nam hương tuyết tùng"},{"name":"Trầm rêu"}],
...
},
  {
    ...
    topNotes: [{"name":"Cam Mandarin nhỏ"},{"name":"Thảo quả non"}],
    middleNotes: [{"name":"Hương trà xanh xao"},{"name":"Hương trà đen khói"},{"name":"Nhài nước"}],
    baseNotes: [{"name":"Hoắc hương rễ"},{"name":"Cỏ tuyết tùng"},{"name":"Vòi lai"}],
...
},
  {
    ...
    description: "Bản đối trọng nữ tính quyền lực của ông vua Aventus. Quả đào mọng sương, xạ hương êm dịu hòa cùng hạt tiêu hồng cay nồng tạo ra phong thái độc tôn của bà vương.",
    verdict: "Hương thơm xuất sắc, chuẩn bị cập nhật bài phân tích...",
    verdictShort: "Đang cập nhật",
    score: { scent: Math.floor(Math.random()*2)+8, uniqueness: 8, compliments: 8, value: 8, total: 8.5 },
    vibes: [{"label":"Nữ vương","icon":"👸"},{"label":"Luxury","icon":"🥂"}],
    topNotes: [{"name":"Quả lê xốp"},{"name":"Quả chanh đào"},{"name":"Lựu nứt"},{"name":"Cây hoắc hương nhạt"}],
    middleNotes: [{"name":"Hồng Thổ Nhĩ Kỳ"},{"name":"Trầm mộc"},{"name":"Quả mận gai"}],
    baseNotes: [{"name":"Xạ hương đen"},{"name":"Hoa sơn mộc"},{"name":"Ilang"}],
