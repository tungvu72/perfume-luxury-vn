...
Mùa đông, dịp đặc biệt, buổi tối, sự kiện VIP. Xịt 1 nhát DUY NHẤT — tỏa cực mạnh. Đẹp nhất khi trời lạnh. Ở Việt Nam chỉ dùng tối mùa lạnh hoặc phòng máy lạnh cực mạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9.6,"uniqueness":9.5,"compliments":9,"value":8,"total":9},
    topNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
      {"name": "Gỗ hồng mộc Palisander (Rosewood)"}
    ],
    middleNotes: [
      {"name": "Hoa linh lan (Lily)"},
      {"name": "Hoa Hồng lả"},
      {"name": "Táo tuyết"}
    ],
    baseNotes: [
      {"name": "Gỗ Trầm hương sang (Oud)"},
...
Hẹn hò, tiệc, buổi tối, sự kiện. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất mùa thu đông. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Quất hoàng kim (Kumquat)"},
      {"name": "Chanh mộc"}
    ],
    middleNotes: [
      {"name": "Hoa Violet (Hoa tử罗兰)"},
      {"name": "Hoa Diên vĩ (Iris)"},
      {"name": "Linh lan trắng"}
    ],
    baseNotes: [
      {"name": "Vanilla nguyên xốp (Vanilla)"},
      {"name": "Mạch nha quyện (Malt)"},
...
Cuối tuần thư giãn, đi biển, dạo hoàng hôn, hoặc khi muốn mùi hương mà không ai hỏi "xịt mùi gì" mà hỏi "cảm giác gì thế?". Xịt 3 nhát: cổ và cổ tay. Dùng quanh năm — cát ấm vào đông, biển tươi vào hè. Chai dành cho dreamer.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Nước biển (Water Notes)"},
      {"name": "Cam Bergamot"},
      {"name": "Bưởi bóc (Grapefruit)"}
    ],
    middleNotes: [
      {"name": "Ambroxan rực"},
...
Buổi tối, ăn tối, hoặc cuối tuần thư giãn. Xịt 2-3 nhát: cổ và cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai để tự thưởng, không phải để khoe.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 9,
    seasons: {"spring":30,"summer":35,"fall":20,"winter":15},
    ...
    topNotes: [
      {"name": "Cam ruột đỏ (Orange)"},
      {"name": "Chanh vàng Sicilian"},
      {"name": "Cam Bergamot Calabrian"}
    ],
    middleNotes: [
      {"name": "Trái cây sấy khô lên men (Fruity Notes)"}
    ],
    baseNotes: [
      {"name": "Xạ hương động vật (Musk)"},
      {"name": "Vani đanh đỏ (Vanilla)"},
      {"name": "Hổ phách"}
    ],
    accords: [
...
Mùa thu đông, buổi tối, hẹn hò, tiệc. Xịt 1-2 nhát — tỏa cực mạnh. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông Hà Nội.`,
  ...
  },
  {
    ...
    subName: "EDP",
    perfumer: "Carlos Benaim, Jean-Christophe Herault",
    year: 2015,
    gender: "nam",
    longevity: 8,
    sillage: 8,
    ...
    score: {"scent":9.5,"uniqueness":9,"compliments":9.8,"value":8.5,"total":9.2},
    topNotes: [
      {"name": "Thì là trắng (Cumin)"},
      {"name": "Cánh hoa nghệ tây (Saffron)"}
    ],
    middleNotes: [
      {"name": "Quế già (Cinnamon)"},
      {"name": "Tiêu đen vụn"}
    ],
    baseNotes: [
      {"name": "Vani béo xốp (Vanilla)"},
      {"name": "Thuốc lá non (Tobacco)"},
      {"name": "Rượu Bourbon"}
    ],
    accords: [
...
Văn phòng, ban ngày, mùa hè. Xịt 3 nhát: cổ và cổ tay. Đẹp nhất xuân hè Việt Nam (25-32°C). Chai Libre cho người sợ mùi nặng.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":20,"summer":15,"fall":30,"winter":35},
    dayNight: {"day":35,"night":65},
    ...
    score: {"scent":8.5,"uniqueness":7.5,"compliments":9.5,"value":9,"total":8.6},
    topNotes: [
      {"name": "Lá Bạc hà the (Mint)"},
      {"name": "Táo xanh (Apple)"},
      {"name": "Chanh vàng (Lemon)"}
    ],
    middleNotes: [
      {"name": "Đậu Tonka xốp (Tonka Bean)"},
      {"name": "Ambroxan"},
      {"name": "Hoa Phong lữ"}
    ],
    baseNotes: [
      {"name": "Vani béo (Vanilla)"},
      {"name": "Gỗ Tuyết tùng"},
      {"name": "Cỏ hương bài"}
    ],
    accords: [
...
Mọi lúc — đi làm, đi học, đi chơi, đi biển. Xịt 4-5 nhát vì EDT nhẹ. Sài Gòn quanh năm. Hà Nội tháng 3-11. Chai MỌI PHỤ NỮ nên có 1.`,
...
},
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":30,"summer":50,"fall":15,"winter":5},
    dayNight: {"day":75,"night":25},
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":8.5,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Cam đỏ (Blood Orange)"},
      {"name": "Bưởi (Grapefruit)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hạt tiêu hồng"},
    ...
    baseNotes: [
      {"name": "Xạ hương sạch (Musk)"},
      {"name": "Gỗ băm (Woody)"},
      {"name": "Hoắc hương trắng"}
    ],
    accords: [
...
},
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9,"value":9,"total":8.8},
    topNotes: [
      {"name": "Cam đắng Chinotto"},
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Tiêu đen (Pepper)"}
    ],
    middleNotes: [
...
Mùa thu đông, buổi tối, hẹn hò, đi chơi. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
...
},
  {
    ...
    score: {"scent":9.2,"uniqueness":7.5,"compliments":9,"value":9.5,"total":8.8},
    topNotes: [
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Cam Bergamot"},
      {"name": "Hoa Cam (Neroli)"}
    ...
    middleNotes: [
      {"name": "Hoa Lan dạ hương (Hyacinth)"},
      {"name": "Cây xô thơm"},
      {"name": "Lan tỏa Gỗ Tuyết tùng"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka (Tonka Bean)"},
      {"name": "Xạ hương sạch (Musk)"},
...
},
  {
    ...
    score: {"scent":9.2,"uniqueness":8.5,"compliments":9,"value":8,"total":8.7},
    topNotes: [
      {"name": "Bưởi tép mọng (Grapefruit)"},
      {"name": "Chanh vàng rực (Lemon)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
      {"name": "Hoa Diên vĩ (Iris)"},
      {"name": "Hoa Hồng quyến rũ"}
    ],
    baseNotes: [
      {"name": "Xạ hương xốp"},
      {"name": "Gỗ tuyết tùng"},
