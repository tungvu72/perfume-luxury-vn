...
Hoàn hảo cho môi trường văn phòng, đi làm hằng ngày, dạo phố cuối tuần, hoặc khi không biết xịt gì. Dùng được quanh năm, tuyệt nhất là mùa xuân và thu mát mẻ.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":25,"summer":5,"fall":35,"winter":35},
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":8,"value":8.5,"total":8.5},
    topNotes: [
      {"name": "Hoa Tóc tiên (Hyacinth)"},
      {"name": "Quả Cam (Orange)"}
    ],
    middleNotes: [
...
Ban ngày, đi dạo, café, du lịch, hoặc khi muốn cảm giác "cuộc sống ngọt ngào" đúng nghĩa. Xịt 3 nhát: cổ và cổ tay. Xuân hè đẹp nhất. Sài Gòn dùng quanh năm. Hà Nội tháng 3-10. Nếu tìm được chai, giữ lại — vintage value.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":20,"summer":10,"fall":35,"winter":35},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":8,"uniqueness":8,"compliments":8.5,"value":9,"total":8.3},
    topNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
      {"name": "Quả Chanh (Lemon)"}
    ],
    middleNotes: [
      {"name": "Cây thông (Pine Tree)"},
      {"name": "Cây Bách (Fir)"}
    ],
    baseNotes: [
      {"name": "Rêu sồi (Oakmoss)"},
...
Đi làm, gặp khách, họp hành, dùng hằng ngày. Xịt 2-3 nhát: cổ, ngực, cổ tay. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng thoải mái — rất dễ chịu khi nóng.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":9,"compliments":8.2,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Quả Cam (Orange)"}
    ],
    middleNotes: [
      {"name": "Nhựa cây (Resins)"},
      {"name": "Kẹo Caramel"}
    ],
    baseNotes: [
      {"name": "Hổ phách (Amber)"},
      {"name": "Nhựa thơm Peru (Peru Balsam)"},
      {"name": "Gỗ tuyết tùng (Cedar)"}
    ],
    accords: [
...
Đẹp nhất khi đi ăn tối, hẹn hò hoặc đi chơi cuối tuần — trời dưới 28°C. Xịt 1 nhát cổ, 1 nhát ngực là vừa. Mùa mưa Sài Gòn hay mùa đông Hà Nội là lúc chai này tỏa đẹp nhất. Đừng dùng đi làm ban ngày trừ khi văn phòng rộng và bạn xịt rất ít. Chai này cực hợp cho những buổi tối muốn gây ấn tượng gần.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":30,"summer":60,"fall":10,"winter":0},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":9,"uniqueness":8.8,"compliments":9,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Thanh Yên (Citron)"}
    ],
    middleNotes: [
      {"name": "Quả Bách xù (Juniper Berries)"},
      {"name": "Tiêu Timur"}
    ],
    baseNotes: [
      {"name": "Khoáng chất (Mineral Notes)"},
...
Ban ngày, đi làm mùa hè, khi muốn Terre mà trời nóng. Xịt 3 nhát cổ. Dùng quanh năm nhưng đẹp nhất xuân hè. Sài Gòn quanh năm.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":35,"summer":20,"fall":40,"winter":5},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":9.5,"uniqueness":9.5,"compliments":8.5,"value":9,"total":9.1},
    topNotes: [
      {"name": "Quả Cam (Orange)"},
      {"name": "Quả Bưởi (Grapefruit)"}
    ],
...
Đi làm, họp, gặp đối tác, café trò chuyện hoặc bất cứ khi nào cần toát ra sự chững chạc. Xịt 2-3 nhát: cổ và cổ tay. Dùng tốt quanh năm. Ở Việt Nam hợp ban ngày, đặc biệt mùa hanh khô Hà Nội.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":9,"compliments":8.5,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Quả Cam (Orange)"},
      {"name": "Quả Bưởi (Grapefruit)"}
    ],
...
Sự kiện tối, khi mặc suit, gala. Xịt 2 nhát cổ. Thu đông. Chai cho ai biết Le Smoking là gì.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":9.5,"compliments":8,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Quả Bưởi (Grapefruit)"},
      {"name": "Xoài xanh (Mango)"},
      {"name": "Cà chua (Tomato)"},
      {"name": "Cà rốt"}
    ],
    middleNotes: [
      {"name": "Hoa Sen (Lotus)"},
      {"name": "Cây Bồ hoàng (Bulrush)"}
    ],
    baseNotes: [
      {"name": "Nhang hương"},
      {"name": "Chi Tiên khách lai"}
    ],
    accords: [
      {"name": "Cam chanh", "value": 100, "color": "#ffff00"},
      {"name": "Thảo mộc", "value": 85, "color": "#2e8b57"},
...
Hằng ngày, hẹn hò nhẹ, cuối tuần, trời mát hoặc phòng máy lạnh. Xịt 2-3 nhát: cổ tay và cổ. Đẹp nhất thu-đông. Ở Việt Nam hợp tối hoặc ngày se lạnh. Rất tốt khi phối thêm với mùi hoa hoặc gỗ.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8,"value":9,"total":8.6},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Quả Chanh (Lemon)"}
    ],
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":30,"summer":60,"fall":5,"winter":5},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":8.2,"uniqueness":8.8,"compliments":8,"value":8,"total":8.2},
    topNotes: [
      {"name": "Nước biển (Sea Water)"}
    ],
    middleNotes: [
      {"name": "Hương gỗ (Woody Notes)"}
    ],
...
},
  {
    ...
    score: {"scent":8,"uniqueness":8.5,"compliments":8.2,"value":8,"total":8.2},
    topNotes: [
      {"name": "Tiêu hồng (Pink Pepper)"}
    ],
    middleNotes: [
