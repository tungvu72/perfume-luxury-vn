...
Đi ăn tối, hẹn hò, sự kiện, hoặc khi muốn mùi NỮ MẠNH. Xịt 2-3 nhát cổ và cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai tên CẤM — và xịt rồi thì khó quên.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":8.5,"compliments":9.5,"value":8,"total":8.8},
    topNotes: [
      {"name": "Bạch đậu khấu (Cardamom)"},
      {"name": "Cam Bergamot"}
    ],
...
Hẹn hò, ăn tối, buổi tối, gặp gỡ thân mật. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất thu đông. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":9,"compliments":9.5,"value":8.5,"total":9},
    topNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
      {"name": "Cam Mandarin"},
      {"name": "Thinh dầu lá cam"}
    ],
    middleNotes: [
      {"name": "Hoa Cam ngợp (Orange Blossom)"},
      {"name": "Hoa nhài thanh (Jasmine)"}
    ],
    baseNotes: [
...
Đi chơi tối, hẹn hò, party. Xịt 2-3 nhát cổ và cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Libre cho đêm lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":8.5,"compliments":9.3,"value":8,"total":8.8},
    topNotes: [
    ...
    middleNotes: [
      {"name": "Hoa Oải hương nguyên bản"},
      {"name": "Hoa Cam"}
    ],
    baseNotes: [
      {"name": "Mật ong mật (Honey)"},
      {"name": "Vani đen nhuyễn (Vanilla)"},
      {"name": "Đậu Tonka"},
      {"name": "Cỏ hương bài"}
    ],
    accords: [
...
Đi ăn tối, hẹn hò, sự kiện. Xịt 2-3 nhát cổ. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối điều hòa. Mon Guerlain cho đêm lạnh.`,
  ...
  },
  {
    ...
    baseNotes: [
      {"name": "Hoắc hương hoang (Patchouli)"},
      {"name": "Xạ hương ngà (Musk)"},
      {"name": "Gỗ Tuyết tùng"}
    ],
    accords: [
...
Sự kiện VIP, gala, hoặc khi muốn LUXURY level max. Xịt 1-2 nhát cổ. Thu đông. Hà Nội tháng 11-2. Sài Gòn chỉ tối điều hòa lạnh. Chai statement đắt nhất.`,
  ...
  },
  {
    ...
    score: {"scent":8,"uniqueness":9.5,"compliments":7,"value":8.5,"total":8.2},
    topNotes: [
      {"name": "Quýt Tangerine (Tangerine)"},
      {"name": "Cam Bergamot"},
      {"name": "Hoa linh lan"}
    ],
    middleNotes: [
      {"name": "Nhũ hương nhựa (Myrrh)"},
      {"name": "Hoa Cẩm chướng (Carnation)"},
      {"name": "Hoa Lài"}
    ],
    baseNotes: [
      {"name": "Hổ phách khét (Amber)"},
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Vani đen (Vanilla)"}
    ],
    accords: [
...
Đi làm sang trọng, gặp khách hàng quan trọng, đi ăn trưa ở nhà hàng, hoặc bất cứ khi nào muốn tạo hình ảnh chỉnh tề mà không cần la hét. Xịt 3 nhát: cổ, ngực, cổ tay. Dùng quanh năm — Sài Gòn hay Hà Nội đều thoải mái vì mùi rất sạch. Tránh đi club hay nhậu — lãng phí.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":35,"summer":5,"fall":35,"winter":25},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":7.5,"value":8,"total":8.2},
    topNotes: [
      {"name": "Anđêhít kim loại (Aldehydes)"},
      {"name": "Hương hoa xanh"},
      {"name": "Kim ngân hoa"}
    ],
    middleNotes: [
      {"name": "Hoa Hồng đỏ (Rose)"},
      {"name": "Hoa Diên vĩ đắng (Iris)"},
      {"name": "Hoa Muguet"}
    ],
    baseNotes: [
      {"name": "Rêu sồi ẩm (Oakmoss)"},
      {"name": "Cỏ hương bài (Vetiver)"},
      {"name": "Xạ hương da"}
    ],
    accords: [
...
Hẹn hò buổi tối, đi bar, đi ăn nhà hàng hoặc những dịp muốn gây ấn tượng. Xịt 1-2 nhát thôi: 1 sau gáy và 1 cổ — vì tỏa rất mạnh. Đẹp nhất khi trời mát dưới 25°C. Mùa đông Hà Nội hoặc mùa mưa Sài Gòn là lúc chai này tỏa đẹp nhất. Đừng dùng đi gym hay đi làm ban ngày.`,
...
},
  {
    ...
    score: {"scent":9,"uniqueness":9.2,"compliments":9,"value":8.5,"total":8.9},
    topNotes: [
      {"name": "Tiêu hồng the (Pink Pepper)"},
      {"name": "Lụa Nhài"},
      {"name": "Cây hợp hoan đào"}
    ],
    middleNotes: [
      {"name": "Kem tươi (Cream)"},
      {"name": "Vani sệt (Vanilla)"},
      {"name": "Hạt dẻ bùi nướng (Chestnut)"}
    ],
    baseNotes: [
      {"name": "Gỗ Đàn hương (Sandalwood)"},
      {"name": "Gỗ Cashmere dẻo (Cashmir wood)"}
    ],
    accords: [
...
Mùa đông, buổi tối, sự kiện, áo da. Xịt 1-2 nhát — tỏa cực mạnh. Đẹp nhất khi dưới 20°C. Ở Việt Nam chỉ nên dùng mùa lạnh Hà Nội hoặc phòng máy lạnh rất mạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9.8,"uniqueness":9,"compliments":9.5,"value":8.2,"total":9.1},
    topNotes: [
      {"name": "Lá Violet (Violet Leaf)"},
      {"name": "Ngò rí thơm (Coriander)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa Hồng lả (Rose)"},
      {"name": "Tiêu đen vụn (Pepper)"},
      {"name": "Hoa linh lan linh"}
    ],
    baseNotes: [
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Vani đanh (Vanilla)"},
      {"name": "Long diên hương mặn (Ambergris)"}
    ],
    accords: [
...
Quanh năm — đi làm, gặp gỡ, cà phê, dạo phố. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất xuân hè. Ở Sài Gòn dùng quanh năm.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":7.5,"compliments":8.8,"value":8,"total":8.2},
    topNotes: [
      {"name": "Hoa Oải hương non"},
      {"name": "Cam Mandarin"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Trà Hoa nhài (Jasmine Tea)"},
      {"name": "Hoa Cam tơ"},
      {"name": "Hoa nhài trắng"}
    ],
    baseNotes: [
      {"name": "Vani mỏng (Vanilla)"},
      {"name": "Xạ hương ngà (Musk)"},
      {"name": "Long diên hương"}
    ],
    accords: [
