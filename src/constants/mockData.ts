...
Sự kiện quan trọng, opera, triển lãm, hoặc khi muốn mùi hương là statement. Xịt 1-2 nhát SAU CỔ — vì EDP mạnh. Dùng quanh năm nhưng đẹp nhất mùa ấm — tuberose nở ra dưới nắng. Cả Sài Gòn và Hà Nội đều dùng được vì bạch đàn giữ tươi.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Lá Mimosa"},
      {"name": "Hoa dâm bụt (Hibiscus)"}
    ],
    middleNotes: [
      {"name": "Hoa trinh nữ (Mimosa)"},
      {"name": "Buddleia (Lilac mùa hè)"}
    ],
    baseNotes: [
      {"name": "Gỗ hạnh nhân (Almond tree)"},
      {"name": "Hoa hồng (Rose)"}
    ],
    accords: [
...
Văn phòng, meeting, gặp khách, hoặc BẤT CỨ KHI NÀO cần mùi hương professional. Xịt 2-3 nhát: cổ và cổ tay. Dùng quanh năm — vetiver giữ tươi mùa hè, gỗ sồi giữ ấm mùa đông. Chai "CEO scent" đúng nghĩa.`,
  ...
  },
  {
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":7,"value":8.5,"total":8.2},
    topNotes: [
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Gỗ hồng (Brazilian Rosewood)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa cẩm chướng (Carnation)"},
...
Đi ăn tối, sự kiện nhẹ, hoặc khi muốn mùi Pháp thật sự. Xịt 3 nhát: cổ, ngực, cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối mát. Chai để hiểu heritage nước hoa nam.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
...
Đi làm, gặp khách, họp, hoặc bất cứ dịp nào cần sự LỊCH SỰ THẦM LẶNG. Xịt 2-3 nhát: cổ và cổ tay. Dùng quanh năm — iris-neroli tươi mùa hè, benzoin-cedar ấm mùa đông. Chai "old money" scent.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":40,"summer":5,"fall":20,"winter":35},
    dayNight: {"day":60,"night":40},
    ...
    topNotes: [
      {"name": "Hoa tím (Violet)"},
      {"name": "Dâu rừng (Wild Strawberry)"}
    ],
    middleNotes: [
      {"name": "Hoa diên vĩ (Iris)"},
      {"name": "Hoa cam mộc (Orange Blossom)"}
    ],
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Đậu Tonka (Tonka Bean)"},
...
Đẹp nhất khi đi ăn tối, đi bar hoặc hẹn hò — trời dưới 25°C. Xịt 1 nhát sau gáy, 1 nhát trước ngực là vừa đủ. Mùa mưa Sài Gòn hay mùa đông Hà Nội là lúc Khamrah tỏa đẹp nhất. Đừng dùng đi làm ban ngày vì mùi quá đậm sẽ gây khó chịu cho người xung quanh. Phòng máy lạnh mát thì xịt ít hơn bình thường vì mùi sẽ đọng lại rất lâu.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9.2,"value":9,"total":8.9},
    topNotes: [
      {"name": "Quả anh đào (Cherry)"},
      {"name": "Hạnh nhân (Almond)"},
      {"name": "Hương cay (Spicy Notes)"}
    ],
    middleNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Hương nhang (Incense)"},
      {"name": "Hoa hồng (Rose)"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka (Tonka Bean)"},
...
Đi làm ban ngày, đi học, đi dạo, trời nóng 30-38°C. Xịt 3-4 nhát vì tỏa nhẹ. Đẹp nhất mùa hè — chai mùa hè lý tưởng. Ở Sài Gòn dùng quanh năm rất thoải mái. Perfect cho văn phòng.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":5,"fall":40,"winter":30},
    dayNight: {"day":40,"night":60},
    ...
    score: {"scent":8.8,"uniqueness":9.5,"compliments":7,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Tiểu hồi hương (Anise)"},
      {"name": "Cây rau mùi (Coriander)"}
    ],
    middleNotes: [
      {"name": "Hoa cẩm chướng (Carnation)"},
      {"name": "Hoa tím (Violet)"},
      {"name": "Hoa vòi voi (Heliotrope)"}
    ],
    baseNotes: [
      {"name": "Hoa diên vĩ (Iris)"},
      {"name": "Vani (Vanilla)"},
      {"name": "An tức hương (Benzoin)"}
    ],
    accords: [
...
Hoàng hôn (theo đúng tên), ăn tối nhẹ, thời gian riêng, hoặc khi muốn mùi hương là THƠ chứ không phải phụ kiện. Xịt 2 nhát: cổ và cổ tay. Dùng quanh năm — hoa tím tươi mùa xuân, vani ấm mùa đông. Chai để sống chậm lại.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 8,
    seasons: {"spring":30,"summer":10,"fall":30,"winter":30},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":7.5,"value":8.5,"total":8.3},
    topNotes: [
      {"name": "Hương cay (Spicy Notes)"}
    ],
    middleNotes: [
...
Quanh năm — đi làm, gặp khách, du lịch, dạo phố. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất xuân hè. Ở Sài Gòn dùng quanh năm. Chai daily driver luxury.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":10,"fall":40,"winter":25},
    dayNight: {"day":40,"night":60},
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":8,"value":8.2,"total":8.1},
    topNotes: [
      {"name": "Mật ong (Honey)"}
    ],
    middleNotes: [
...
Ban ngày, đi cafe, cuối tuần, hoặc khi muốn comfort. Xịt 3 nhát cổ và cổ tay. Dùng quanh năm. Cả SG và HN dùng thoải mái. Chai "ôm" mà không ngộp.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.8,"compliments":8.5,"value":9,"total":8.8},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Hoa Hồi (Star Anise)"},
      {"name": "Nhựa Elemi"}
    ],
    middleNotes: [
      {"name": "Hoắc hương (Patchouli)"}
...
Ban ngày, đi chơi, picnic, hoặc khi nào muốn VUI. Chai này = nụ cười trong lọ nước hoa. Discontinued nên dùng dè sẻn.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":9.8,"compliments":7,"value":9,"total":8.8},
    topNotes: [
      {"name": "Quả đào (Peach)"},
      {"name": "Cam Bergamot"}
    ],
...
Sự kiện trang trọng, opera, triển lãm nghệ thuật. Xịt 2 nhát cổ. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai cho ai coi nước hoa là nghệ thuật.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":35,"summer":10,"fall":35,"winter":20},
    dayNight: {"day":60,"night":40},
    ...
    score: {"scent":8.5,"uniqueness":8,"compliments":9,"value":8.5,"total":8.5},
    topNotes: [
...
Dùng quanh năm — đi làm, gặp gỡ, cà phê, hẹn hò nhẹ. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất thu đông. Ở Sài Gòn dùng thoải mái vì lavender giúp mùi sáng hơn.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":20,"summer":5,"fall":40,"winter":35},
    dayNight: {"day":40,"night":60},
...
Ban ngày, đi dạo, galerie, hoặc khi muốn mùi Paris student art. Xịt 3 nhát cổ. Xuân thu. Chai vintage affordable nhất.`,
  ...
  },
  {
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":7.5,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Chiết xuất Cam chanh (Citruses)"}
    ],
    middleNotes: [
      {"name": "Hoa Ngọc lan tây (Ylang-Ylang)"},
      {"name": "Hoa nhài (Jasmine)"},
...
Quanh năm — đi làm, gặp khách, dạo phố, du lịch. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất xuân hè. Ở Sài Gòn dùng quanh năm rất thoải mái.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":9.5,"compliments":7.5,"value":9,"total":8.9},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Hương cam chanh (Citruses)"}
    ],
    middleNotes: [
      {"name": "Nhựa Opoponax"},
      {"name": "Nhang khói (Incense)"}
    ],
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Da thuộc (Leather)"}
...
Đi ăn tối nhẹ, gặp bạn bè, thu nhẹ. Xịt 2-3 nhát cổ. Thu đông nhẹ. Shalimar cho ai muốn nhẹ hơn gốc.`,
  ...
  },
  {
    ...
    score: {"scent":9.8,"uniqueness":9.5,"compliments":8,"value":8.5,"total":9},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Hương hoa (Floral Notes)"}
    ],
    middleNotes: [
      {"name": "Hoa Diên vĩ (Iris)"},
      {"name": "Hoa hồng (Rose)"}
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    score: {"scent":7.5,"uniqueness":7.8,"compliments":7,"value":7.5,"total":7.4},
    topNotes: [
      {"name": "Ngò thơm (Coriander)"}
    ],
    middleNotes: [
      {"name": "Hoa hồng (Rose)"},
      {"name": "Hoa phong lữ (Geranium)"}
    ...
    baseNotes: [
      {"name": "Gỗ hồng sắc (Palisander Rosewood)"},
      {"name": "Gỗ đàn hương (Sandalwood)"},
      {"name": "Hoắc hương"}
    ],
    accords: [
...
},
  {
    ...
    score: {"scent":8,"uniqueness":7.5,"compliments":8,"value":7.8,"total":7.8},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Lá sung đỏ (Fig Leaf)"},
      {"name": "Tinh dầu lá chanh (Petitgrain)"}
    ],
    middleNotes: [
      {"name": "Hoa cam (Neroli)"},
      {"name": "Quả sung (Fig)"}
...
},
  {
    ...
    score: {"scent":7.5,"uniqueness":7,"compliments":7.5,"value":7.4,"total":7.4},
    topNotes: [
      {"name": "Hương nước (Water)"},
      {"name": "Hoa cam (Orange Blossom)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hương ánh mặt trời (Solar Notes)"},
      {"name": "Hoa mộc lan (Magnolia)"},
      {"name": "Hoa hồng"}
    ],
    baseNotes: [
