...
export const MASTER_PERFUMES: Perfume[] = [
  {
    ...
    score: {"scent":8.8,"uniqueness":7.5,"compliments":9,"value":9.5,"total":8.7},
    topNotes: [
      {"name": "Quả Quýt ngọt (Clementine)"}
    ],
    middleNotes: [
...
Dịp đặc biệt nhất, sự kiện VIP, mùa đông. Xịt 1-2 nhát — tỏa rõ. Đẹp nhất khi trời lạnh. Chai signature ultimate.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":9.5,"compliments":8.5,"value":8,"total":8.7},
    topNotes: [
      {"name": "Hoa Nhài Sambac (Jasmine)"}
    ],
    middleNotes: [
      {"name": "Gỗ Cashmeran"}
    ],
...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 2 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":8.2,"uniqueness":10,"compliments":7.5,"value":8.5,"total":8.6},
    topNotes: [
    ...
    baseNotes: [
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Sô cô la đen (Dark Chocolate)"},
      {"name": "Caramel"},
      {"name": "Vani"}
    ],
    accords: [
...
Mùa đông, buổi tối. Xịt 1 nhát — tỏa cả phòng. Đẹp nhất khi trời lạnh. Ở Sài Gòn chỉ dùng tối trong phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8.5,"value":8,"total":8.4},
    topNotes: [
      {"name": "Tiêu hồng (Pink Pepper)"},
      {"name": "Bưởi Tây (Grapefruit)"}
    ],
    middleNotes: [
      {"name": "Hạt dẻ ca cao (Hazelnut Cocoa)"}
    ],
    baseNotes: [
      {"name": "Hoắc hương đỏ (Patchouli)"},
...
Đẹp nhất khi trời mát — mùa đông Hà Nội hoặc mùa mưa Sài Gòn. Hợp đi ăn tối, dự tiệc hoặc những dịp muốn tạo dấu ấn. Xịt 1 nhát sau gáy và 1 nhát cổ tay là đủ — đừng xịt quá 2 nhát vì mùi rất tỏa. Dùng ban ngày trong phòng máy lạnh cũng đẹp. Đừng dùng ngày nóng 35°C ngoài trời vì sẽ hơi ngọp.`,
...
},
  {
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":8,"value":8.5,"total":8.5},
    topNotes: [
      {"name": "Tiêu hồng (Pink Pepper)"},
      {"name": "Quả Lê (Pear)"},
      {"name": "Nhục đậu khấu"},
...
Dùng hằng ngày — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng rất thoải mái.`,
...
},
  {
    ...
    score: {"scent":8,"uniqueness":7,"compliments":8,"value":8,"total":7.8},
    topNotes: [
      {"name": "Hoa Lan Nam Phi (Freesia)"},
...
},
  {
    ...
    name: "Ambrée",
    subName: "EDP",
    perfumer: "Aurélien Guichard",
    year: 2020,
    gender: "nu",
    longevity: 6,
    sillage: 8,
    seasons: {"spring":25,"summer":35,"fall":25,"winter":15},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":8.2,"uniqueness":7.5,"compliments":8.5,"value":8,"total":8.1},
    topNotes: [
...
},
  {
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":8,"value":8,"total":8.1},
    topNotes: [
      {"name": "Hoa Ngọc Lan Tây (Ylang-Ylang)"},
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Hoa Cam"}
    ...
    middleNotes: [
      {"name": "Xạ Hương Chuyên Sâu (Musk)"}
    ],
    baseNotes: [
      {"name": "Mật ong (Honey)"},
      {"name": "Hương gỗ mát (Woody Notes)"},
      {"name": "Hổ phách (Amber)"}
    ],
    accords: [
...
},
  {
    ...
    subName: "EDP",
    perfumer: "Dora Baghriche, Daphné Bugey",
    year: 2023,
    gender: "nu",
    longevity: 6,
    sillage: 8,
    seasons: {"spring":40,"summer":30,"fall":20,"winter":10},
    dayNight: {"day":75,"night":25},
    ...
    middleNotes: [
      {"name": "Hoa Hồng Centifolia (Rose)"},
      {"name": "Phong Lữ Thảo (Geranium)"}
    ],
    baseNotes: [
      {"name": "Xạ Hương (Musk)"},
      {"name": "Gỗ Đàn Hương (Sandalwood)"}
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":40,"summer":15,"fall":30,"winter":15},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9.5,"value":9,"total":9},
    topNotes: [
      {"name": "Hoa Hồng (Rose)"},
      {"name": "Quả Đào (Peach)"}
    ],
