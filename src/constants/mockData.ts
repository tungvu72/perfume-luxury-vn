...
Đi chơi, hẹn hò casual, tụ tập bạn bè, trời mát. Xịt 2-3 nhát: cổ, ngực, cổ tay. Đẹp nhất mùa thu đông. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh. Đừng dùng đi văn phòng nghiêm túc — quá vui và quá ngọt.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/jpg-le-male-elixir-bottle.jpg", source: "studio", caption: "Ảnh chai JPG Le Male Elixir" },
      { url: "/images/products/jpg-le-male-elixir-main.jpg", source: "studio", caption: "Ảnh chi tiết JPG Le Male Elixir" }
    ],
...
Đẹp nhất khi đi ăn tối, đi bar hoặc hẹn hò — trời dưới 25°C. Xịt 1 nhát sau gáy, 1 nhát trước ngực là vừa đủ. Mùa mưa Sài Gòn hay mùa đông Hà Nội là lúc Khamrah tỏa đẹp nhất. Đừng dùng đi làm ban ngày vì mùi quá đậm sẽ gây khó chịu cho người xung quanh. Phòng máy lạnh mát thì xịt ít hơn bình thường vì mùi sẽ đọng lại rất lâu.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/guerlain-l-homme-ideal-eau-de-parfum-main.webp", source: "amazon", caption: "Ảnh sản phẩm L'Homme Ideal EDP (chai và hộp)" },
      { url: "/images/products/guerlain-l-homme-ideal-edp-bottle.jpg", source: "studio", caption: "Ảnh chai L'Homme Ideal EDP" }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
