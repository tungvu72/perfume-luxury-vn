...
Le Male Le Parfum là lựa chọn sáng giá cho người muốn mùi đi tối vừa cuốn vừa dễ dùng. Điểm yếu là vào ngày quá nóng nó có thể hơi dày.`,
    ...
    accords: [{ name: "Hổ phách", value: 100, color: "#d4a017" }, { name: "Gỗ", value: 80, color: "#8B4513" }, { name: "Gia vị ấm", value: 75, color: "#e67e22" }, { name: "Ngọt", value: 70, color: "#e74c3c" }, { name: "Vani", value: 65, color: "#f5deb3" }, { name: "Oải hương", value: 55, color: "#9b59b6" }],
...
Prada L'Homme mạnh ở độ tử tế và dễ dùng nơi công sở. Điểm yếu là ai thích mùi cá tính mạnh có thể thấy nó quá hiền.`,
    ...
    accords: [{ name: "Phấn", value: 100, color: "#ecf0f1" }, { name: "Gỗ", value: 80, color: "#8B4513" }, { name: "Gia vị tươi", value: 70, color: "#2ecc71" }, { name: "Thơm thảo mộc", value: 65, color: "#1abc9c" }, { name: "Iris", value: 60, color: "#d5c4f0" }, { name: "Hoa", value: 50, color: "#e91e63" }],
...
Terre d'Hermès EDT rất hay nếu gu của bạn thích sự điềm và tinh tế. Điểm yếu là nó không phải kiểu ai ngửi lần đầu cũng mê ngay.`,
    ...
    accords: [{ name: "Cam chanh", value: 100, color: "#f1c40f" }, { name: "Gỗ", value: 90, color: "#8B4513" }, { name: "Gia vị tươi", value: 80, color: "#2ecc71" }, { name: "Thơm thảo mộc", value: 75, color: "#1abc9c" }, { name: "Đất", value: 70, color: "#95a5a6" }, { name: "Gia vị ấm", value: 60, color: "#e67e22" }],
...
Nên mua khi mày cần một mùi buổi tối an toàn, dễ dùng và có khả năng tạo thiện cảm cao. Không nên mua nếu mục tiêu là hiệu năng mạnh, tỏa xa hoặc cần một mùi quá khác biệt.`,
    ...
    accords: [{ name: "Gỗ", value: 100, color: "#8B4513" }, { name: "Gia vị tươi", value: 85, color: "#2ecc71" }, { name: "Thơm thảo mộc", value: 75, color: "#1abc9c" }, { name: "Oải hương", value: 70, color: "#9b59b6" }, { name: "Gia vị ấm", value: 60, color: "#e67e22" }, { name: "Phấn", value: 50, color: "#ecf0f1" }],
...
Nên mua khi mày muốn một chai signature ít rủi ro, dễ tạo thiện cảm và có chất Guerlain hiện đại. Nếu mày thích những mùi cực ngọt hoặc cực nổi, có thể cần một lựa chọn cá tính hơn.`,
    ...
    accords: [{ name: "Phương Đông", value: 100, color: "#c0392b" }, { name: "Gỗ", value: 80, color: "#8B4513" }, { name: "Vani", value: 75, color: "#f5deb3" }, { name: "Oải hương", value: 60, color: "#9b59b6" }, { name: "Hoa", value: 55, color: "#e91e63" }],
    tags: ["Nữ", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày muốn một chai signature dễ dùng quanh năm. Nếu đã có nhiều mùi fresh-sweet tương tự, hãy mua vì chất lượng blend của Chanel chứ đừng kỳ vọng độ đột phá.`,
    ...
    accords: [{ name: "Tươi mát", value: 100, color: "#2ecc71" }, { name: "Gỗ", value: 80, color: "#8B4513" }, { name: "Gia vị tươi", value: 70, color: "#27ae60" }, { name: "Xạ hương", value: 60, color: "#bdc3c7" }, { name: "Thơm thảo mộc", value: 55, color: "#1abc9c" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai premium để đi làm, gặp khách hoặc làm signature ban ngày. Nếu mày thích mùi mềm, ấm, tình cảm hơn là sáng sắc và sang lạnh, nên thử kỹ trước khi chốt.`,
    ...
    accords: [{ name: "Gỗ", value: 100, color: "#8B4513" }, { name: "Cam chanh", value: 85, color: "#f1c40f" }, { name: "Rêu", value: 70, color: "#556B2F" }, { name: "Trái cây", value: 65, color: "#e74c3c" }, { name: "Đất", value: 55, color: "#95a5a6" }],
    tags: ["Unisex", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai tối lịch sự, hẹn hò hoặc đi event. Nếu đang tìm một chai dùng ban ngày quanh năm, bản gốc sẽ hợp hơn.`,
    ...
    accords: [{ name: "Phấn", value: 100, color: "#ecf0f1" }, { name: "Hổ phách", value: 85, color: "#d4a017" }, { name: "Gỗ", value: 75, color: "#8B4513" }, { name: "Da thuộc", value: 60, color: "#5D4037" }, { name: "Iris", value: 55, color: "#d5c4f0" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày đã chán các vanilla phổ thông và muốn một thứ tinh hơn, có cá tính hơn. Nếu mày cần mùi dễ thương, gourmand rõ hoặc dễ khen ngay, đây không phải hướng đầu tiên.`,
    ...
    accords: [{ name: "Xạ hương", value: 100, color: "#bdc3c7" }, { name: "Vani", value: 85, color: "#f5deb3" }, { name: "Phấn", value: 70, color: "#ecf0f1" }, { name: "Hổ phách", value: 65, color: "#d4a017" }, { name: "Ngọt", value: 55, color: "#e74c3c" }],
    tags: ["Unisex", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai dùng đi làm hoặc signature nhẹ nhàng sang. Nếu mày muốn mùi cực quyến rũ buổi tối, nên tìm hướng đậm hơn.`,
    ...
    accords: [{ name: "Hoa trắng", value: 100, color: "#ffeaa7" }, { name: "Cam chanh", value: 75, color: "#f1c40f" }, { name: "Gỗ", value: 60, color: "#8B4513" }, { name: "Xạ hương", value: 55, color: "#bdc3c7" }],
    tags: ["Nữ", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày muốn một chai tối, lạnh, có statement rõ. Nếu mày cần mùi nữ hiện đại, sáng và dễ dùng mỗi ngày, Opium sẽ không phải lựa chọn đầu tiên.`,
    ...
    accords: [{ name: "Hổ phách", value: 100, color: "#d4a017" }, { name: "Gia vị ấm", value: 85, color: "#e67e22" }, { name: "Hoa", value: 70, color: "#e91e63" }, { name: "Cam chanh", value: 55, color: "#f1c40f" }, { name: "Nhựa thơm", value: 50, color: "#c0392b" }],
    tags: ["Nữ", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày muốn thêm một chai mood scent cho tối, ngày mưa hoặc những lúc cần một vibe rất riêng. Nếu mày mới chơi nước hoa hoặc chỉ cần mùi dễ dùng hằng ngày, đây không phải lựa chọn ưu tiên đầu tiên.`,
    ...
    accords: [{ name: "Gỗ", value: 100, color: "#8B4513" }, { name: "Đất", value: 85, color: "#95a5a6" }, { name: "Cỏ hương bài", value: 80, color: "#556B2F" }, { name: "Thơm thảo mộc", value: 60, color: "#1abc9c" }, { name: "Khói", value: 50, color: "#7f8c8d" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày đang cần một chai buổi tối có sức công phá. Nếu mày thích sự tinh tế, kín đáo hoặc khí hậu dùng chủ yếu là trưa nóng ngoài trời, nên cân nhắc kỹ.`,
    ...
    accords: [{ name: "Oải hương", value: 100, color: "#9b59b6" }, { name: "Vani", value: 85, color: "#f5deb3" }, { name: "Gia vị ấm", value: 75, color: "#e67e22" }, { name: "Ngọt", value: 70, color: "#e74c3c" }, { name: "Mật ong", value: 60, color: "#d4a017" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày muốn một mùi linh hoạt cho đi chơi và dùng casual. Nếu mày đang tìm một chai cực kỳ hiện đại hoặc cực kỳ sang tối, các bản flankers như Le Parfum hay Elixir có thể hợp hơn.`,
    ...
    accords: [{ name: "Oải hương", value: 100, color: "#9b59b6" }, { name: "Ngọt", value: 80, color: "#e74c3c" }, { name: "Gia vị ấm", value: 75, color: "#e67e22" }, { name: "Vani", value: 70, color: "#f5deb3" }, { name: "Bạc hà", value: 55, color: "#2ecc71" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai premium cho dịp quan trọng hoặc muốn sưu tập thêm một twist khác của Aventus. Nếu mày chỉ cần một chai linh hoạt nhất trong nhóm này, bản Aventus gốc vẫn dễ sống chung hơn.`,
    ...
    accords: [{ name: "Trái cây", value: 100, color: "#e74c3c" }, { name: "Gỗ", value: 85, color: "#8B4513" }, { name: "Cam chanh", value: 70, color: "#f1c40f" }, { name: "Gia vị ấm", value: 65, color: "#e67e22" }, { name: "Khói", value: 55, color: "#7f8c8d" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai tối, mùa mát hoặc hẹn hò. Nếu mày chủ yếu dùng giữa trưa nóng hoặc thích mùi rất fresh, Ani không phải hướng ưu tiên.`,
    ...
    accords: [{ name: "Gia vị ấm", value: 100, color: "#e67e22" }, { name: "Vani", value: 85, color: "#f5deb3" }, { name: "Nhựa thơm", value: 70, color: "#c0392b" }, { name: "Gia vị tươi", value: 65, color: "#2ecc71" }, { name: "Gỗ", value: 55, color: "#8B4513" }],
    tags: ["Unisex", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai ban ngày chất lượng cao, đặc biệt cho môi trường lịch sự. Nếu ưu tiên độ bền khủng hoặc vibe tối quyến rũ, nên có thêm một chai khác bổ sung.`,
    ...
    accords: [{ name: "Cam chanh", value: 100, color: "#f1c40f" }, { name: "Thơm thảo mộc", value: 80, color: "#1abc9c" }, { name: "Vani", value: 70, color: "#f5deb3" }, { name: "Gỗ", value: 65, color: "#8B4513" }, { name: "Phấn", value: 55, color: "#ecf0f1" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai signature ban ngày mùa nóng. Nếu mày ưu tiên chiều sâu buổi tối, bản EDT hoặc Parfum vẫn hợp hơn.`,
    ...
    accords: [{ name: "Cam chanh", value: 100, color: "#f1c40f" }, { name: "Gỗ", value: 75, color: "#8B4513" }, { name: "Tươi mát", value: 70, color: "#2ecc71" }, { name: "Ozone", value: 55, color: "#3498db" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày cần một chai tối lịch sự và có khí chất quý ông. Nếu mày chỉ tìm một chai trẻ trung, dễ dùng hằng ngày, đây sẽ không phải lựa chọn đầu tiên.`,
    ...
    accords: [{ name: "Phương Đông", value: 100, color: "#c0392b" }, { name: "Gỗ", value: 80, color: "#8B4513" }, { name: "Vani", value: 75, color: "#f5deb3" }, { name: "Ngọt", value: 60, color: "#e74c3c" }, { name: "Da thuộc", value: 50, color: "#5D4037" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
    verdict: "(Chờ nguồn xác minh)",
...
Nên mua khi mày đã có ít nhất một chai fresh hoặc văn phòng, và đang cần một option tối hơn cho hẹn hò hay đi chơi tối. Không nên ưu tiên nó làm chai duy nhất nếu nhu cầu chính là đi làm mỗi ngày giữa thời tiết nóng.`,
    ...
    baseNotes: [{ name: "Đậu Tonka" }, { name: "Da thuộc" }, { name: "Gỗ đàn hương" }],
    accords: [{ name: "Hạnh nhân", value: 100, color: "#d4a017" }, { name: "Da thuộc", value: 80, color: "#5D4037" }, { name: "Vani", value: 75, color: "#f5deb3" }, { name: "Gỗ", value: 65, color: "#8B4513" }, { name: "Phương Đông", value: 60, color: "#c0392b" }, { name: "Gourmand", value: 55, color: "#e74c3c" }],
    tags: ["Nam", "NEEDS_SOURCE"],
    sizes: [],
    basePrice: 0,
