...
Profondo là kiểu chai dễ dùng thật sự trong khí hậu Việt Nam. Điểm yếu là nó thiên an toàn nên không hợp người thích mùi gây sốc hoặc quá khác biệt.`,
    ...
    seoTitle: "Acqua di Gio Profondo giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Acqua di Gio Profondo chính hãng: mùi biển sạch hiện đại, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Nếu bạn thích một chai nước hoa nữ trẻ trung, ngọt trái cây và rất dễ tạo thiện cảm, Burberry Her EDP là lựa chọn rất đáng thử. Nó không quá sang kiểu tiệc tối, nhưng lại rất hợp với nhịp sống hiện đại và tinh thần vui tươi, nữ tính mà nhiều người tìm kiếm.`,
    ...
    seoTitle: "Burberry Her EDP chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Burberry Her EDP chính hãng: mùi dâu quả mọng trẻ trung, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
    tags: ["nu","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Nếu bạn muốn một chai nước hoa nam an toàn theo nghĩa tích cực, trưởng thành và hợp nhiều tình huống, Boss Bottled EDP là lựa chọn rất dễ sống chung lâu dài. Nó không quá flashy, nhưng sự ổn định và hình ảnh lịch sự mà nó mang lại luôn có giá trị thực tế.`,
    ...
    seoTitle: "Boss Bottled EDP chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Boss Bottled EDP chính hãng: mùi gỗ gia vị lịch lãm, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026 tại Maison De Son.",
    tags: ["nam","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Dùng được quanh năm — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa xuân hè khi trời ấm. Ở Sài Gòn dùng thoải mái vì rất nhẹ nhàng, không bao giờ ngọp. Đây là kiểu chai thơm nhẹ cho mọi ngày — tinh tế, dễ chịu và rất feminine.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chloe-eau-de-parfum-main.jpg", source: "amazon", caption: "CHLOE Chloe Eau de Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
