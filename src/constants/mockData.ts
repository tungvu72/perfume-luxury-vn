...
Cedrat Boise mạnh ở độ đa dụng và hiệu năng. Điểm yếu là opening không phải ai cũng mê ngay.`,
    ...
    seoTitle: "Mancera Cedrat Boise chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Mancera Cedrat Boise chính hãng: mùi citrus gỗ mạnh mẽ, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026 tại Maison De Son.",
...
Dùng quanh năm — đi làm, đi chơi, hẹn hò nhẹ, cà phê. Xịt 2-3 nhát: cổ, ngực, cổ tay. Đẹp nhất mùa xuân thu. Ở Sài Gòn dùng thoải mái — vừa tươi vừa ấm nên hợp cả nắng và máy lạnh.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/nishane-hacivat-main.jpg", source: "studio", caption: "Ảnh sản phẩm Nishane Hacivat (chai và hộp)" },
      { url: "/images/products/nishane-hacivat-bottle.jpg", source: "studio", caption: "Ảnh chai Nishane Hacivat" }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
