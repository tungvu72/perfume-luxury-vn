...
Nếu bạn cần một chai nước hoa nam trẻ, sạch, linh hoạt và không có rủi ro cao khi blind buy, Coach for Men EDT là lựa chọn khá an toàn. Nó không phải kiểu để gây choáng ngợp, nhưng lại rất hợp với người muốn thơm một cách tự nhiên và dễ gần.`,
    ...
    seoTitle: "Coach For Men chính hãng giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Coach For Men chính hãng: mùi lê gỗ da trẻ trung, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
    tags: ["nam","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Nên mua khi mày muốn một mùi linh hoạt cho đi chơi và dùng casual. Nếu mày đang tìm một chai cực kỳ hiện đại hoặc cực kỳ sang tối, các bản flankers như Le Parfum hay Elixir có thể hợp hơn.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/creed-absolu-aventus-main.jpg", source: "studio", caption: "Ảnh sản phẩm Creed Absolu Aventus (chai và hộp)" },
      { url: "/images/products/creed-absolu-aventus-bottle.jpg", source: "studio", caption: "Ảnh chai Creed Absolu Aventus" }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối, mùa lạnh hoặc dịp đặc biệt. Nếu mày chủ yếu dùng giữa thời tiết nóng ẩm ban ngày, đây không phải hướng ưu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-egoiste-platinum-main.jpg", source: "amazon", caption: "CHANEL Platinum Egoiste chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Dùng được quanh năm — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa xuân hè khi trời ấm. Ở Sài Gòn dùng thoải mái vì rất nhẹ nhàng, không bao giờ ngọp. Đây là kiểu chai thơm nhẹ cho mọi ngày — tinh tế, dễ chịu và rất feminine.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-coco-noir-main.jpg", source: "amazon", caption: "CHANEL Coco Noir chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
