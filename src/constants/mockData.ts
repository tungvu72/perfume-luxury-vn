...
Hẹn hò, ăn tối, buổi tối, gặp gỡ thân mật. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất thu đông. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/sospiro-vibrato-main.jpg", source: "amazon", caption: "SOSPIRO Vibrato chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối lịch sự và có khí chất quý ông. Nếu mày chỉ tìm một chai trẻ trung, dễ dùng hằng ngày, đây sẽ không phải lựa chọn đầu tiên.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/penhaligons-halfeti-main.jpg", source: "amazon", caption: "PENHALIGON'S Halfeti chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
