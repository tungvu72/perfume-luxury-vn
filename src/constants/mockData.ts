...
Đây là một chai dễ làm người ta nhớ nếu gu của bạn thiên ngọt ấm. Điểm trừ là không hợp số đông trong thời tiết nóng và không phải ai cũng chịu được độ dày của nó.`,
  ...
  },
  {
    ...
    gender: "nam",
    image: "/images/products/bleu-chanel-edp-1.avif",
    images: [
      { url: "/images/products/bleu-chanel-edp-2.jpg", source: "fragram", caption: "Bleu de Chanel EDP trên áo sơ mi trắng", verified: true },
      { url: "/images/products/bleu-chanel-edp-3.jpg", source: "fragram", caption: "Bleu de Chanel EDP góc nghệ thuật", verified: true },
      { url: "/images/products/bleu-chanel-edp-4.jpg", source: "fragram", caption: "Bleu de Chanel EDP fullbox và chiết", verified: true },
      { url: "/images/products/bleu-chanel-edp-5.jpg", source: "fragram", caption: "Bleu de Chanel EDP cầm tay", verified: true },
    ],
