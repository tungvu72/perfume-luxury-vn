...
Đi làm, đi cà phê, gặp gỡ, dùng hằng ngày. Xịt 2 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng thoải mái — hoa trắng rất dễ chịu khi nóng nếu xịt vừa tay.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/essential-parfums-bois-imperial-main.jpg", source: "amazon", caption: "ESSENTIAL PARFUMS Bois Imperial chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nếu bạn cần một chai nước hoa unisex thiên về quyến rũ, trưởng thành và có chiều sâu rất rõ, Initio Side Effect là lựa chọn cực kỳ đáng thử. Nó không phải kiểu thơm dễ chiều số đông, nhưng lại rất hợp với người muốn mùi hương của mình có sức hút kiểu chậm, dày và rất khó quên.`,
    ...
    seoTitle: "Initio Side Effect chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Initio Side Effect chính hãng: mùi rum vanilla hổ phách đậm, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
    tags: ["unisex","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
