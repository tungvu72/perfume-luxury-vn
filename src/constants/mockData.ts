...
Mùa đông, ở nhà cuối tuần, đi cafe, hoặc khi muốn comfort zone. Xịt 2-3 nhát cổ và cổ tay. Hà Nội tháng 11-2 là perfect. Sài Gòn thì phòng máy lạnh hoặc tối mát. Không dùng đi làm trong phòng kín vì caramel sữa sẽ ngộp đồng nghiệp.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":8,"compliments":9.5,"value":8,"total":8.6},
    topNotes: [
      {"name": "Quả Lê tươi (Pear)"},
      {"name": "Tiêu hồng the (Pink Pepper)"},
      {"name": "Hoa Cam"}
    ],
    middleNotes: [
      {"name": "Cà phê đen (Coffee)"},
      {"name": "Hoa Nhài lả (Jasmine)"},
      {"name": "Hạnh nhân đắng"}
    ],
    baseNotes: [
      {"name": "Vani đen sệt (Vanilla)"},
      {"name": "Hoắc hương đất (Patchouli)"},
      {"name": "Gỗ Cashmere"}
    ],
    accords: [
...
Đi tối, hẹn hò, bar, tiệc, sự kiện. Xịt 1-2 nhát thôi: 1 cổ, 1 cổ tay — vì tỏa rất mạnh. Đẹp nhất mùa đông hoặc trời mát dưới 25°C. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh. Đừng xịt nhiều đi ăn trưa ngày nóng — cà phê + vani khi nóng sẽ rất ngọp.`,
  ...
  },
  {
    ...
    score: {"scent":9.3,"uniqueness":8,"compliments":9.2,"value":8,"total":8.6},
    topNotes: [
      {"name": "Quả Lê dập (Pear)"},
      {"name": "Quế già (Cinnamon)"},
      {"name": "Quýt xanh"}
    ],
    middleNotes: [
      {"name": "Hương ánh sáng (Solar Notes)"},
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Hoa Cam"}
    ],
    baseNotes: [
      {"name": "Hỗn hợp 4 loại Vani (Vanilla)"},
      {"name": "Cà phê Arabica (Coffee)"},
      {"name": "Hoắc hương hoang"}
    ],
    accords: [
...
Dùng được quanh năm — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa xuân hè khi trời ấm. Ở Sài Gòn dùng thoải mái vì rất nhẹ nhàng, không bao giờ ngọp. Đây là kiểu chai thơm nhẹ cho mọi ngày — tinh tế, dễ chịu và rất feminine.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":8.5,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Quả quýt Clementine"},
      {"name": "Hoa Hạnh nhân (Almond Blossom)"},
      {"name": "Hồng nhung"}
    ],
    middleNotes: [
      {"name": "Hoa nhài thanh (Jasmine)"},
      {"name": "Mẫu đơn trắng"},
      {"name": "Loa kèn đỏ"}
    ],
    baseNotes: [
...
Hẹn hò buổi tối, ăn tối lãng mạn. Xịt 4-5 nhát vì rất nhanh tan: cổ, ngực, cổ tay, quần áo. Đẹp nhất cuối thu qua đông. Ở Sài Gòn dùng buổi tối phòng máy lạnh.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":30,"summer":10,"fall":35,"winter":25},
    dayNight: {"day":40,"night":60},
    ...
    score: {"scent":9.5,"uniqueness":8,"compliments":9.8,"value":8,"total":8.8},
    topNotes: [
      {"name": "Bạch đậu khấu cay (Cardamom)"},
      {"name": "Gừng the (Ginger)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
    ...
    baseNotes: [
      {"name": "Gỗ Tuyết tùng khô (Cedar)"},
      {"name": "Cỏ hương bài mộc"}
    ],
    accords: [
...
Đi ăn tối, hẹn hò, cuối tuần thư giãn. Xịt 2-3 nhát cổ. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai cho ai đã mệt mainstream.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":8.5,"compliments":9.2,"value":8,"total":8.8},
    topNotes: [
...
Ban ngày mùa hè, đi dạo, khi muốn N°19 mà trời nóng. Xịt 4-5 nhát vì EDT bay nhanh.`,
  ...
  },
  {
    ...
    score: {"scent":9.8,"uniqueness":9,"compliments":9.5,"value":8.5,"total":9.2},
    topNotes: [
      {"name": "Hoa Oải hương (Lavender)"},
      {"name": "Chanh vàng rực"},
      {"name": "Cam Bergamot"}
    ...
    middleNotes: [
      {"name": "Mật ong đặc (Honey)"},
      {"name": "Quế (Cinnamon)"},
      {"name": "Hoa Nhài Cashmeran"}
    ],
    baseNotes: [
      {"name": "Thuốc lá non (Tobacco)"},
      {"name": "Đậu Tonka (Tonka Bean)"},
      {"name": "Vani mịn (Vanilla)"}
    ],
    accords: [
...
Mùa thu đông, buổi tối, hẹn hò, đi chơi. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":30,"summer":55,"fall":10,"winter":5},
    dayNight: {"day":75,"night":25},
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":8.8,"value":7.5,"total":8.4},
    topNotes: [
      {"name": "Lá Bạc hà the (Mint)"},
      {"name": "Chanh vàng (Lemon)"},
      {"name": "Húng quế (Basil)"}
...
Xuân hè, ban ngày, đi làm, thể thao nhẹ, dạo phố. Xịt 3-4 nhát. Đẹp nhất khi trời nóng. Ở Sài Gòn dùng quanh năm.`,
...
},
  {
    ...
    score: {"scent":8.5,"uniqueness":7,"compliments":8.8,"value":8,"total":8},
    topNotes: [
      {"name": "Hoa Cam trắng (Orange Blossom)"},
      {"name": "Quả lê"}
    ],
    middleNotes: [
      {"name": "Bột Cà phê (Coffee)"},
      {"name": "Mashmallow xốp"},
      {"name": "Hạnh nhân đắng"}
    ],
    baseNotes: [
      {"name": "Vani đen (Vanilla)"},
      {"name": "Xạ hương đê mê"},
      {"name": "Hoắc hương"}
    ],
    accords: [
...
},
  {
    ...
    topNotes: [
      {"name": "Hoa Oải hương sắc (Lavender)"},
      {"name": "Cam Mandarin"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa Oải hương lả"},
      {"name": "Hoa Lan Châu Phi (Orchid)"},
      {"name": "Hoa Nhài (Jasmine)"}
    ],
    baseNotes: [
      {"name": "Vani nguyên con (Vanilla)"},
      {"name": "Đậu Tonka (Tonka Bean)"},
      {"name": "Long diên hương"}
    ],
    accords: [
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":25,"fall":30,"winter":20},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":9,"uniqueness":7.5,"compliments":9.5,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Táo xanh giòn (Apple)"},
      {"name": "Gừng tươi (Ginger)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Lá Xô thơm mặn (Sage)"},
      {"name": "Quả bách xù"},
      {"name": "Hoa phong lữ"}
    ],
    baseNotes: [
      {"name": "Gỗ hổ phách nhựa (Amberwood)"},
      {"name": "Đậu Tonka (Tonka Bean)"},
      {"name": "Gỗ Tuyết tùng"},
      {"name": "Trầm hương phay"}
    ],
    accords: [
