...
Dùng được quanh năm — đi làm, gặp khách, đi ăn tối nhẹ. Đẹp nhất vào mùa xuân thu khi trời mát. Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Ở Sài Gòn dùng trong phòng máy lạnh rất đẹp. Đây là kiểu chai signature cho người thích sự chỉn chu gọn gàng — xịt xong đi luôn, không cần nghĩ nhiều.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/acqua-di-parma-colonia-main.jpg", source: "amazon", caption: "ACQUA DI PARMA Colonia chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày đã có ít nhất một chai fresh hoặc văn phòng, và đang cần một option tối hơn cho hẹn hò hay đi chơi tối. Không nên ưu tiên nó làm chai duy nhất nếu nhu cầu chính là đi làm mỗi ngày giữa thời tiết nóng.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/givenchy-l-interdit-eau-de-parfum-main.jpg", source: "amazon", caption: "GIVENCHY L Interdit Eau de Parfum chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
