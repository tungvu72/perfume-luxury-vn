...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 1-2 nhát — beast mode. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông Hà Nội nhất.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/chanel-no-19-eau-de-parfum-main.webp", source: "amazon", caption: "CHANEL Chanel No 19 Eau de Parfum chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-19-poudre-main.jpg", source: "amazon", caption: "CHANEL Chanel No 19 Poudre chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
...
Dùng hằng ngày — đi làm, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất mùa thu đông. Ở Sài Gòn dùng thoải mái vì EDT khá nhẹ. Đây là bản daily-wear lý tưởng của N°5.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-no-5-parfum-main.jpg", source: "amazon", caption: "CHANEL Chanel No 5 Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
...
Mùa thu đông, buổi tối, sự kiện, áo da jacket. Xịt 2 nhát: cổ, ngực. Đẹp nhất khi trời mát dưới 25°C. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    name: "Ombre Nomade",
    subName: "Eau de Parfum",
    perfumer: "Givaudan perfumers",
    gender: "unisex",
    image: "/images/products/louis-vuitton-ombre-nomade-main.jpg",
    images: [{ url: "/images/products/louis-vuitton-ombre-nomade-main.jpg", source: "amazon", caption: "LOUIS VUITTON Ombre Nomade chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
