...
Đi làm, gặp khách, chơi golf, họp hành, dùng hằng ngày. Xịt 2-3 nhát: cổ, ngực, cổ tay. Dùng quanh năm nhưng đẹp nhất mùa xuân hè. Ở Sài Gòn dùng thoải mái — xanh iris rất dễ chịu khi nóng.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":8.8,"compliments":8.5,"value":8,"total":8.6},
    topNotes: [
      {"name": "Bưởi tây (Grapefruit)"},
      {"name": "Hoa cam (Orange Blossom)"},
      {"name": "Cây xô thơm"}
...
Mùa thu đông, buổi tối, dịp đặc biệt, hẹn hò. Xịt 1-2 nhát — tỏa khá mạnh. Đẹp nhất khi trời mát. Ở Sài Gòn chỉ dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":9,"compliments":9,"value":6.5,"total":8.5},
    topNotes: [
      {"name": "Quả Anh đào (Cherry)"},
      {"name": "Hạnh nhân đắng (Almond)"},
      {"name": "Rượu mùi (Liquor)"}
    ],
    middleNotes: [
      {"name": "Mận mọng"},
      {"name": "Hoa hồng Thổ Nhĩ Kỳ"},
      {"name": "Hoa Nhài Sambac"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka"},
...
Hẹn hò, sinh nhật, Giáng sinh, Valentine — những dịp ngọt ngào. Xịt 2 nhát sau cổ và cổ tay. Mùi sẽ ngọt nhất 30 phút đầu rồi dịu dần. Ở Hà Nội dùng thu đông. Ở Sài Gòn thì tối mát hoặc phòng điều hòa — không nên dùng ban ngày ngoài trời vì ngọt gặp nóng sẽ ngấy.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8.8,"value":8,"total":8.5},
    topNotes: [
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Cây đương quy (Angelica)"},
      {"name": "Hoắc hương (Patchouli)"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka (Coumarin)"},
      {"name": "Hổ phách đỏ (Amber)"},
      {"name": "Xạ hương (Musk)"}
    ],
    accords: [
...
Mùa thu đông, buổi tối, hẹn hò, gặp gỡ. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Tiêu cay (Pepper)"}
    ],
    middleNotes: [
      {"name": "Oải hương (Lavender)"},
      {"name": "Than đá (Coal)"},
      {"name": "Hương nhôm kim loại"},
      {"name": "Đất ướt"}
    ],
    baseNotes: [
      {"name": "Ambroxan"},
...
Dịp đặc biệt, sự kiện, khi muốn mùi hương QUYỀN LỰC. Dabbing — chấm 1-2 giọt sau tai và cổ (Parfum dạng dabber, không spray). Dùng quanh năm. Chai mà mọi phụ nữ nên ngửi một lần.`,
  ...
  },
  {
    ...
    middleNotes: [
      {"name": "Kem Kulfi Ấn Độ"},
      {"name": "Hoa Hồng"},
      {"name": "Nhũ hương (Mastic)"}
    ],
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Hổ phách tươi (Amber)"},
      {"name": "Cốt gỗ khô (Woody Notes)"}
    ],
    accords: [
...
Đi làm, meeting, ban ngày. Xịt 3 nhát cổ. Xuân thu đẹp nhất. Chai để hiểu vetiver GỐC là gì.`,
  ...
  },
  {
    ...
    score: {"scent":9.3,"uniqueness":8.5,"compliments":9.5,"value":8,"total":8.8},
    topNotes: [
      {"name": "Bưởi chùm (Grapefruit)"},
      {"name": "Bergamot"},
      {"name": "Hoa Nhài"}
    ],
    middleNotes: [
      {"name": "Gừng tự nhiên (Ginger)"},
      {"name": "Hương xanh cỏ mát (Green Notes)"},
      {"name": "Bột Phấn (Powdery Notes)"}
    ],
    baseNotes: [
      {"name": "Xạ hương nhung (Musk)"},
      {"name": "Gỗ tuyết tùng"},
      {"name": "Cỏ hương bài"}
    ],
    accords: [
...
Hằng ngày, đi làm, hẹn hò gần gũi. Xịt 3-4 nhát vì tỏa nhẹ. Đẹp quanh năm. Ở Sài Gòn dùng thoải mái.`,
...
},
  {
    ...
    score: {"scent":9.5,"uniqueness":9,"compliments":9,"value":7.5,"total":8.8},
    topNotes: [
      {"name": "Bưởi tây (Grapefruit)"},
      {"name": "Chanh đắng (Lime)"},
      {"name": "Lá bạc hà (Mint)"},
      {"name": "Cam đắng"}
    ],
    middleNotes: [
...
},
  {
    ...
    score: {"scent":8,"uniqueness":8.5,"compliments":8.5,"value":9.5,"total":8.6},
    topNotes: [
      {"name": "Vỏ Chanh (Lemon Zest)"},
      {"name": "Tinh dầu lá Chanh (Petitgrain)"}
    ],
    middleNotes: [
      {"name": "Gia vị cay (Spicy Notes)"}
    ],
    baseNotes: [
      {"name": "Ambroxan lạch cạch"},
      {"name": "Xạ Hương (Musk)"},
      {"name": "Hợp chất sấy Gỗ (Woody Notes)"}
    ],
    accords: [
...
},
  {
    ...
    topNotes: [
      ...
      {"name": "Hoa nhài Pháp"},
      {"name": "Ngọc lan tây (Ylang)"},
      {"name": "Lý chua đen"}
    ],
    middleNotes: [
      {"name": "Hoa Phong Lan Đen (Orchid)"},
      {"name": "Gia vị"},
      {"name": "Hoa sen"}
    ],
    baseNotes: [
      {"name": "Sôcôla đen (Dark Chocolate)"},
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Hương Nhang (Incense)"},
      {"name": "Vani"}
    ],
