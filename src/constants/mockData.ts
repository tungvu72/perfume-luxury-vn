...
Mọi lúc: đi làm, đi gym, đi chơi, hẹn hò casual. Xịt 3-4 nhát: cổ, ngực, cổ tay. Chai 4 mùa — ở Sài Gòn thì bạc hà-cam tươi trong nóng, ở Hà Nội thì đậu Tonka ấm trong lạnh. Đây là chai "main rotation" — xịt 5 ngày/tuần không ai phàn nàn, không bao giờ sai.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Hoa Cam (Orange Blossom)"},
      {"name": "Bạch đậu khấu (Cardamom)"},
      {"name": "Quả cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Vani Bourbon (Vanilla)"},
      {"name": "Nhựa hương Elemi"}
    ],
    baseNotes: [
...
Đi bar, đi event, tiệc tất niên, hoặc ở nhà cuối tuần trời lạnh. Xịt 2 nhát cổ và cổ tay là đủ. Trời Hà Nội tháng 12-1, mặc áo len, ngồi quán cà phê ban đêm — Angels' Share lúc đó đẹp không tả nổi. Ở Sài Gòn thì chỉ nên dùng khi máy lạnh mạnh hoặc đêm mát hiếm hoi.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":9,"compliments":9,"value":8.5,"total":9},
    topNotes: [
      {"name": "Gừng khô (Ginger)"},
      {"name": "Cam Bergamot"},
      {"name": "Tiêu hồng"},
      {"name": "Chanh vàng rực"}
    ],
...
Đi chơi tối, hẹn hò, bar, hoặc dịp muốn khác biệt với Boss thường. Xịt 2-3 nhát: cổ và ngực. Thu đông — Hà Nội tháng 10-2. Sài Gòn tối phòng điều hòa. Chai cho ai muốn thử "dark side" của Boss.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":9.5,"compliments":8.5,"value":8.5,"total":8.9},
    topNotes: [
      {"name": "Táo giòn (Apple)"},
...
Mùa đông, buổi tối, dịp đặc biệt, tiệc sang. Xịt 1-2 nhát — tỏa đẹp. Đẹp nhất khi trời lạnh. Ở Việt Nam dùng mùa lạnh Hà Nội hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":10,"value":9,"total":9.1},
    topNotes: [
      {"name": "Quả Dứa ngọt (Pineapple)"},
      {"name": "Bưởi Tây (Grapefruit)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
...
Đi tập gym, dạo phố, chạy bộ, hoặc ban ngày nóng. Xịt 3-4 nhát: cổ, ngực, cổ tay. Xuân hè — Sài Gòn quanh năm. Hà Nội tháng 3-10. Chai sporty sạch nhất dòng Dior Homme.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":15,"fall":30,"winter":30},
    dayNight: {"day":50,"night":50},
    ...
    middleNotes: [
      ...
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Rễ Hoa Diên Vĩ đỏ"}
    ],
    baseNotes: [
      {"name": "Vani đục (Vanilla)"},
      {"name": "Gỗ Đàn hương (Sandalwood)"},
      {"name": "Cỏ hương bài"}
    ],
    accords: [
...
Mùa thu đông, buổi tối, dịp đặc biệt, sự kiện VIP. Xịt 1-2 nhát — beast mode. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":40,"summer":35,"fall":15,"winter":10},
    dayNight: {"day":80,"night":20},
    ...
    score: {"scent":8.5,"uniqueness":8,"compliments":8.5,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Xạ Hương (Musk)"}
    ],
    middleNotes: [
...
Dùng hằng ngày — đi làm, đi học, đi cà phê, gặp gỡ. Xịt 2-3 nhát: cổ, cổ tay. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng rất thoải mái.`,
...
},
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":9,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Hoa Hồng Bulgary (Rose)"},
      {"name": "Hoa Cam (Orange Blossom)"}
    ],
    middleNotes: [
      {"name": "Xạ Hương (Musk)"}
...
},
  {
    ...
    score: {"scent":8.2,"uniqueness":7.5,"compliments":8.5,"value":8,"total":8},
    topNotes: [
      {"name": "Hoa trắng"},
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Tiêu hồng"}
...
Hằng ngày, đi làm, hẹn hò gần gũi. Xịt 3-4 nhát vì tỏa nhẹ. Đẹp quanh năm. Ở Sài Gòn dùng thoải mái.`,
...
},
  {
    ...
    name: "Pure XS",
    subName: "EDT",
    perfumer: "Anne Flipo, Caroline Dumur",
    year: 2017,
    gender: "nam",
    longevity: 7,
    sillage: 8,
    ...
    topNotes: [
      {"name": "Gừng cay (Ginger)"},
      {"name": "Cỏ Xạ hương"},
      {"name": "Bưởi tây"}
    ],
    middleNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Rượu Mùi (Liquor)"},
      {"name": "Quế (Cinnamon)"},
      {"name": "Da thuộc"},
      {"name": "Táo"}
    ],
