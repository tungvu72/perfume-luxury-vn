...
Mùa thu đông, buổi tối, hẹn hò, dịp ấm cúng. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất khi trời mát. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Quả Táo xanh (Apple)"},
      {"name": "Tiêu đen (Black Pepper)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Quế (Cinnamon)"},
      {"name": "Hạt Bạch đậu khấu (Cardamom)"},
...
Đi làm, gặp khách, đi ăn tối nhẹ hoặc dùng hằng ngày. Xịt 2-3 nhát: cổ, ngực, cổ tay. Dùng quanh năm nhưng đẹp nhất mùa thu đông. Ở Sài Gòn dùng trong phòng máy lạnh rất ổn. Đây là kiểu chai an toàn — xịt xong đi luôn, không cần nghĩ nhiều.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8.2,"value":8,"total":8.4},
    topNotes: [
      {"name": "Nhang hương (Incense)"}
    ],
    middleNotes: [
      {"name": "Nhựa thơm Myrrh"},
      {"name": "Davana"}
    ],
    baseNotes: [
...
Đi bar, nghe nhạc live, ngồi quán cocktail, hoặc ở nhà cuối tuần mở nhạc jazz. Xịt 3 nhát cổ và cổ tay. Đẹp nhất trời mát-lạnh: Hà Nội thu đông, Sài Gòn tối mát. Đây là chai để "sống" chứ không phải để khoe — xịt cho mình thưởng thức, không phải để ai khen.`,
  ...
  },
  {
    ...
    score: {"scent":8.2,"uniqueness":9,"compliments":8,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Hoa Cam (Orange Blossom)"},
...
Đi chơi tối, hẹn hò, đi bar, hoặc khi muốn mùi 90s nostalgia. Xịt 3 nhát: cổ, cổ tay, tóc. Thu đông nhẹ — Hà Nội tháng 10-3. Sài Gòn tối mát. Chai biểu tượng — mua vì chai cũng đáng.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":9.2,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Quả Lê (Pear)"}
    ],
    middleNotes: [
      {"name": "Cỏ hương bài (Vetiver)"},
      {"name": "Hương hoa cỏ (Floral Notes)"}
    ],
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Hổ phách (Amber)"},
...
Hẹn hò, đi chơi tối, tiệc, dịp đặc biệt. Xịt 2 nhát: cổ, cổ tay. Đẹp nhất thu đông, buổi tối. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Quả Lê (Pear)"}
    ],
    middleNotes: [
...
Đi chơi tối, hẹn hò, club, hoặc khi muốn mùi VANI BOMB. Xịt 2 nhát: cổ và cổ tay — Le Parfum tỏa mạnh. Thu đông — Hà Nội tháng 10-2. Sài Gòn tối phòng điều hòa. Chai rẻ nhất mà vani đậm nhất.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":20,"summer":60,"fall":15,"winter":5},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9.5,"value":8.5,"total":8.9},
    topNotes: [
      {"name": "Quả Dứa (Pineapple)"},
      {"name": "Hoa Diên Vĩ (Iris)"}
    ],
    middleNotes: [
      {"name": "Trái Dừa (Coconut)"},
      {"name": "Hương gỗ (Woody Notes)"}
    ],
    baseNotes: [
      {"name": "Đậu Tonka (Tonka Bean)"},
      {"name": "Đàn hương (Sandalwood)"}
    ],
    accords: [
...
Đi chơi tối, hẹn hò, du lịch, cuối tuần hoặc bất cứ lúc nào muốn mùi hương có tính vui và cuốn hút. Xịt 2-3 nhát: cổ và cổ tay. Đẹp nhất thu-đông hoặc tối hè. Ở Việt Nam hợp nhất buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    score: {"scent":8.5,"uniqueness":9.5,"compliments":8.5,"value":9,"total":8.8},
    topNotes: [
      {"name": "Bạc hà (Mint)"},
      {"name": "Hoa Oải hương (Lavender)"}
    ],
...
Thu đông, buổi tối, khi muốn mùi BÍ ẨN. Xịt 2-3 nhát: cổ và cổ tay. Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai dành cho ai muốn unique mà không phải trả giá niche.`,
  ...
  },
  {
    ...
    score: {"scent":8.5,"uniqueness":9,"compliments":8,"value":9,"total":8.5},
    topNotes: [
      {"name": "Quả Yuzu"},
      {"name": "Quả Chanh (Lemon)"},
      {"name": "Cỏ đuôi ngựa (Lemon Verbena)"}
...
Đêm đặc biệt, hẹn hò, phòng ngủ. Xịt 1 nhát GÓC CỔ — MỘT NHÁT thôi. Thu đông. Hà Nội tháng 11-2. Sài Gòn chỉ tối phòng điều hòa lạnh. Không phải hằng ngày.`,
  ...
  },
  {
    ...
    score: {"scent":9.5,"uniqueness":8.5,"compliments":9,"value":7.5,"total":8.8},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Cam Mandarin (Mandarin Orange)"}
    ],
    middleNotes: [
      {"name": "Nho chua (Black Currant)"},
      {"name": "Hoa Mộc lan (Magnolia)"}
    ],
    baseNotes: [
      {"name": "Xạ hương (Musk)"},
      {"name": "Đàn hương trắng (Sandalwood)"}
    ],
    accords: [
      {"name": "Cam chanh", "value": 100, "color": "#ffff00"},
...
Sự kiện đặc biệt, opera, gala. Dabbing 1-2 giọt sau tai. Mùa đông only. Chai museum-worthy.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":9.5,"compliments":9.5,"value":8,"total":9.1},
    topNotes: [
      {"name": "Rượu Rum"}
    ],
    middleNotes: [
    ...
    baseNotes: [
      {"name": "Nhụy hoa nghệ tây (Saffron)"},
      {"name": "Đàn hương (Sandalwood)"}
    ],
    accords: [
      {"name": "Cay ấm", "value": 100, "color": "#d2691e"},
