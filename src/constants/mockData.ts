...
Hẹn hò, tiệc, buổi tối, dịp đặc biệt. Xịt 2 nhát: cổ, cổ tay. Đẹp nhất thu đông. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
...

  {
    ...
    score: {"scent":9,"uniqueness":9.5,"compliments":8,"value":8,"total":8.6},
    topNotes: [
...
Đẹp nhất khi đi bar, đi tiệc hoặc hẹn hò cuối tuần — trời dưới 28°C. Xịt 1 nhát cổ, 1 nhát ngực là vừa. Thu đông là mùa Eros EDP tỏa đẹp nhất. Có thể dùng ban ngày nếu đi chơi hoặc event, nhưng không nên dùng đi làm trừ khi văn phòng rộng. Chai này sinh ra cho buổi tối.`,
  ...
  },
  {
    ...
    name: "Explorer EDP",
    subName: "EDP",
    perfumer: "J. G. Gillotin, O. Pescheux, A. Fernandez",
    year: 2019,
    gender: "nam",
    longevity: 6,
    sillage: 8,
    ...
    score: {"scent":8.5,"uniqueness":7,"compliments":9.5,"value":9.5,"total":8.6},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Tiêu hồng (Pink Pepper)"},
      {"name": "Cây đơn sâm (Clary Sage)"}
    ],
    middleNotes: [
      {"name": "Cỏ hương bài Haiti (Vetiver)"},
      {"name": "Da thuộc (Leather)"}
    ],
    baseNotes: [
      {"name": "Long diên hương (Ambroxan)"},
      {"name": "Gỗ Akigala"},
      {"name": "Lá hoắc hương Indo"}
    ],
    accords: [
      {"name": "Gỗ", "value": 100, "color": "#8b4513"},
...
Dùng hằng ngày — đi làm, đi học, đi cà phê, đi chơi. Xịt 3-4 nhát vì tỏa nhẹ. Dùng quanh năm nhưng đẹp nhất xuân hè. Ở Sài Gòn dùng rất thoải mái.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":35,"summer":25,"fall":30,"winter":10},
    ...
    score: {"scent":9.2,"uniqueness":10,"compliments":8.5,"value":8,"total":8.9},
    topNotes: [
      {"name": "Quả Quýt Tây (Mandarin)"},
      {"name": "Nhụy hoa nghệ tây (Saffron)"}
    ],
    middleNotes: [
      {"name": "Hoa Mộc Tê (Osmanthus)"},
      {"name": "Hương Khoáng (Mineral Notes)"}
    ],
    baseNotes: [
      {"name": "Da lộn (Suede)"},
      {"name": "Gỗ Akigala (Akigalawood)"}
    ],
    accords: [
...
Đi ăn tối, hẹn hò, sự kiện, hoặc khi muốn mùi NỮ 100%. Xịt 2-3 nhát: cổ và cổ tay. Thu đông — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai cho ai muốn feminine mà không basic.`,
  ...
  },
  {
    ...
    middleNotes: [
      {"name": "Nhựa Hổ Phách (Amberwood)"},
      {"name": "Hoa Hồng Ma Rốc"},
      {"name": "Hoa Nhài Ai Cập"}
    ],
    baseNotes: [
      {"name": "Vani (Vanilla)"},
      {"name": "Xạ hương trắng (Musk)"},
      {"name": "Gỗ Đàn hương (Sandalwood)"}
    ],
    accords: [
      {"name": "Gỗ", "value": 100, "color": "#8b4513"},
...
Dùng quanh năm — đi làm, gặp gỡ, tiệc, hẹn hò nhẹ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa xuân thu. Ở Sài Gòn dùng thoải mái vì floral sáng rất dễ chịu khi nóng.`,
  ...
  },
  {
    ...
    middleNotes: [
      {"name": "Rượu Rum"},
      {"name": "Dầu Cỏ hương bài (Vetiver)"}
    ],
    baseNotes: [
      {"name": "Lá Thuốc lá (Tobacco)"},
      {"name": "Vani (Vanilla)"},
      {"name": "Nhựa Styrax"}
    ],
    accords: [
...
Chiều tối, mùa mưa, trời mát, ngày xám, mood introvert. Xịt 2 nhát: cổ, ngực. Đẹp nhất mùa thu đông hoặc ngày mưa Sài Gòn. Đừng dùng đi tiệc hay hẹn hò lần đầu — quá tối.`,
...
},
  {
    ...
    score: {"scent":8,"uniqueness":7.5,"compliments":8.5,"value":7.5,"total":7.9},
    topNotes: [
      {"name": "Quả Mâm Xôi (Raspberry)"},
      {"name": "Quả Mơ (Apricot)"}
    ],
...
},
  {
    ...
    score: {"scent":8.8,"uniqueness":7.5,"compliments":9,"value":8,"total":8.3},
    topNotes: [
      {"name": "Quả Quýt (Mandarin Orange)"},
      {"name": "Bưởi Tây (Grapefruit)"},
      {"name": "Quả Đào (Peach)"},
      {"name": "Qủa Dứa (Pineapple)"}
    ],
    middleNotes: [
      {"name": "Hoa Nhài (Jasmine)"},
      {"name": "Hoa Ylang-Ylang"}
    ],
    baseNotes: [
      {"name": "Xạ hương trắng (White Musk)"},
      {"name": "Gỗ Tuyết Tùng"}
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":35,"summer":40,"fall":15,"winter":10},
    dayNight: {"day":65,"night":35},
    ...
    topNotes: [
      {"name": "Chanh vàng Sicily (Lemon)"},
      {"name": "Lý chua đen (Black Currant)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hương trái cây (Fruity Notes)"},
      {"name": "Lá hoắc hương"}
    ],
    baseNotes: [
      {"name": "Gỗ Tuyết Tùng (Cedar)"},
...
Hằng ngày, đi làm, hẹn hò gần gũi. Xịt 3-4 nhát vì tỏa nhẹ. Đẹp quanh năm. Ở Sài Gòn dùng thoải mái.`,
...
},
  {
    ...
    score: {"scent":9,"uniqueness":9,"compliments":8.8,"value":8,"total":8.7},
    topNotes: [
      {"name": "Đinh hương (Cloves)"},
      {"name": "Tiêu hồng"},
      {"name": "Hoa cam (Orange Blossom)"}
...
},
  {
    ...
    score: {"scent":8.5,"uniqueness":7.5,"compliments":8,"value":7,"total":7.8},
    topNotes: [
      {"name": "Lõi Andehit (Aldehydes)"},
      {"name": "Hoa Linh Lan Trắng (Lily-of-the-valley)"},
      {"name": "Quả Lê dập nát"}
    ],
    middleNotes: [
      {"name": "Hoa Hồng Thổ Nhĩ Kỳ (Rose)"},
      {"name": "Hoa Diên Vĩ (Iris)"}
    ],
    baseNotes: [
      {"name": "Xạ Hương Trắng (Musk)"},
