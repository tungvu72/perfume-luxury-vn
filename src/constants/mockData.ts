...
Quanh năm — đi làm, gặp gỡ, cà phê, dịp thanh lịch. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất xuân thu. Ở Sài Gòn dùng thoải mái quanh năm.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":9.5,"value":8,"total":8.8},
    topNotes: [
      {"name": "Quả Vải (Litchi)"},
...
Đi làm, gặp khách VIP, sự kiện, ban ngày. Xịt 2 nhát — tỏa rất mạnh. Đẹp nhất mùa xuân hè. Ở Sài Gòn dùng quanh năm. Perfect cho ai muốn mùi signature cao cấp.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":9.2,"compliments":8.5,"value":8.5,"total":8.8},
    topNotes: [
      {"name": "Lá Cây bách (Cypress)"},
      {"name": "Nhụy hoa Saffron"},
      {"name": "Bạch đậu khấu"}
    ],
    middleNotes: [
      {"name": "Hoa Hồng (Rose)"},
...
Đi cafe, đi shopping, gặp bạn bè, hẹn hò casual. Xịt 2-3 nhát cổ và cổ tay. Dùng quanh năm — ở Sài Gòn dùng thoải mái vì berry tươi sáng. Hà Nội mùa đông thì cashmeran-vani ấm lên đẹp. Chai này tỏa hương vui vẻ — ai đứng gần cũng thấy thoải mái.`,
  ...
  },
  {
    ...
    score: {"scent":9.2,"uniqueness":8.8,"compliments":9,"value":8.5,"total":8.9},
    topNotes: [
      {"name": "Quế (Cinnamon)"},
      {"name": "Tiêu đen (Pepper)"}
    ],
    middleNotes: [
      {"name": "Thuốc lá (Tobacco)"},
      {"name": "Nhang trầm (Incense)"},
...
Quanh năm — đi làm, gặp khách VIP, sự kiện, dạo phố. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất xuân hè. Chai signature cho CEO.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8.5,"compliments":8,"value":8.5,"total":8.4},
    topNotes: [
      {"name": "Hoa Cam (African Orange Blossom)"},
      {"name": "Quả Cam tươi"},
      {"name": "Cam quýt ngâm"}
    ],
    middleNotes: [
      {"name": "Hoa Diên Vĩ đỏ mọng (Iris)"},
      {"name": "Nhựa Galbanum xanh"}
    ],
    baseNotes: [
      {"name": "Bột Tuyết Tùng (Cedar)"},
      {"name": "Nhang trầm mảnh (Incense)"},
      {"name": "Nhựa Benzoin"}
    ],
    accords: [
...
Gần như mọi lúc ngoài đi biển: đi làm, đi chơi, gặp bạn, ăn tối. Xịt 2 nhát cổ và cổ tay là đủ. Dùng quanh năm — ở Sài Gòn và Hà Nội đều thoải mái. Mùa đông thì praline-vani tỏa đẹp hơn, mùa hè thì iris-lê tươi sáng hơn. Chai an toàn nhất cho ai chưa biết bắt đầu từ đâu.`,
  ...
  },
  {
    ...
    score: {"scent":9,"uniqueness":8.5,"compliments":10,"value":8.5,"total":9},
    topNotes: [
      {"name": "Táo xanh (Apple)"},
      {"name": "Oải hương (Lavender)"},
      {"name": "Cam Bergamot"},
...
Ban ngày xuân nhẹ, đi dạo, uống trà, khi muốn L'Heure Bleue mà không quá nặng. Xịt 3-4 nhát. Hà Nội tháng 3-5 và 9-11. Sài Gòn ban ngày phòng điều hòa.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":9.2,"value":8.5,"total":8.6},
    topNotes: [
      {"name": "Hoa Cam chát (Neroli)"},
      {"name": "Hạt tiêu đen"},
      {"name": "Bạch đậu khấu"}
    ],
    middleNotes: [
      {"name": "Hoa Diên Vĩ (Iris)"},
      {"name": "Hoa Phong lữ thảo"},
      {"name": "Hoa Tím Violet"}
    ],
    baseNotes: [
      {"name": "Hổ phách tươi (Amber)"},
      {"name": "Gỗ tuyết tùng (Cedar)"},
      {"name": "Hoắc hương sạch"}
    ],
    accords: [
...
Hằng ngày, đi làm, hẹn hò gần gũi. Xịt 3-4 nhát vì tỏa nhẹ. Đẹp quanh năm. Ở Sài Gòn dùng thoải mái.`,
...
},
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":35,"summer":15,"fall":30,"winter":20},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":8.5,"uniqueness":8.5,"compliments":8,"value":8,"total":8.2},
    topNotes: [
      {"name": "Quả Lê dập nát (Pear)"},
      {"name": "Quả Quýt (Mandarin)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
...
},
  {
    ...
    longevity: 9,
    sillage: 9,
    seasons: {"spring":35,"summer":30,"fall":20,"winter":15},
    dayNight: {"day":65,"night":35},
    ...
    score: {"scent":9.2,"uniqueness":8.8,"compliments":9.5,"value":8,"total":8.9},
    topNotes: [
      {"name": "Quả Cam ngọt"},
      {"name": "Lựu mọng chín"},
      {"name": "Aldehydes mạnh"}
    ...
    middleNotes: [
      {"name": "Cánh hoa hồng Pháp"},
      {"name": "Hoa huệ trắng (Tuberose)"},
      {"name": "Hoa cam (Orange Blossom)"}
    ],
    baseNotes: [
      {"name": "Ambroxan (Liều cao)"},
      {"name": "Hổ phách đậm"},
      {"name": "Xạ hương (Musk)"},
      {"name": "Gỗ trắng"}
    ],
