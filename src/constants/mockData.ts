...
Nên mua khi mày cần một chai signature cho buổi tối hoặc mùa mát. Nếu mày ghét mùi ngọt ấm, nên test kỹ trước khi chốt.`,
  ...
  },
  {
    ...
    perfumer: "BLOCKED_SOURCE",
    gender: "nam",
    image: "/images/products/louis-vuitton-imagination-main.webp",
    images: [{ url: "/images/products/louis-vuitton-imagination-main.webp", source: "amazon", caption: "LOUIS VUITTON Imagination chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Mùa thu đông, buổi tối, hẹn hò, đi chơi. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/louis-vuitton-limmensite-main.jpg", source: "amazon", caption: "LOUIS VUITTON L'Immensité chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
