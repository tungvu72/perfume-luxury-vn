...
Nếu cần một chai nước hoa nam an toàn nhưng vẫn đủ lịch sự và cuốn, Sauvage EDP là lựa chọn rất mạnh. Điểm yếu là quá nổi nên không hợp người sợ đụng hàng.`,
    ...
    seoTitle: "Dior Sauvage EDP chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Dior Sauvage EDP chính hãng: mùi sạch nam tính đa dụng, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Good Girl dễ nổi và dễ được nhớ. Điểm yếu là nó không quá tinh tế nếu xịt quá tay.`,
    ...
    seoTitle: "Good Girl chính hãng giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Good Girl chính hãng: mùi cà phê hoa trắng gợi cảm, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026 tại Maison De Son.",
...
La Vie Est Belle mạnh ở độ đại chúng và dễ dùng. Điểm yếu là không còn quá mới mẻ với người chơi lâu.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/valentino-born-in-roma-intense-main.jpg", source: "fragram", caption: "Valentino Donna Born in Roma Intense chính hãng", verified: true }
    ],
...
Điểm mạnh của chai này là dễ thấy đẹp và khá hợp xu hướng hiện tại. Điểm yếu là chưa phải kiểu quá riêng nếu so với nhiều chai niche.`,
    ...
    seoTitle: "Valentino Donna Born In Roma Intense giá bao nhiêu? Review",
    metaDescription: "Đánh giá Valentino Donna Born In Roma Intense chính hãng: mùi vanilla jasmine quyến rũ, độ lưu hương, độ tỏa hương và giá tham khảo 2026.",
...
Nếu bạn muốn một chai nước hoa nữ sang, trưởng thành, dễ dùng và có độ cuốn rất ổn mà không cần quá phô trương, Giorgio Armani Sì EDP là lựa chọn rất đáng cân nhắc. Nó không phải kiểu gây sốc ngay lập tức, nhưng lại là kiểu càng dùng càng thấy hợp lý, đẹp và khó lỗi thời.`,
    ...
    seoTitle: "Armani Si EDP chính hãng giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Armani Si EDP chính hãng: mùi lý chua đen vanilla thanh lịch, độ lưu hương, độ tỏa hương và giá tham khảo 2026 tại Maison De Son.",
    tags: ["nu","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Nên mua khi mày cần một chai mùa nóng dùng nhiều. Nếu mày thích mùi tối, dày hoặc quá cá tính, đây không phải hướng ưu tiên.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/dg-the-one-for-men-eau-de-parfum-main.jpg", source: "amazon", caption: "DOLCE & GABBANA The One for Men Eau de Parfum chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
...
Nên mua khi mày đã có ít nhất một chai fresh hoặc văn phòng, và đang cần một option tối hơn cho hẹn hò hay đi chơi tối. Không nên ưu tiên nó làm chai duy nhất nếu nhu cầu chính là đi làm mỗi ngày giữa thời tiết nóng.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/chanel-no-5-eau-de-parfum-main.jpg", source: "amazon", caption: "CHANEL Chanel No 5 Eau de Parfum chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
