...
The One EDP đẹp vì nó biết tiết chế. Điểm yếu là hiệu năng không phải thế mạnh lớn nhất.`,
    ...
    seoTitle: "The One EDP chính hãng giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá The One EDP chính hãng: mùi ấm gia vị lịch lãm, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026 tại Maison De Son.",
...
Nếu bạn đang tìm một chai nước hoa nữ tươi, nhẹ, sạch và dễ dùng hằng ngày, Versace Bright Crystal EDT là lựa chọn rất hợp lý. Nó không quá cá tính, nhưng chính sự dễ chịu, nữ tính và an toàn đẹp của nó khiến chai này luôn có chỗ đứng ổn định.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/dolce-gabbana-light-blue-pour-femme-main.jpg", source: "fragram", caption: "Dolce & Gabbana Light Blue Eau de Toilette chính hãng", verified: true }
    ],
    description: "Phi�n b?n dang du?c b? sung nhanh v�o catalog Maison de SON d? ho�n thi?n thu vi?n s?n ph?m live.",
...
Nếu bạn cần một chai nước hoa nữ tươi, sạch, dễ dùng và đặc biệt hợp mùa nóng, D&G Light Blue Pour Femme là lựa chọn rất đáng tin cậy. Nó không phải kiểu để gây choáng ngợp, nhưng lại là kiểu thơm lâu dài theo nghĩa rất thực tế: lúc nào cần cũng cầm lên dùng được và hiếm khi sai hoàn cảnh.`,
    ...
    seoTitle: "Light Blue Pour Femme giá bao nhiêu? Review mùi hương 2026",
    metaDescription: "Đánh giá Light Blue Pour Femme chính hãng: mùi cam chanh biển mát, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
    tags: ["nu","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Nên mua khi mày muốn một chai tối, lạnh, có statement rõ. Nếu mày cần mùi nữ hiện đại, sáng và dễ dùng mỗi ngày, Opium sẽ không phải lựa chọn đầu tiên.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/ysl-black-opium-le-parfum-main.jpg", source: "amazon", caption: "YVES SAINT LAURENT Black Opium Le Parfum chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Dùng được quanh năm — đi làm, đi cà phê, gặp gỡ, đi tiệc nhẹ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa xuân hè khi trời ấm. Ở Sài Gòn dùng thoải mái vì rất nhẹ nhàng. Đây là kiểu chai phụ nữ nào dùng cũng thấy hợp — tinh tế, thanh lịch và rất ladylike.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/tom-ford-black-orchid-main.jpg", source: "amazon", caption: "TOM FORD Black Orchid chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
    verdict: "(Chờ nguồn xác minh)",
