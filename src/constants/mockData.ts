...
Mùa thu đông, buổi tối, hẹn hò, gặp gỡ. Xịt 2-3 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng buổi tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/parfums-de-marly-carlisle-main.jpg", source: "amazon", caption: "PARFUMS DE MARLY Carlisle chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai buổi sáng thật đẹp. Nếu mày muốn hiệu năng mạnh hoặc vibe hiện đại hơn, nên cân nhắc hướng khác.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/parfums-de-marly-sedley-main.jpg", source: "amazon", caption: "PARFUMS DE MARLY Sedley chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
