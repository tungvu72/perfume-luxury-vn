...
Đi ăn trưa sang, dạo phố, gặp bạn bè, hoặc mùa xuân. Xịt 2-3 nhát: cổ và cổ tay. Xuân là đẹp nhất — mimosa nở vào xuân. Hà Nội tháng 3-5. Sài Gòn dùng ban ngày phòng điều hòa. Chai cho ai yêu Paris và phong cách Pháp thật sự.`,
  ...
  },
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":70,"summer":20,"fall":8,"winter":2},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":8.2,"uniqueness":7,"compliments":7,"value":8.2,"total":7.7},
    topNotes: [
      {"name": "Quả bưởi (Grapefruit)"},
      {"name": "Mộc qua (Quince)"}
    ],
    middleNotes: [
      {"name": "Hoa hồng (Rose)"},
...
Dùng được quanh năm — đi làm, đi chơi, gặp gỡ. Đẹp nhất ban ngày và trời ấm (25-32°C). Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Tỏa rất mạnh nên đừng xịt quá nhiều trong phòng kín. Mùa xuân và hè là lúc CDNIM tỏa đẹp nhất. Buổi tối cũng OK nhưng không đẹp bằng ban ngày.`,
  ...
  },
  {
    ...
    longevity: 10,
    sillage: 8,
    seasons: {"spring":8,"summer":2,"fall":35,"winter":55},
    dayNight: {"day":20,"night":80},
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":8.5,"value":8.4,"total":8.4},
    topNotes: [
      {"name": "Rau mùi (Coriander)"},
      {"name": "Hoa hồng (Bulgarian Rose)"},
      {"name": "Đào (Peach)"},
      {"name": "Nhài (Jasmine)"},
      {"name": "Quýt (Mandarin)"}
    ],
    middleNotes: [
      {"name": "Đinh hương (Cloves)"},
      {"name": "Hoa hồng (Rose)"},
      {"name": "Hoa cam (Orange Blossom)"},
      {"name": "Hoa trinh nữ (Mimosa)"}
    ],
    baseNotes: [
      {"name": "Hổ phách (Amber)"},
      {"name": "Gỗ đàn hương (Sandalwood)"},
      {"name": "Đậu Tonka"},
      {"name": "Hương bài (Civet)"},
      {"name": "Nhựa Opoponax"}
    ],
    accords: [
...
Sự kiện trang trọng, opera, tiệc tối, hoặc khi muốn MÙI HƯƠNG CÓ TRỌNG LƯỢNG. Xịt 2 nhát: cổ và cổ tay — EDP mạnh. Thu đông đẹp nhất. Hà Nội tháng 10-2. Sài Gòn tối máy lạnh. Chai dành cho phụ nữ biết mình muốn gì.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 6,
    seasons: {"spring":10,"summer":5,"fall":40,"winter":45},
    dayNight: {"day":30,"night":70},
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":7,"value":8.4,"total":7.9},
    topNotes: [
      {"name": "Rau mùi (Coriander)"},
      {"name": "Quýt (Mandarin Orange)"},
      {"name": "Đào (Peach)"},
      {"name": "Nhài (Jasmine)"}
    ],
    middleNotes: [
...
Ban ngày thu nhẹ, đi ăn trưa, hoặc khi muốn Coco mà không quá nặng. Xịt 3-4 nhát vì EDT nhẹ: cổ, ngực, cổ tay. Dùng thu đông — Hà Nội tháng 10-3. Sài Gòn ban ngày phòng điều hòa. Nếu chưa thử Coco, nên bắt đầu từ EDT rồi quyết EDP sau.`,
  ...
  },
  {
    ...
    longevity: 9,
    sillage: 8,
    seasons: {"spring":35,"summer":20,"fall":30,"winter":15},
    ...
    middleNotes: [
      {"name": "Hồng Thổ Nhĩ Kỳ"},
      {"name": "Hoa nhài (Jasmine)"},
      {"name": "Hoa trinh nữ"},
      {"name": "Ngọc lan tây (Ylang-Ylang)"}
    ],
    baseNotes: [
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Xạ hương trắng"},
      {"name": "Hương thảo (Vetiver)"},
      {"name": "Vani (Vanilla)"}
    ],
    accords: [
...
Đẹp nhất khi đi làm, gặp khách hàng, dự tiệc nhẹ hoặc đi ăn tối. Xịt 1 nhát sau gáy, 1 nhát cổ tay là đủ — tỏa khá mạnh trong 3-4 giờ đầu. Dùng quanh năm được, nhưng đẹp nhất vào mùa thu đông hoặc những ngày Sài Gòn mát mẻ. Đừng xịt quá nhiều vào ngày nóng 35°C vì citrus + patchouli khi nóng sẽ hơi nồng.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 6,
    seasons: {"spring":15,"summer":5,"fall":45,"winter":35},
    dayNight: {"day":15,"night":85},
...
Ban ngày mùa nóng — đi làm, đi học, đi biển, tập gym nhẹ. Xịt 4-5 nhát thoải mái vì mùi nhẹ. Đẹp nhất khi trời 30-36°C. Ở Sài Gòn dùng quanh năm được. Đừng dùng cho hẹn hò buổi tối — quá nhẹ và quá casual.`,
  ...
  },
  {
    ...
    score: {"scent":8.8,"uniqueness":8,"compliments":8.5,"value":8.8,"total":8.6},
    topNotes: [
      {"name": "Cam đắng (Bitter Orange)"},
      {"name": "Tinh dầu hoa cam (Neroli)"},
      {"name": "Hương cam chanh"}
    ],
    middleNotes: [
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Rễ diên vĩ (Orris)"},
      {"name": "Hoa hồng (Rose)"},
      {"name": "Hoa nhài"}
    ],
    baseNotes: [
      {"name": "Sôcôla trắng (White Chocolate)"},
      {"name": "Nhựa Benzoin"},
      {"name": "Hổ phách (Amber)"},
      {"name": "Nhũ hương (Olibanum)"}
    ],
...
Đi làm, ăn tối, sự kiện cần sự nghiêm túc. Xịt 2 nhát cổ — Parfum mạnh. Thu đông tuyệt vời — Hà Nội tháng 10-2. Sài Gòn tối điều hòa. Chai cho quý ông thật sự.`,
  ...
  },
  {
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":8.5,"value":8.4,"total":8.4},
    topNotes: [
      {"name": "Gỗ cẩm lai (Brazilian Rosewood)"},
      {"name": "Rau mùi (Coriander)"},
      {"name": "Quýt Sicilian"},
      {"name": "Gỗ đào dái (Mahogany)"}
    ],
    middleNotes: [
      {"name": "Quế (Cinnamon)"},
      {"name": "Hồng Damask (Damask Rose)"},
      {"name": "Hoa cẩm chướng (Carnation)"}
    ],
    baseNotes: [
      {"name": "Gỗ đàn hương (Sandalwood)"},
      {"name": "Thuốc lá (Tobacco)"},
      {"name": "Vani (Vanilla)"},
...
Đi làm, ăn tối nhẹ, đọc sách, hoặc khi muốn thời gian cho bản thân. Xịt 3 nhát: cổ, ngực, cổ tay. Thu đông đẹp nhất — Hà Nội tháng 10-3. Sài Gòn tối phòng điều hòa. Chai cho người đã tìm được chính mình.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":40,"summer":40,"fall":15,"winter":5},
    dayNight: {"day":85,"night":15},
    ...
    score: {"scent":8.6,"uniqueness":7,"compliments":7,"value":8.6,"total":7.9},
    topNotes: [
      {"name": "Oải hương (Lavender)"},
      {"name": "Hương thảo (Rosemary)"},
      {"name": "Tinh dầu hoa cam (Neroli)"},
      {"name": "Lá cam (Petitgrain)"}
    ],
    middleNotes: [
      {"name": "Hoa phong lữ (Geranium)"},
      {"name": "Xô thơm (Clary Sage)"},
      {"name": "Nhựa Galbanum"},
      {"name": "Nhài (Jasmine)"}
    ],
    baseNotes: [
      {"name": "Rêu sồi (Oakmoss)"},
      {"name": "Hương bài (Vetiver)"},
      {"name": "Gỗ tuyết tùng (Cedar)"},
      {"name": "Đàn hương"}
    ],
    accords: [
...
Mọi lúc — đi làm, cuối tuần, ngủ, hoặc khi cần bình yên. Xịt 3-4 nhát cả cổ và ngực, gần da. Dùng quanh năm. Chai comfort niche đắt nhưng xứng.`,
  ...
  },
  {
    ...
    longevity: 5,
    sillage: 6,
    seasons: {"spring":60,"summer":30,"fall":8,"winter":2},
    dayNight: {"day":90,"night":10},
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":7,"value":8.2,"total":7.8},
    topNotes: [
      {"name": "Nhựa Galbanum"},
      {"name": "Lục bình (Hyacinth)"},
      {"name": "Cam Bergamot"},
      {"name": "Neroli"}
    ],
    middleNotes: [
      {"name": "Hoa diên vĩ (Iris)"},
      {"name": "Rễ diên vĩ (Orris Root)"},
      {"name": "Hoa linh lan (Lily-of-the-Valley)"},
      {"name": "Hoa hồng"}
    ],
    baseNotes: [
      {"name": "Rêu sồi (Oakmoss)"},
      {"name": "Cỏ hương bài (Vetiver)"},
      {"name": "Da thuộc (Leather)"},
      {"name": "Gỗ tuyết tùng (Cedar)"},
      {"name": "Xạ hương"}
    ],
...
Mùa thu đông, buổi tối, hẹn hò, dịp đặc biệt. Xịt 1-2 nhát — beast mode. Đẹp nhất khi trời lạnh. Ở Việt Nam hợp mùa đông Hà Nội nhất.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 6,
    seasons: {"spring":60,"summer":15,"fall":15,"winter":10},
    dayNight: {"day":80,"night":20},
