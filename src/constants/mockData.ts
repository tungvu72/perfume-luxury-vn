...
Đi ăn brunch, đi uống cà phê, gặp bạn bè, hoặc đi chùa. Xịt 2-3 nhát cổ tay và sau cổ. Đẹp nhất vào buổi sáng trời mát, khi hoa trắng tỏa tự nhiên nhất. Ở Sài Gòn dùng trong phòng máy lạnh hoặc buổi tối. Hà Nội thì xuân thu là lý tưởng.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":30,"summer":25,"fall":30,"winter":15},
    ...
    score: {"scent":8.4,"uniqueness":7.5,"compliments":9,"value":8.4,"total":8.5},
    topNotes: [
      {"name": "Húng quế (Basil)"},
      {"name": "Tiêu nước Timur (Timur Pepper)"}
    ],
    middleNotes: [
      {"name": "Hương gỗ (Woody Notes)"},
      {"name": "Cỏ hương bài Haiti (Haitian Vetiver)"}
    ],
    baseNotes: [
      {"name": "Gỗ Akigalawood"},
      {"name": "Ambroxan"},
...
Mùa thu đông, buổi tối, dịp đặc biệt, tiệc sang. Xịt 2 nhát: cổ, ngực. Đẹp nhất khi trời mát. Ở Sài Gòn dùng tối hoặc phòng máy lạnh.`,
  ...
  },
  {
    ...
    longevity: 8,
    sillage: 8,
    seasons: {"spring":40,"summer":40,"fall":10,"winter":10},
    dayNight: {"day":50,"night":50},
    ...
    score: {"scent":8.4,"uniqueness":9,"compliments":8,"value":8.4,"total":8.5},
    topNotes: [
      {"name": "Bạch đàn (Eucalyptus)"},
      {"name": "Dưa lưới (Melon)"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa huệ trắng (Tuberose)"},
      {"name": "Hoa ngọc lan tây (Ylang-Ylang)"},
      {"name": "Hoa nhài (Jasmine)"}
    ],
    baseNotes: [
      {"name": "Quả dừa (Coconut)"},
      {"name": "Xạ hương trắng (White Musk)"},
      {"name": "Hoa cam tami (Orange Blossom Absolute)"}
    ],
    accords: [
      {"name": "Gỗ", "value": 100, "color": "#8b4513"},
...
Những ngày muốn tự thưởng cho mình — đi cà phê một mình, đọc sách, hoặc hẹn hò nhẹ nhàng. Xịt 2 nhát: cổ tay và sau cổ. Vì extrait, ít thôi là đủ. Đẹp nhất trời mát — Hà Nội thu đông, Sài Gòn tối mát hoặc phòng máy lạnh. Không hợp đi dã ngoại hay nhậu nhẹt — chai này cần không gian yên tĩnh để thưởng thức.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":10,"summer":5,"fall":35,"winter":50},
    dayNight: {"day":30,"night":70},
    ...
    score: {"scent":8.2,"uniqueness":7,"compliments":8.5,"value":8.2,"total":8.1},
    topNotes: [
      {"name": "Quả mận (Plum)"},
...
Dịp đặc biệt — tiệc tối, sự kiện, mùa đông lạnh. Xịt 1 nhát duy nhất ở ngực — đủ rồi. Đẹp nhất khi trời dưới 20°C. Ở Việt Nam dùng mùa lạnh Hà Nội hoặc phòng máy lạnh rất mạnh. Đừng bao giờ xịt 3 nhát đi ăn trưa.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":40,"summer":25,"fall":20,"winter":15},
    dayNight: {"day":55,"night":45},
    ...
    score: {"scent":7.6,"uniqueness":6,"compliments":8.5,"value":7.6,"total":7.5},
    topNotes: [
      {"name": "Quả lê (Pear)"},
      {"name": "Dưa lưới (Melon)"},
      {"name": "Quả đào (Peach)"}
...
Quanh năm — đi làm, hẹn hò, gặp gỡ, dạo phố. Xịt 2 nhát — tỏa mạnh. Đẹp nhất thu đông nhưng dùng quanh năm vì lavender sáng. Ở Sài Gòn dùng thoải mái vì opening tươi.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":40,"summer":10,"fall":30,"winter":20},
    ...
    topNotes: [
      {"name": "Hoa cam Châu Phi (African Orange Flower)"}
    ],
    middleNotes: [
      {"name": "Hoa nhài (Jasmine)"}
    ],
    baseNotes: [
      {"name": "Mật ong trắng (White Honey)"},
      {"name": "Hoắc hương (Patchouli)"},
      {"name": "Hoa hồng (Rose)"},
      {"name": "Gỗ tuyết tùng (Virginia Cedar)"}
    ],
    accords: [
      {"name": "Hoa trắng", "value": 100, "color": "#fffaf0"},
...
Sự kiện đặc biệt, đêm mùa đông, hoặc khi muốn STATEMENT. Xịt 1-2 nhát cổ — Le Parfum cực mạnh. Hà Nội tháng 11-2. Sài Gòn chỉ tối phòng điều hòa mạnh. Chai artillery, không phải hằng ngày.`,
...
},
  {
    ...
    longevity: 6,
    sillage: 6,
    seasons: {"spring":20,"summer":60,"fall":10,"winter":10},
    dayNight: {"day":80,"night":20},
    ...
    score: {"scent":7.8,"uniqueness":6,"compliments":8,"value":7.8,"total":7.6},
    topNotes: [
      {"name": "Chanh Sicilia (Lemon)"},
      {"name": "Táo xanh (Apple)"},
      {"name": "Gỗ tuyết tùng (Cedar)"},
      {"name": "Hoa chuông (Bellflower)"}
    ],
    middleNotes: [
      {"name": "Tre (Bamboo)"},
      {"name": "Hoa nhài (Jasmine)"},
...
Đi ăn tối, hẹn hò, bar, dự tiệc hoặc dịp cần hình ảnh trưởng thành. Xịt 2 nhát: 1 cổ, 1 cổ tay — vì tỏa mạnh. Đẹp nhất trời mát, mùa đông hoặc buổi tối. Ở Sài Gòn dùng buổi tối ngoài trời hoặc phòng máy lạnh. Đừng dùng đi làm ban ngày — quá tối và quá nặng.`,
  ...
  },
  {
    ...
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Quýt Mandarin (Mandarin Orange)"}
    ],
    middleNotes: [
      {"name": "Hoa hồng (Rose)"},
      {"name": "Hoắc hương (Patchouli)"}
...
Đêm đặc biệt, hẹn hò, sự kiện tối. Xịt 2 nhát cổ. Thu đông. Chai collector — tìm được thì giữ.`,
  ...
  },
  {
    ...
    longevity: 5,
    sillage: 6,
    seasons: {"spring":55,"summer":25,"fall":12,"winter":8},
    dayNight: {"day":80,"night":20},
...
Đi làm, đi học, đi cà phê, gặp gỡ ban ngày. Xịt 3-4 nhát: cổ, sau tai, cổ tay, tóc — vì EDT bay nhanh nên cần xịt nhiều hơn EDP. Dùng quanh năm nhưng đẹp nhất mùa xuân và hè khi trời ấm. Ở Sài Gòn dùng rất thoải mái vì không bao giờ ngọp. Đây là kiểu chai thơm nhẹ cho mọi ngày — tinh tế và dễ chịu.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":30,"summer":15,"fall":30,"winter":25},
    ...
    score: {"scent":8.2,"uniqueness":8,"compliments":8.5,"value":8.2,"total":8.3},
    topNotes: [
      {"name": "Quýt Mandarin"},
...
Đi làm ở văn phòng sang, ăn tối nhẹ nhàng, gặp khách hàng, hoặc bất cứ khi nào cần "có mùi" mà không muốn nổi bật. Xịt 3 nhát: cổ, ngực, cổ tay — vì tỏa nhẹ. Dùng quanh năm nhưng đẹp nhất thu đông. Ở Sài Gòn dùng thoải mái vì rất nhẹ. Hà Nội mùa đông thì bạch đậu khấu và gỗ ấm lên đẹp.`,
...
},
  {
    ...
    score: {"scent":7.8,"uniqueness":8,"compliments":8.5,"value":7.8,"total":8.1},
    topNotes: [
      {"name": "Quả mận (Plum)"},
      {"name": "Rau mùi (Coriander)"},
      {"name": "Quả rừng (Forest Fruits)"}
    ],
    middleNotes: [
      {"name": "Tuberose"},
      {"name": "Trầm hương (Incense)"},
      {"name": "Mật ong (Honey)"},
      {"name": "Quế (Cinnamon)"}
    ],
    baseNotes: [
...
Mọi lúc — đi làm, cuối tuần, ngủ. Xịt 3-4 nhát. Quanh năm. Chai để luôn có sẵn.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":35,"summer":15,"fall":25,"winter":25},
    dayNight: {"day":55,"night":45},
...
Thiền, yoga, sự kiện tối, hoặc khi muốn inner peace mùi hương. Xịt 2 nhát cổ. Thu đông. Chai cho ai hiểu spirituality.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":25,"summer":20,"fall":30,"winter":25},
    dayNight: {"day":45,"night":55},
    ...
    score: {"scent":8.4,"uniqueness":6,"compliments":8.5,"value":8.4,"total":8},
    topNotes: [
      {"name": "Cam Bergamot"},
      {"name": "Tiêu Tứ Xuyên (Sichuan Pepper)"}
    ],
    middleNotes: [
      {"name": "Oải hương (Lavender)"},
      {"name": "Đại hồi (Star Anise)"},
      {"name": "Nhục đậu khấu (Nutmeg)"}
    ],
    baseNotes: [
      {"name": "Ambroxan"},
      {"name": "Vani (Vanilla)"}
...
Dùng được quanh năm — đi làm, đi chơi, hẹn hò, gặp gỡ. Xịt 2-3 nhát: 1 sau gáy, 1 trước ngực, 1 cổ tay. Đẹp nhất mùa xuân thu khi trời mát. Ở Sài Gòn dùng ban ngày trong phòng máy lạnh rất thoải mái. Buổi tối cũng OK nhưng không đẹp bằng Elixir. Đây là kiểu chai xịt xong đi luôn — gần như không bao giờ sai.`,
  ...
  },
  {
    ...
    score: {"scent":8.6,"uniqueness":7,"compliments":8.5,"value":8.6,"total":8.3},
    topNotes: [
      {"name": "Oải hương (Lavender)"},
      {"name": "Cam thảo (Licorice)"},
      {"name": "Nhục đậu khấu (Nutmeg)"},
...
Hẹn hò buổi tối, đi bar, đi ăn nhà hàng hoặc những dịp muốn gây ấn tượng. Xịt 1-2 nhát thôi: 1 sau gáy và 1 cổ — vì tỏa rất mạnh. Đẹp nhất khi trời mát dưới 25°C. Mùa đông Hà Nội hoặc mùa mưa Sài Gòn là lúc chai này tỏa đẹp nhất. Đừng dùng đi gym hay đi làm ban ngày.`,
  ...
  },
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":15,"summer":5,"fall":40,"winter":40},
    dayNight: {"day":40,"night":60},
    ...
    score: {"scent":7.6,"uniqueness":6,"compliments":8.5,"value":7.6,"total":7.6},
    topNotes: [
      {"name": "Quả đào (Peach)"},
      {"name": "Vải thiều (Litchi)"},
      {"name": "Quýt Mandarin"},
      {"name": "Cam Bergamot"}
    ],
    middleNotes: [
      {"name": "Hoa bách hợp (Lily)"},
      {"name": "Qủa mận (Plum)"},
      {"name": "Hoa nhài (Jasmine)"},
      {"name": "Hoa linh lan"}
    ],
...
},
  {
    ...
    score: {"scent":9,"uniqueness":7,"compliments":8.5,"value":9,"total":8.6},
    topNotes: [
      {"name": "Bưởi tây (Grapefruit)"},
      {"name": "Rau mùi (Coriander)"},
      {"name": "Húng quế (Basil)"}
    ],
    middleNotes: [
...
Gần như mọi nơi trừ chỗ cần kín đáo: đi làm, đi event, gặp đối tác, hẹn hò. Xịt 2-3 nhát cổ và ngực. Aventus tỏa rất mạnh 2 giờ đầu rồi lắng xuống thành skin scent gỗ-rêu sồi. Dùng quanh năm — Sài Gòn thì dứa-cam mở ra tươi, Hà Nội mùa đông thì bạch dương-rêu sồi ấm. Chai mà mặc vest hay jeans đều hợp.`,
...
},
  {
    ...
    score: {"scent":7.8,"uniqueness":7,"compliments":7,"value":7.8,"total":7.5},
    topNotes: [
      {"name": "Hương biển (Sea Notes)"},
      {"name": "Dương xỉ (Fern)"},
      {"name": "Quýt Mandarin"},
      {"name": "Cây xô thơm (Clary Sage)"}
    ],
    middleNotes: [
      {"name": "Trà trắng (White Tea)"},
      {"name": "Iris (Diên vĩ)"},
      {"name": "Trà Mate"}
    ],
    baseNotes: [
      {"name": "Hạt Ambrette"},
      {"name": "Hương gỗ đỏ (Exotic Woods)"},
      {"name": "Đậu Tonka"},
      {"name": "Hổ phách"}
    ],
    accords: [
...
},
  {
    ...
    longevity: 7,
    sillage: 8,
    seasons: {"spring":45,"summer":45,"fall":5,"winter":5},
    dayNight: {"day":80,"night":20},
    ...
    score: {"scent":8.2,"uniqueness":8.5,"compliments":8,"value":8.2,"total":8.2},
    topNotes: [
      {"name": "Hương nước (Water Notes)"},
      {"name": "Quả lê Nashi (Nashi Pear)"},
      {"name": "Đại hoàng (Rhubarb)"},
      {"name": "Sen (Lotus)"}
    ],
    middleNotes: [
      {"name": "Hoa mộc lan (Magnolia)"},
...
},
  {
    ...
    score: {"scent":8.4,"uniqueness":8,"compliments":9,"value":8.4,"total":8.5},
    topNotes: [
      {"name": "Quả lê (Pear)"},
      {"name": "Cam Bergamot"},
      {"name": "Quýt Mandarin"},
