...
Điểm mạnh của chai này là hiệu quả thực chiến cao. Điểm yếu là không quá lạ và hơi đụng hàng trong nhóm nam trẻ.`,
    ...
    seoTitle: "Azzaro The Most Wanted Parfum giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Azzaro The Most Wanted Parfum chính hãng: mùi ngọt ấm dễ gây chú ý, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Carbon sống rất dễ trong đời thường. Điểm yếu là thiếu độ wow nếu bạn thích mùi gây ấn tượng mạnh từ đầu.`,
    ...
    seoTitle: "Prada Luna Rossa Carbon giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Prada Luna Rossa Carbon chính hãng: mùi sạch hiện đại nam tính, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
...
Nếu bạn đang tìm một chai nước hoa nữ nhẹ, thanh lịch và mang tinh thần “clean floral” dễ dùng, Miss Dior Blooming Bouquet là lựa chọn rất đáng yêu. Nó không quá kịch tính, nhưng lại có sức hút của sự tinh tế và dịu dàng mà nhiều người rất khó chê.`,
    ...
    seoTitle: "Miss Dior Blooming Bouquet giá bao nhiêu? Review 2026",
    metaDescription: "Đánh giá Miss Dior Blooming Bouquet chính hãng: mùi hoa nhẹ tươi nữ tính, độ lưu hương, độ tỏa hương, ai nên dùng và giá tham khảo 2026.",
    tags: ["nu","Catalog","Live","2026"],
    sizes: ["10ml Chi?t","50ml Fullbox","100ml Fullbox"],
    basePrice: 1990000,
    shopeeOffers: []
...
Nên mua khi mày cần một chai tối có khí chất riêng. Nếu mày mê đúng DNA khô và sắc của Fahrenheit EDT, nên giữ kỳ vọng đúng trước khi mua.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/armani-code-parfum-main.jpg", source: "amazon", caption: "GIORGIO ARMANI Code Parfum chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
