...
Dùng quanh năm — đi làm, gặp gỡ, cà phê, hẹn hò nhẹ. Xịt 2-3 nhát: cổ, cổ tay. Đẹp nhất thu đông. Ở Sài Gòn dùng thoải mái vì lavender giúp mùi sáng hơn.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/guerlain-mon-guerlain-intense-main.jpg", source: "amazon", caption: "GUERLAIN Mon Guerlain Intense chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nếu bạn muốn một chai nước hoa nữ ngọt hoa hiện đại, lãng mạn và có khả năng tạo thiện cảm cao, YSL Mon Paris là lựa chọn rất dễ yêu. Nó không quá niche hay quá nghệ, nhưng lại làm rất tốt vai trò của một mùi hương hẹn hò nữ tính và cuốn hút.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/frederic-malle-musc-ravageur-main.jpg", source: "amazon", caption: "FRÉDÉRIC MALLE Musc Ravageur chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
...
Nên mua khi mày cần một chai tối đặc biệt cho hẹn hò hoặc dịp riêng tư. Nếu mày cần mùi đi làm sáng sạch, đây không phải hướng phù hợp.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/initio-musk-therapy-main.jpg", source: "amazon", caption: "INITIO PARFUMS PRIVÉS Musk Therapy chính hãng", verified: true }
    ],
    description: "(Chờ nguồn xác minh)",
    productCopy: "(Chờ Coder viết bài)",
    article: "(Chờ Coder viết bài)",
