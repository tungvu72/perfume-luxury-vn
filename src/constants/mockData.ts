...
Dùng quanh năm — đi làm, đi ăn tối nhẹ, gặp gỡ, tiệc nhỏ. Xịt 2-3 nhát: cổ, cổ tay, sau tai. Đẹp nhất mùa thu đông nhưng xuân hè vẫn OK. Ở Sài Gòn dùng thoải mái vì cân bằng tốt.`,
  ...
  },
  {
    ...
    images: [
      { url: "/images/products/chanel-allure-homme-edition-blanche-main.webp", source: "amazon", caption: "Ảnh chai Chanel Allure Homme Édition Blanche" },
      { url: "/images/products/chanel-allure-edition-blanche-bottle.jpg", source: "studio", caption: "Ảnh chi tiết Chanel Allure Homme Édition Blanche" }
    ],
...
Đi làm, gặp khách, ăn tối nhẹ, dùng hằng ngày. Xịt 2-3 nhát: cổ, ngực, cổ tay. Dùng quanh năm — đẹp nhất xuân thu. Ở Sài Gòn dùng thoải mái vì cân bằng tốt giữa tươi và ấm.`,
  ...
  },
  {
    ...
    images: [{ url: "/images/products/chanel-allure-homme-sport-main.jpg", source: "amazon", caption: "CHANEL Allure Homme Sport chính hãng", verified: true }],
    description: "(Chờ nguồn xác minh)",
    productCopy: `## Mùi hương tổng thể
