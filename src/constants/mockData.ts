...
La Vie Est Belle mạnh ở độ đại chúng và dễ dùng. Điểm yếu là không còn quá mới mẻ với người chơi lâu.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Valentino Born In Roma Intense đang được xác minh lại để tránh nhầm Coral Fantasy", verified: false }
    ],
...
Điểm mạnh của chai này là dễ thấy đẹp và khá hợp xu hướng hiện tại. Điểm yếu là chưa phải kiểu quá riêng nếu so với nhiều chai niche.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Azzaro The Most Wanted Parfum đang được xác minh lại để tránh nhầm EDP Intense", verified: false }
    ],
...
Chai này hay ở chỗ có màu rất riêng mà vẫn dễ dùng. Điểm yếu là không phải ai cũng thích sắc dừa ngọt của nó.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Mancera Instant Crush đang được xác minh lại để tránh nhầm các line khác của Mancera", verified: false }
    ],
...
Instant Crush mạnh ở hiệu năng và độ nhận diện. Điểm yếu là hơi áp lực nếu dùng quá tay hoặc sai thời tiết.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Kayali Vanilla 28 đang được xác minh lại để tránh nhầm các flankers cùng line", verified: false }
    ],
...
Eros EDP hiệu quả nếu mục tiêu là nổi bật và dễ gây chú ý. Điểm yếu là hơi phô nếu xịt quá tay.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Prada Luna Rossa Carbon đang được xác minh lại để tránh nhầm Ocean", verified: false }
    ],
...
Dior Homme Intense đẹp và có gu rõ. Điểm yếu là kén người hơn các chai nam sạch phổ thông.`,
  ...
  },
  {
    ...
    image: PENDING_IMAGE,
    images: [
      { url: PENDING_IMAGE, source: "studio", caption: "Ảnh Dolce & Gabbana The One EDP đang được xác minh lại để tránh nhầm EDT", verified: false }
    ],
