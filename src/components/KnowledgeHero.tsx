...
export default function KnowledgeHero({ totalPosts }: Props) {
  return (
    <section className="border-b border-[var(--border)] bg-[#faf8f6]">
      <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-5 sm:py-16 lg:py-20">
        <div className="overflow-hidden rounded-[28px] border border-[#eadfce] bg-white px-5 py-6 shadow-[0_20px_60px_rgba(27,18,13,0.05)] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
          ...
          <div className="max-w-3xl">
            ...
            <div className="mt-4 flex flex-wrap gap-2 text-sm">
              <span className="rounded-full bg-[#f7f2eb] px-3.5 py-2 text-xs font-semibold text-[#4b3b30] sm:px-4 sm:text-sm">{totalPosts} bài viết đang có</span>
              <span className="rounded-full bg-[#f7f2eb] px-3.5 py-2 text-xs font-semibold text-[#4b3b30] sm:px-4 sm:text-sm">Dễ hiểu, thực tế, rõ ràng</span>
              <span className="rounded-full bg-[#f7f2eb] px-3.5 py-2 text-xs font-semibold text-[#4b3b30] sm:px-4 sm:text-sm">Phù hợp bối cảnh Việt Nam</span>
            </div>
          </div>

          <div className="mt-5 flex flex-col gap-2.5 sm:mt-8 sm:flex-row sm:flex-wrap">
          <Link
            href="#bat-dau"
