...
const BRAND_CONTENT: Record<string, {
    ...
    'armaf': { founded: 'unknown', founder: 'unknown', country: 'UAE', positioning: 'Arabian fragrance, giá mềm', signatureStyle: 'Inspired style, hiệu năng cao, thực dụng', intro: 'Armaf nổi tiếng không phải vì tạo ra trào lưu mới, mà vì làm rất mạnh mảng inspired fragrance giá mềm. Club de Nuit Intense Man là case tiêu biểu: cho cảm giác gần vibe Aventus ở mức tiền dễ chịu hơn nhiều. Điểm mạnh là tính thực dụng và khả năng tiếp cận. Điểm yếu là độ mượt và tinh chỉnh thường không bằng bản gốc, đặc biệt ở opening của nhiều chai.' },
